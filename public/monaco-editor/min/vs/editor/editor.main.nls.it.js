 ...
 *-----------------------------------------------------------*/ define('vs/editor/editor.main.nls.it', {
  ...
  'vs/base/browser/ui/findinput/findInputToggles': ['Maiuscole/minuscole', 'Parola intera', 'Usa espressione regolare'],
  'vs/base/browser/ui/findinput/replaceInput': ['input', 'Mantieni maiuscole/minuscole'],
  ...
  'vs/base/browser/ui/iconLabel/iconLabelHover': ['Caricamento...'],
  ...
  'vs/base/browser/ui/keybindingLabel/keybindingLabel': ['Non associato'],
  'vs/base/browser/ui/selectBox/selectBoxCustom': ['Casella di selezione'],
  'vs/base/browser/ui/toolbar/toolbar': ['Altre azioni...'],
  ...
  'vs/editor/browser/controller/textAreaHandler': [
    'editor',
    "L'editor non \xE8 accessibile in questo momento.",
    "{0} Per abilitare la modalit\xE0 ottimizzata per l'utilit\xE0 per la lettura dello schermo usare {1}",
    "{0} Per abilitare la modalit\xE0 ottimizzata per l'utilit\xE0 per la lettura dello schermo, aprire la selezione rapida con {1} ed eseguire il comando Attiva/Disattiva modalit\xE0 di accessibilit\xE0 dell'utilit\xE0 per la lettura dello schermo, attualmente non attivabile tramite tastiera.",
    "{0} Assegnare un tasto di scelta rapida per il comando Attiva/Disattiva modalit\xE0 di accessibilit\xE0 dell'utilit\xE0 per la lettura dello schermo accedendo all'editor dei tasti di scelta rapida con {1} ed eseguirlo.",
  ],
  ...
  'vs/editor/browser/widget/hoverWidget/hoverWidget': ['Tieni premuto il tasto {0} per passare il mouse'],
 ...
 - I valori maggiori o uguali a 8 verranno usati come valori effettivi.`,
  ...
  'vs/editor/common/editorContextKeys': [
    ...
    'Indica se il contesto \xE8 un editor con pi\xF9 differenze',
  ...
  'vs/editor/common/languages/modesRegistry': ['Testo normale'],
  'vs/editor/common/model/editStack': ['Digitazione'],
  'vs/editor/common/standaloneStrings': [
    ...
    'Contenuto editor',
    'Premere ALT+F1 per le opzioni di accessibilit\xE0.',
    'Attiva/disattiva tema a contrasto elevato',
    'Effettuate {0} modifiche in {1} file',
  ],
  'vs/editor/common/viewLayout/viewLineRenderer': ['Mostra di pi\xF9 ({0})', '{0} caratteri'],
  ...
  'vs/editor/contrib/caretOperations/browser/transpose': ['Trasponi lettere'],
  ...
  'vs/editor/contrib/cursorUndo/browser/cursorUndo': ['Cursore - Annulla', 'Cursore - Ripeti'],
  'vs/editor/contrib/dropOrPasteInto/browser/copyPasteContribution': [
    'Incolla come...',
    "ID della modifica dell'operazione Incolla da provare ad applicare. Se non viene specificato, l'editor mostrer\xE0 un controllo di selezione.",
    'Incolla come testo',
  ],
  ...
  'vs/editor/contrib/format/browser/formatActions': ['Formatta documento', 'Formatta selezione'],
  ...
  'vs/editor/contrib/gotoSymbol/browser/link/goToDefinitionAtPosition': ['Fare clic per visualizzare {0} definizioni.'],
  ...
  'vs/editor/contrib/gotoSymbol/browser/peek/referencesTree': ['{0} riferimenti', '{0} riferimento', 'Riferimenti'],
  ...
  'vs/editor/contrib/inlineCompletions/browser/hoverParticipant': ['Suggerimento:'],
  ...
  'vs/editor/contrib/lineSelection/browser/lineSelection': ['Espandere selezione riga'],
  ...
  'vs/editor/contrib/suggest/browser/suggestWidgetDetails': ['Chiudi', 'Caricamento...'],
  ...
  'vs/editor/contrib/tokenization/browser/tokenization': ['Sviluppatore: Forza retokenizzazione'],
  ...
  'vs/editor/contrib/wordOperations/browser/wordOperations': ['Elimina parola'],
...
[{1}] {2}`,
  ...
  'vs/platform/actions/browser/toolbar': ['Nascondi', 'Reimposta menu'],
  'vs/platform/actions/common/menuService': ["Nascondi '{0}'"],
  ...
  'vs/platform/contextkey/browser/contextKeyService': ['Comando che restituisce informazioni sulle chiavi di contesto'],
...
Ricevuto: '{1}'.`,
  ...
  'vs/platform/history/browser/contextScopedHistoryWidget': ['Indica se i suggerimenti sono visibili'],
  ...
  'vs/platform/list/browser/listService': [
    ...
    "Controlla il numero di elementi permanenti visualizzati nell'albero quando '#workbench.tree.enableStickyScroll#' \xE8 abilitato.",
  ...
  'vs/platform/quickinput/browser/quickInputList': ['Input rapido'],
  'vs/platform/quickinput/browser/quickInputUtils': ["Fare clic per eseguire il comando '{0}'"],
  ...
  'vs/platform/workspace/common/workspace': ['Area di lavoro del codice'],
})
