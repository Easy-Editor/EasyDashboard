 ...
 *-----------------------------------------------------------*/ define('vs/editor/editor.main.nls', {
  ...
  'vs/base/browser/ui/findinput/findInputToggles': ['Match Case', 'Match Whole Word', 'Use Regular Expression'],
  ...
  'vs/base/browser/ui/selectBox/selectBoxCustom': ['Select Box'],
  'vs/base/browser/ui/toolbar/toolbar': ['More Actions...'],
  ...
  'vs/editor/browser/editorExtensions': ['&&Undo', 'Undo', '&&Redo', 'Redo', '&&Select All', 'Select All'],
  ...
  'vs/editor/browser/widget/diffEditor/components/diffEditorEditors': [' use {0} to open the accessibility help.'],
  ...
  'vs/editor/browser/widget/diffEditor/features/revertButtonsFeature': ['Revert Selected Changes', 'Revert Change'],
  ...
  'vs/editor/browser/widget/hoverWidget/hoverWidget': ['Hold {0} key to mouse over'],
 ...
 - Values greater than or equal to 8 will be used as effective values.`,
  ...
  'vs/editor/common/viewLayout/viewLineRenderer': ['Show more ({0})', '{0} chars'],
  ...
  'vs/editor/contrib/caretOperations/browser/caretOperations': ['Move Selected Text Left', 'Move Selected Text Right'],
  ...
  'vs/editor/contrib/codeAction/browser/codeAction': ['An unknown error occurred while applying the code action'],
  ...
  'vs/editor/contrib/cursorUndo/browser/cursorUndo': ['Cursor Undo', 'Cursor Redo'],
  ...
  'vs/editor/contrib/format/browser/formatActions': ['Format Document', 'Format Selection'],
  ...
  'vs/editor/contrib/gotoSymbol/browser/link/goToDefinitionAtPosition': ['Click to show {0} definitions.'],
  ...
  'vs/editor/contrib/gotoSymbol/browser/peek/referencesTree': ['{0} references', '{0} reference', 'References'],
  'vs/editor/contrib/gotoSymbol/browser/peek/referencesWidget': ['no preview available', 'No results', 'References'],
  ...
  'vs/editor/contrib/inPlaceReplace/browser/inPlaceReplace': ['Replace with Previous Value', 'Replace with Next Value'],
  ...
  'vs/editor/contrib/lineSelection/browser/lineSelection': ['Expand Line Selection'],
  ...
  'vs/editor/contrib/message/browser/messageController': ['Whether the editor is currently showing an inline message'],
  ...
  'vs/editor/contrib/suggest/browser/suggestWidgetDetails': ['Close', 'Loading...'],
  ...
  'vs/editor/contrib/tokenization/browser/tokenization': ['Developer: Force Retokenize'],
  ...
  'vs/platform/action/common/actionCommonCategories': ['Developer', 'View', 'Help', 'Test', 'File', 'Preferences'],
...
[{1}] {2}`,
  ...
  'vs/platform/actions/browser/toolbar': ['Hide', 'Reset Menu'],
  ...
  'vs/platform/contextkey/browser/contextKeyService': ['A command that returns information about context keys'],
...
Received: '{1}'.`,
  ...
  'vs/platform/history/browser/contextScopedHistoryWidget': ['Whether suggestion are visible'],
  ...
  'vs/platform/quickinput/browser/quickInputList': ['Quick Input'],
  'vs/platform/quickinput/browser/quickInputUtils': ["Click to execute command '{0}'"],
