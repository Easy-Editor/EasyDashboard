    ...
    static getHighPerformanceTimestamp() {
      return (
        this.PERFORMANCE_NOW_PROBED ||
          ...
          (this.HAS_PERFORMANCE_NOW = u.global.performance && typeof u.global.performance.now == 'function')),
      ...
      if (!u.Utilities.endsWith(c, '.js') && !u.Utilities.isAbsolutePath(c)) {
        ...
        for (let t = 0, e = a.length; t < e; t++)
          (this.isBuild() && a[t] === 'empty:') ||
            ...
            !u.Utilities.endsWith(a[t], '.js') && !u.Utilities.containsQueryString(a[t]) && (a[t] = a[t] + '.js'))
    ...
    requireToUrl(r) {
      ...
      return (
        u.Utilities.isAbsolutePath(c) ||
          ((c = this._applyPaths(c)[0]), u.Utilities.isAbsolutePath(c) || (c = this.options.baseUrl + c)),
  ...
  class h {
    ...
    load(e, i, s, n) {
      if (/^node\|/.test(i)) {
        ...
        if (
          !(/^((http:)|(https:)|(file:))/.test(i) && i.substring(0, self.origin.length) !== self.origin) &&
          this._canUseEval(e)
        ) {
          fetch(i)
            .then(o => {
...
//# sourceURL=${i}`),
  ...
  class r {
    ...
    load(e, i, s, n) {
      ...
      if (/^node\|/.test(i)) {
        ...
        this._readSourceAndCachedData(f, E, _, (I, C, P, w) => {
          ...
          let R
          C.charCodeAt(0) === r._BOM ? (R = r._PREFIX + C.substring(1) + r._SUFFIX) : (R = r._PREFIX + C + r._SUFFIX),
            (R = o(R, f))
    ...
    _createAndEvalScript(e, i, s, n, l) {
      ...
      return (
        (v.amd = f.amd),
        _.call(u.global, e.getGlobalAMDRequireFunc(), v, s.filename, this._path.dirname(s.filename)),
    ...
    _createAndWriteCachedData(e, i, s, n) {
      let l = Math.ceil(n.getConfig().getOptionsLiteral().nodeCachedData.writeDelay * (1 + Math.random())),
        d = -1,
        o = 0,
        _
      const f = () => {
            ...
            () => {
              ...
              n.equals(d) ||
                (l
                  .getConfig()
                  .onError(
                    new Error(`FAILED TO VERIFY CACHED DATA, deleting stale '${s}' now, but a RESTART IS REQUIRED`),
                  ),
                this._fs.unlink(s, o => {
...
;(function (u) {
  ...
  class p {
    ...
    getModuleId(t) {
      ...
      return (
        typeof e > 'u' &&
          ((e = this._nextId++), this._strModuleIdToIntModuleId.set(t, e), (this._intModuleIdToStrModuleId[e] = t)),
        e
      )
    }
    getStrModuleId(t) {
  ...
  class c {
    ...
    configure(t, e) {
      ...
      e ? (this._config = new u.Configuration(this._env, t)) : (this._config = this._config.cloneAndMerge(t)),
    ...
    _onLoad(t) {
      if (this._currentAnonymousDefineCall !== null) {
        ...
        ;(this._currentAnonymousDefineCall = null),
          this.defineModule(this._moduleIdProvider.getStrModuleId(t), e.dependencies, e.callback, null, e.stack)
      }
    }
    ...
    _onLoadError(t, e) {
      ...
      this._modules2[t] ||
        (this._modules2[t] = new m(t, this._moduleIdProvider.getStrModuleId(t), [], () => {}, null, null))
      let s = []
        ...
        for (let i = 0, s = e.length; i < s; i++) {
          ...
          if (this._hasDependencyPath(n.id, t.id)) {
            ...
            d.reverse(),
              ...
              console.warn(
                d
                  .map(o => this._moduleIdProvider.getStrModuleId(o))
                  .join(` => 
`),
              ),
              t.unresolvedDependenciesCount--
...
;(function (u) {
  ...
  ;(u.init = c),
    (typeof u.global.define != 'function' || !u.global.define.amd) &&
      ((m = new u.ModuleManager(y, u.createScriptLoader(y), p, r, u.Utilities.getHighPerformanceTimestamp())),
      typeof u.global.require < 'u' && typeof u.global.require != 'function' && r.config(u.global.require),
      (define = function () {
