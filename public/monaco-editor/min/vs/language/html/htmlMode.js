  ...
  var moduleExports = (() => {
    ...
    var dn = (n =>
      typeof require < 'u'
        ? require
        : typeof Proxy < 'u'
          ? new Proxy(n, { get: (t, i) => (typeof require < 'u' ? require : t)[i] })
          : n)(function (n) {
      if (typeof require < 'u') return require.apply(this, arguments)
      throw Error('Dynamic require of "' + n + '" is not supported')
    })
    var cn = (n, t) => () => (t || n((t = { exports: {} }).exports, t), t.exports),
      ln = (n, t) => {
      ...
      q = (n, t, i, r) => {
        if ((t && typeof t == 'object') || typeof t == 'function')
          for (let e of sn(t))
            !un.call(n, e) && e !== i && Q(n, e, { get: () => t[e], enumerable: !(r = on(t, e)) || r.enumerable })
        return n
      },
      me = (n, t, i) => (q(n, t, 'default'), i && q(i, t, 'default')),
      he = (n, t, i) => (
        (i = n != null ? rn(an(n)) : {}),
        q(t || !n || !n.__esModule ? Q(i, 'default', { value: n, enumerable: !0 }) : i, n)
      ),
      gn = n => q(Q({}, '__esModule', { value: !0 }), n)
    var Te = cn((Sn, ve) => {
      var fn = he(dn('vs/editor/editor.api'))
      ve.exports = fn
    })
    var Dn = {}
    ln(Dn, {
    ...
    var pn = 2 * 60 * 1e3,
      b = class {
        ...
        _checkIfIdle() {
          ...
          Date.now() - this._lastUsedTime > pn && this._stopWorker()
        }
        _getClient() {
          return (
    ...
    ;(function (n) {
      function t(r, e, o, s) {
        ...
        throw new Error('Range#create called with invalid arguments[' + r + ', ' + e + ', ' + o + ', ' + s + ']')
      }
      n.create = t
      function i(r) {
        var e = r
    ...
    ;(function (n) {
      ...
      function i(r) {
        var e = r
        return a.defined(e) && v.is(e.range) && (a.string(e.uri) || a.undefined(e.uri))
      }
      n.is = i
    })(ie || (ie = {}))
    var xe
    ;(function (n) {
      function t(r, e, o, s) {
        return { targetUri: r, targetRange: e, targetSelectionRange: o, originSelectionRange: s }
      }
      n.create = t
      function i(r) {
        var e = r
        return (
          ...
          (v.is(e.targetSelectionRange) || a.undefined(e.targetSelectionRange)) &&
    ...
    ;(function (n) {
      ...
      function i(r) {
        ...
        return (
          ...
          (a.undefined(e.additionalTextEdits) || a.typedArray(e.additionalTextEdits, _.is))
        )
      }
      n.is = i
    })(Ie || (Ie = {}))
    ...
    ;(function (n) {
      function t(r, e, o, s, u) {
        ...
        return (
          a.defined(o) && (l.startCharacter = o), a.defined(s) && (l.endCharacter = s), a.defined(u) && (l.kind = u), l
        )
      }
      n.create = t
      function i(r) {
      ...
      function i(r) {
        ...
        return (
          ...
          (a.undefined(o.codeDescription) ||
            a.string((e = o.codeDescription) === null || e === void 0 ? void 0 : e.href)) &&
          (a.string(o.source) || a.undefined(o.source)) &&
          (a.undefined(o.relatedInformation) || a.typedArray(o.relatedInformation, se.is))
        )
      }
      n.is = i
    })(Y || (Y = {}))
    ...
    ;(function (n) {
      function t(r, e, o) {
        var s = { label: r }
        return e !== void 0 && (s.needsConfirmation = e), o !== void 0 && (s.description = o), s
      }
      n.create = t
      function i(r) {
        var e = r
    ...
    ;(function (n) {
      ...
      function e(o) {
        var s = o
        return _.is(s) && (R.is(s.annotationId) || T.is(s.annotationId))
      }
      n.is = e
    })(I || (I = {}))
    var Z
    ...
    ;(function (n) {
      function t(r, e, o) {
        ...
        return (
          e !== void 0 && (e.overwrite !== void 0 || e.ignoreIfExists !== void 0) && (s.options = e),
      ...
      function i(r) {
        ...
        return (
          ...
          a.string(e.uri) &&
          (e.options === void 0 ||
            ((e.options.overwrite === void 0 || a.boolean(e.options.overwrite)) &&
              (e.options.ignoreIfExists === void 0 || a.boolean(e.options.ignoreIfExists)))) &&
    ...
    ;(function (n) {
      function t(r, e, o, s) {
        ...
        return (
          o !== void 0 && (o.overwrite !== void 0 || o.ignoreIfExists !== void 0) && (u.options = o),
    ...
    ;(function (n) {
      function t(r, e, o) {
        ...
        return (
          e !== void 0 && (e.recursive !== void 0 || e.ignoreIfNotExists !== void 0) && (s.options = e),
          o !== void 0 && (s.annotationId = o),
          s
        )
      }
      ...
      function i(r) {
        ...
        return (
          ...
          a.string(e.uri) &&
          (e.options === void 0 ||
            ((e.options.recursive === void 0 || a.boolean(e.options.recursive)) &&
              (e.options.ignoreIfNotExists === void 0 || a.boolean(e.options.ignoreIfNotExists)))) &&
          (e.annotationId === void 0 || T.is(e.annotationId))
        )
      }
      n.is = i
        ...
        return (
          ...
          (n.prototype.getTextEditChange = function (t) {
            if (ee.is(t)) {
              ...
              if (!r) {
                var e = []
                ;(this._workspaceEdit.changes[t] = e), (r = new G(e)), (this._textEditChanges[t] = r)
              }
              return r
            }
          }),
          ...
          (n.prototype.createFile = function (t, i, r) {
            ...
            if (
              (e === void 0
                ? (o = N.create(t, r))
                : ((s = T.is(e) ? e : this._changeAnnotations.manage(e)), (o = N.create(t, r, s))),
              this._workspaceEdit.documentChanges.push(o),
              s !== void 0)
            )
              return s
          ...
          (n.prototype.renameFile = function (t, i, r, e) {
            ...
            if (
              (o === void 0
                ? (s = V.create(t, i, e))
                : ((u = T.is(o) ? o : this._changeAnnotations.manage(o)), (s = V.create(t, i, e, u))),
          ...
          (n.prototype.deleteFile = function (t, i, r) {
            ...
            if (
              (e === void 0
                ? (o = z.create(t, r))
                : ((s = T.is(e) ? e : this._changeAnnotations.manage(e)), (o = z.create(t, r, s))),
              this._workspaceEdit.documentChanges.push(o),
              s !== void 0)
            )
              return s
    ...
    ;(function (n) {
      function t(i) {
        ...
        return (
          !!r &&
          a.objectLiteral(r) &&
          (ue.is(r.contents) || te.is(r.contents) || a.typedArray(r.contents, te.is)) &&
    ...
    ;(function (n) {
      function t(i, r) {
        ...
        var s = { label: i }
        return a.defined(r) && (s.documentation = r), a.defined(e) ? (s.parameters = e) : (s.parameters = []), s
      }
      n.create = t
    })(He || (He = {}))
    var W
    ...
    ;(function (n) {
      ...
      function i(r) {
        var e = r
        return (
          a.defined(e) && a.typedArray(e.diagnostics, Y.is) && (e.only === void 0 || a.typedArray(e.only, a.string))
        )
      }
      n.is = i
    })(Ve || (Ve = {}))
    ...
    ;(function (n) {
      function t(r, e, o) {
        var s = { title: r },
          u = !0
        return (
          typeof e == 'string' ? ((u = !1), (s.kind = e)) : O.is(e) ? (s.command = e) : (s.edit = e),
          u && o !== void 0 && (s.kind = o),
          s
        )
      }
    ...
    ;(function (n) {
      ...
      function i(r) {
        var e = r
        return a.defined(e) && v.is(e.range) && (a.undefined(e.command) || O.is(e.command))
      }
      n.is = i
    })(Xe || (Xe = {}))
    var Be
    ...
    ;(function (n) {
      ...
      function i(r) {
        var e = r
        return a.defined(e) && v.is(e.range) && (a.undefined(e.target) || a.string(e.target))
      }
      n.is = i
    })($e || ($e = {}))
    var qe
    ;(function (n) {
      ...
      function i(r) {
        var e = r
        return e !== void 0 && v.is(e.range) && (e.parent === void 0 || n.is(e.parent))
      }
      n.is = i
    })(qe || (qe = {}))
    var Qe
        ...
        for (
          var u = o.getText(),
            l = e(s, function (E, $) {
              ...
              return pe === 0 ? E.range.start.character - $.range.start.character : pe
            }),
            f = u.length,
            g = l.length - 1;
          g >= 0;
          ...
          if (c <= f) u = u.substring(0, k) + h.newText + u.substring(c, u.length)
        ...
        return (
          ...
          (n.prototype.getLineOffsets = function () {
            if (this._lineOffsets === void 0) {
              for (var t = [], i = this._content, r = !0, e = 0; e < i.length; e++) {
                r && (t.push(e), (r = !1))
                var o = i.charAt(e)
                ;(r =
                  o === '\r' ||
...
` &&
    ...
    ;(function (n) {
      ...
      n.numberRange = u
      function l(c) {
        return t.call(c) === '[object Number]' && -2147483648 <= c && c <= 2147483647
      }
      n.integer = l
      function f(c) {
      ...
      constructor(t, i, r) {
        ...
        let e = s => {
            ...
            ;(this._listener[s.uri.toString()] = s.onDidChangeContent(() => {
              window.clearTimeout(l), (l = window.setTimeout(() => this._doValidate(s.uri, u), 500))
            })),
        ...
        return this._worker(o)
          ...
          .then(s => {
            ...
            let u = t.getWordUntilPosition(i),
              l = new d.Range(i.lineNumber, u.startColumn, i.lineNumber, u.endColumn),
              f = s.items.map(g => {
                let h = {
                  label: g.label,
                ...
                return (
                  g.textEdit &&
                    (yn(g.textEdit)
                      ? (h.range = { insert: y(g.textEdit.insert), replace: y(g.textEdit.replace) })
                      : (h.range = y(g.textEdit.range)),
                    (h.insertText = g.textEdit.newText)),
                  g.additionalTextEdits && (h.additionalTextEdits = g.additionalTextEdits.map(D)),
                  g.insertTextFormat === ne.Snippet &&
                    (h.insertTextRules = d.languages.CompletionItemInsertTextRule.InsertAsSnippet),
                  h
                )
              })
    ...
    function y(n) {
      if (n) return new d.Range(n.start.line + 1, n.start.character + 1, n.end.line + 1, n.end.character + 1)
    }
    function yn(n) {
    ...
    var L = class {
      ...
      provideHover(t, i, r) {
        ...
        return this._worker(e)
          ...
          .then(o => {
            if (o) return { range: y(o.range), contents: _n(o.contents) }
          })
      }
    }
    function In(n) {
...
` +
    ...
    var S = class {
      ...
      provideDocumentHighlights(t, i, r) {
        ...
        return this._worker(e)
          ...
          .then(o => {
            if (o) return o.map(s => ({ range: y(s.range), kind: Cn(s.kind) }))
          })
      }
    }
    function Cn(n) {
    ...
    function bn(n) {
      ...
      for (let i in n.changes) {
        ...
        for (let e of n.changes[i])
          t.push({ resource: r, versionId: void 0, textEdit: { range: y(e.range), text: e.newText } })
      }
      return { edits: t }
    }
    var M = class {
    ...
    function Ye(n) {
      return {
        ...
        kind: Ze(n.kind),
        range: y(n.range),
        selectionRange: y(n.selectionRange),
        tags: n.tags ?? [],
        children: (n.children ?? []).map(t => Ye(t)),
      }
    }
    function Ze(n) {
    ...
    var A = class {
        ...
        provideLinks(t, i) {
          ...
          return this._worker(r)
            ...
            .then(e => {
              if (e) return { links: e.map(o => ({ range: y(o.range), url: o.target })) }
            })
        }
      },
      H = class {
        ...
        provideDocumentFormattingEdits(t, i, r) {
          ...
          return this._worker(e).then(o =>
            o.format(e.toString(), null, en(i)).then(s => {
              if (!(!s || s.length === 0)) return s.map(D)
            }),
          )
        }
      },
      K = class {
        ...
        provideDocumentRangeFormattingEdits(t, i, r, e) {
          ...
          return this._worker(o).then(s =>
            s.format(o.toString(), fe(i), en(r)).then(u => {
    ...
    var ge = class {
        ...
        provideDocumentColors(t, i) {
          ...
          return this._worker(r)
            ...
            .then(e => {
              if (e) return e.map(o => ({ color: o.color, range: y(o.range) }))
            })
        }
        provideColorPresentations(t, i, r) {
          let e = t.uri
          return this._worker(e)
            .then(o => o.getColorPresentations(e.toString(), i.color, fe(i.range)))
            .then(o => {
              if (o)
                return o.map(s => {
                  let u = { label: s.label }
                  return (
                    s.textEdit && (u.textEdit = D(s.textEdit)),
                    s.additionalTextEdits && (u.additionalTextEdits = s.additionalTextEdits.map(D)),
                    u
                  )
                })
            })
            ...
            .then(o => {
              if (o)
                return o.map(s => {
                  ...
                  return typeof s.kind < 'u' && (u.kind = En(s.kind)), u
                })
            })
        }
      }
    ...
    function Pn(n) {
      ...
      d.languages.registerCompletionItemProvider(r, new re(i)),
        d.languages.registerHoverProvider(r, new L(i)),
    ...
    function Wn(n) {
      ...
      function o() {
        ...
        tn(i),
          u.completionItems && i.push(d.languages.registerCompletionItemProvider(s, new re(e))),
          u.hovers && i.push(d.languages.registerHoverProvider(s, new L(e))),
          u.documentHighlights && i.push(d.languages.registerDocumentHighlightProvider(s, new S(e))),
          u.links && i.push(d.languages.registerLinkProvider(s, new A(e))),
          u.documentSymbols && i.push(d.languages.registerDocumentSymbolProvider(s, new M(e))),
          u.rename && i.push(d.languages.registerRenameProvider(s, new F(e))),
          u.foldingRanges && i.push(d.languages.registerFoldingRangeProvider(s, new U(e))),
          u.selectionRanges && i.push(d.languages.registerSelectionRangeProvider(s, new j(e))),
          u.documentFormattingEdits && i.push(d.languages.registerDocumentFormattingEditProvider(s, new H(e))),
          u.documentRangeFormattingEdits && i.push(d.languages.registerDocumentRangeFormattingEditProvider(s, new K(e)))
      }
      return o(), t.push(nn(i)), nn(t)
    }
    function nn(n) {
      return { dispose: () => tn(n) }
    }
