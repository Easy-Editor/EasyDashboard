...
define('vs/language/html/htmlWorker', ['require', 'require'], require => {
  ...
  var moduleExports = (() => {
    ...
    var Cn = (t, i) => {
        for (var o in i) Xe(t, o, { get: i[o], enumerable: !0 })
      },
      Ln = (t, i, o, n) => {
        if ((i && typeof i == 'object') || typeof i == 'function')
          for (let e of Dn(i))
            !En.call(t, e) && e !== o && Xe(t, e, { get: () => i[e], enumerable: !(n = xn(i, e)) || n.enumerable })
        return t
      }
    var Mn = t => Ln(Xe({}, '__esModule', { value: !0 }), t)
    var Ri = {}
    Cn(Ri, { HTMLWorker: () => Je, create: () => Mi })
    function Rn(t, i) {
      let o
      return (
        i.length === 0
    ...
    ;(function (t) {
      function i(n, e) {
        return (
          n === Number.MAX_VALUE && (n = Ie.MAX_VALUE),
          e === Number.MAX_VALUE && (e = Ie.MAX_VALUE),
          { line: n, character: e }
        )
      }
      t.create = i
      function o(n) {
        var e = n
        return _.objectLiteral(e) && _.uinteger(e.line) && _.uinteger(e.character)
      }
      t.is = o
    })(X || (X = {}))
    var P
    ...
    ;(function (t) {
      ...
      function o(n) {
        var e = n
        return _.defined(e) && P.is(e.range) && (_.string(e.uri) || _.undefined(e.uri))
      }
      t.is = o
    })(ve || (ve = {}))
    var Tt
    ;(function (t) {
      ...
      function o(n) {
        ...
        return (
          ...
          (P.is(e.targetSelectionRange) || _.undefined(e.targetSelectionRange)) &&
    ...
    ;(function (t) {
      ...
      function o(n) {
        var e = n
        return P.is(e.range) && Ue.is(e.color)
      }
      t.is = o
    })($e || ($e = {}))
    var Qe
    ;(function (t) {
      ...
      function o(n) {
        ...
        return (
          ...
          (_.undefined(e.additionalTextEdits) || _.typedArray(e.additionalTextEdits, Y.is))
        )
      }
      t.is = o
    })(Qe || (Qe = {}))
    ...
    ;(function (t) {
      function i(n, e, a, c, l) {
        ...
        return (
          _.defined(a) && (r.startCharacter = a), _.defined(c) && (r.endCharacter = c), _.defined(l) && (r.kind = l), r
        )
      }
      t.create = i
      function o(n) {
      ...
      function o(n) {
        ...
        return (
          ...
          (_.undefined(a.codeDescription) ||
            _.string((e = a.codeDescription) === null || e === void 0 ? void 0 : e.href)) &&
          (_.string(a.source) || _.undefined(a.source)) &&
          (_.undefined(a.relatedInformation) || _.typedArray(a.relatedInformation, Ke.is))
        )
      }
      t.is = o
    })(Ae || (Ae = {}))
    ...
    ;(function (t) {
      ...
      function o(n) {
        var e = n
        return _.defined(e) && Fe.is(e.textDocument) && Array.isArray(e.edits)
      }
      t.is = o
    })(We || (We = {}))
    var xe
    ;(function (t) {
      function i(n, e, a) {
        ...
        return (
          e !== void 0 && (e.overwrite !== void 0 || e.ignoreIfExists !== void 0) && (c.options = e),
      ...
      function o(n) {
        ...
        return (
          ...
          _.string(e.uri) &&
          (e.options === void 0 ||
            ((e.options.overwrite === void 0 || _.boolean(e.options.overwrite)) &&
              (e.options.ignoreIfExists === void 0 || _.boolean(e.options.ignoreIfExists)))) &&
    ...
    ;(function (t) {
      function i(n, e, a) {
        ...
        return (
          e !== void 0 && (e.recursive !== void 0 || e.ignoreIfNotExists !== void 0) && (c.options = e),
          a !== void 0 && (c.annotationId = a),
          c
        )
      }
      ...
      function o(n) {
        ...
        return (
          ...
          _.string(e.uri) &&
          (e.options === void 0 ||
            ((e.options.recursive === void 0 || _.boolean(e.options.recursive)) &&
              (e.options.ignoreIfNotExists === void 0 || _.boolean(e.options.ignoreIfNotExists)))) &&
          (e.annotationId === void 0 || Z.is(e.annotationId))
        )
      }
      t.is = o
        ...
        return (
          ...
          (n.documentChanges === void 0 ||
            n.documentChanges.every(function (e) {
              return _.string(e.kind) ? xe.is(e) || De.is(e) || Ee.is(e) : We.is(e)
            }))
        )
      }
      t.is = i
      ...
      xt = (function () {
        ...
        return (
          ...
          (t.prototype.manage = function (i, o) {
            var n
            if ((Z.is(i) ? (n = i) : ((n = this.nextId()), (o = i)), this._annotations[n] !== void 0))
              throw new Error('Id ' + n + ' is already in use.')
            if (o === void 0) throw new Error('No annotation provided for id ' + n)
        ...
        return (
            ...
            if (Fe.is(i)) {
              ...
              if (!n) {
                ...
                this._workspaceEdit.documentChanges.push(a),
                  (n = new He(e, this._changeAnnotations)),
              ...
              if (!n) {
                var e = []
                ;(this._workspaceEdit.changes[i] = e), (n = new He(e)), (this._textEditChanges[i] = n)
              }
              return n
            }
          }),
          ...
          (t.prototype.createFile = function (i, o, n) {
            ...
            if (
              (e === void 0
                ? (a = xe.create(i, n))
                : ((c = Z.is(e) ? e : this._changeAnnotations.manage(e)), (a = xe.create(i, n, c))),
              this._workspaceEdit.documentChanges.push(a),
              c !== void 0)
            )
              return c
          ...
          (t.prototype.renameFile = function (i, o, n, e) {
            ...
            if (
              (a === void 0
                ? (c = De.create(i, o, e))
                : ((l = Z.is(a) ? a : this._changeAnnotations.manage(a)), (c = De.create(i, o, e, l))),
          ...
          (t.prototype.deleteFile = function (i, o, n) {
            ...
            if (
              (e === void 0
                ? (a = Ee.create(i, n))
                : ((c = Z.is(e) ? e : this._changeAnnotations.manage(e)), (a = Ee.create(i, n, c))),
              this._workspaceEdit.documentChanges.push(a),
              c !== void 0)
            )
              return c
    ...
    ;(function (t) {
      ...
      function o(n) {
        var e = n
        return _.defined(e) && _.string(e.uri) && (e.version === null || _.integer(e.version))
      }
      t.is = o
    })(Fe || (Fe = {}))
    var Ct
    ;(function (t) {
      ...
      function o(n) {
        var e = n
        return _.defined(e) && _.string(e.uri) && _.string(e.languageId) && _.integer(e.version) && _.string(e.text)
      }
      t.is = o
    })(Ct || (Ct = {}))
    var ee
    ...
    ;(function (t) {
      ...
      function o(n) {
        var e = n
        return _.string(e) || (_.objectLiteral(e) && _.string(e.language) && _.string(e.value))
      }
      t.is = o
    })(Ce || (Ce = {}))
    var at
    ;(function (t) {
      function i(o) {
        ...
        return (
          !!n &&
          _.objectLiteral(n) &&
          (Pe.is(n.contents) || Ce.is(n.contents) || _.typedArray(n.contents, Ce.is)) &&
    ...
    ;(function (t) {
      function i(o, n) {
        for (var e = [], a = 2; a < arguments.length; a++) e[a - 2] = arguments[a]
        var c = { label: o }
        return _.defined(n) && (c.documentation = n), _.defined(e) ? (c.parameters = e) : (c.parameters = []), c
      }
      t.create = i
    })(Mt || (Mt = {}))
    var ye
    ...
    ;(function (t) {
      ...
      function o(n) {
        var e = n
        return (
          _.defined(e) && _.typedArray(e.diagnostics, Ae.is) && (e.only === void 0 || _.typedArray(e.only, _.string))
        )
      }
      t.is = o
    })(It || (It = {}))
    ...
    ;(function (t) {
      function i(n, e, a) {
        var c = { title: n },
          l = !0
        return (
          typeof e == 'string' ? ((l = !1), (c.kind = e)) : _e.is(e) ? (c.command = e) : (c.edit = e),
          l && a !== void 0 && (c.kind = a),
          c
        )
      }
      ...
      function o(n) {
        ...
        return (
          e &&
          _.string(e.title) &&
          (e.diagnostics === void 0 || _.typedArray(e.diagnostics, Ae.is)) &&
    ...
    ;(function (t) {
      ...
      function o(n) {
        var e = n
        return _.defined(e) && P.is(e.range) && (_.undefined(e.command) || _e.is(e.command))
      }
      t.is = o
    })(Wt || (Wt = {}))
    var lt
    ;(function (t) {
      ...
      function o(n) {
        var e = n
        return _.defined(e) && _.uinteger(e.tabSize) && _.boolean(e.insertSpaces)
      }
      t.is = o
    })(lt || (lt = {}))
    var ut
    ;(function (t) {
      ...
      function o(n) {
        var e = n
        return _.defined(e) && P.is(e.range) && (_.undefined(e.target) || _.string(e.target))
      }
      t.is = o
    })(ut || (ut = {}))
    var Te
        ...
        for (
          var l = a.getText(),
            r = e(c, function (y, m) {
              ...
              return A === 0 ? y.range.start.character - m.range.start.character : A
            }),
            s = l.length,
            u = r.length - 1;
          u >= 0;
          ...
          if (g <= s) l = l.substring(0, d) + h.newText + l.substring(g, l.length)
        ...
        return (
          ...
          (t.prototype.getLineOffsets = function () {
            if (this._lineOffsets === void 0) {
              for (var i = [], o = this._content, n = !0, e = 0; e < o.length; e++) {
                n && (i.push(e), (n = !1))
                var a = o.charAt(e)
                ;(n =
                  a === '\r' ||
...
` &&
    ...
    ;(function (t) {
      ...
      t.numberRange = l
      function r(g) {
        return i.call(g) === '[object Number]' && -2147483648 <= g && g <= 2147483647
      }
      t.integer = r
      function s(g) {
    ...
    var Ne = class t {
          ...
          for (let n of i)
            if (t.isIncremental(n)) {
              ...
              let l = Math.max(e.start.line, 0),
                ...
                s = this._lineOffsets,
                u = Ft(n.text, !1, a)
              if (r - l === u.length) for (let d = 0, g = u.length; d < g; d++) s[d + l + 1] = u[d]
              else
                u.length < 1e4
                  ? s.splice(l + 1, r - l, ...u)
                  : (this._lineOffsets = s = s.slice(0, l + 1).concat(u, s.slice(r + 1)))
              let h = n.text.length - (c - a)
              if (h !== 0) for (let d = l + 1 + u.length, g = s.length; d < g; d++) s[d] = s[d] + h
            } else if (t.isFull(n)) (this._content = n.text), (this._lineOffsets = void 0)
            else throw new Error('Unknown change event received')
          this._version = o
        }
        getLineOffsets() {
          return this._lineOffsets === void 0 && (this._lineOffsets = Ft(this._content, !0)), this._lineOffsets
        }
        positionAt(i) {
          i = Math.max(Math.min(i, this._content.length), 0)
        ...
        static isFull(i) {
          let o = i
          return o != null && typeof o.text == 'string' && o.range === void 0 && o.rangeLength === void 0
        }
      },
      Me
    ;(function (t) {
      function i(e, a, c, l) {
        return new Ne(e, a, c, l)
      }
      t.create = i
      function o(e, a, c) {
        if (e instanceof Ne) return e.update(a, c), e
      ...
      function n(e, a) {
        let c = e.getText(),
          l = ct(a.map(In), (u, h) => {
            ...
            return d === 0 ? u.range.start.character - h.range.start.character : d
          }),
          r = 0,
          s = []
        for (let u of l) {
          ...
          h > r && s.push(c.substring(r, h)), u.newText.length && s.push(u.newText), (r = e.offsetAt(u.range.end))
        }
    ...
    function ct(t, i) {
      ...
      let a = 0,
        c = 0,
        l = 0
      for (; a < n.length && c < e.length; ) i(n[a], e[c]) <= 0 ? (t[l++] = n[a++]) : (t[l++] = e[c++])
    ...
    function Ft(t, i, o = 0) {
      ...
      for (let e = 0; e < t.length; e++) {
        ...
        ;(a === 13 || a === 10) &&
          (a === 13 && e + 1 < t.length && t.charCodeAt(e + 1) === 10 && e++, n.push(o + e + 1))
      }
      return n
    }
    function Pt(t) {
      let i = t.start,
        o = t.end
      return i.line > o.line || (i.line === o.line && i.character > o.character) ? { start: o, end: i } : t
    }
    function In(t) {
      let i = Pt(t.range)
    ...
    ;(function (t) {
      t.LATEST = {
        textDocument: {
          completion: { completionItem: { documentationFormat: [ee.Markdown, ee.PlainText] } },
    ...
    var he = ge(),
      Un = (function () {
        ...
        return (
          ...
          (t.prototype.peekChar = function (i) {
            return i === void 0 && (i = 0), this.source.charCodeAt(this.position + i) || 0
          }),
          (t.prototype.advanceIfChar = function (i) {
            return i === this.source.charCodeAt(this.position) ? (this.position++, !0) : !1
          }),
          (t.prototype.advanceIfChars = function (i) {
            var o
            if (this.position + i.length > this.source.length) return !1
            for (o = 0; o < i.length; o++) if (this.source.charCodeAt(this.position + o) !== i[o]) return !1
          ...
          (t.prototype.advanceUntilChars = function (i) {
            for (; this.position + i.length <= this.source.length; ) {
              for (var o = 0; o < i.length && this.source.charCodeAt(this.position + o) === i[o]; o++);
          ...
          (t.prototype.skipWhitespace = function () {
            var i = this.advanceWhileChar(function (o) {
              return o === qn || o === jn || o === Pn || o === On || o === Nn
            })
            return i > 0
          }),
          (t.prototype.advanceWhileChar = function (i) {
            for (var o = this.position; this.position < this.len && i(this.source.charCodeAt(this.position)); )
              this.position++
      ...
      qn = 32,
      jn = 9,
      Gn = { 'text/x-handlebars-template': !0, 'text/html': !0 }
    function $(t, i, o, n) {
      i === void 0 && (i = 0), o === void 0 && (o = W.WithinContent), n === void 0 && (n = !1)
      var e = new Un(t, i),
        a = o,
        c = 0,
        l = S.Unknown,
      ...
      function y() {
        return e.advanceIfRegExp(/^[^\s"'></=\x00-\x0F\x7F\x80-\x9F]*/).toLowerCase()
      }
      function m(w, M, B) {
      ...
      function A() {
        var w = e.pos(),
          M = a,
          B = E()
        return B !== S.EOS && w === e.pos() && !(n && (B === S.StartTagClose || B === S.EndTagClose))
          ? (console.log('Scanner.scan has not advanced at offset ' + w + ', state before: ' + M + ' after: ' + a),
            e.advance(1),
            m(w, S.Unknown))
          : B
      }
      function E() {
        ...
        switch (a) {
          case W.WithinComment:
            return e.advanceIfChars([ke, ke, se])
              ? ((a = W.WithinContent), m(w, S.EndCommentTag))
              : (e.advanceUntilChars([ke, ke, se]), m(w, S.Comment))
          ...
          case W.WithinContent:
            if (e.advanceIfChar(qe)) {
              if (!e.eos() && e.peekChar() === Ot) {
                if (e.advanceIfChars([Ot, ke, ke])) return (a = W.WithinComment), m(w, S.StartCommentTag)
                if (e.advanceIfRegExp(/^!doctype/i)) return (a = W.WithinDoctype), m(w, S.StartDoctypeTag)
              }
              return e.advanceIfChar(ht)
            ...
            return B.length > 0
              ...
              : e.skipWhitespace()
                ? m(
                    w,
                    S.Whitespace,
                    he('error.unexpectedWhitespace', 'Tag name must directly follow the open bracket.'),
                  )
                : ((a = W.WithinEndTag),
                  e.advanceUntilChar(se),
                  w < e.pos() ? m(w, S.Unknown, he('error.endTagNameExpected', 'End tag name expected.')) : E())
          case W.WithinEndTag:
            if (e.skipWhitespace()) return m(w, S.Whitespace)
            if (e.advanceIfChar(se)) return (a = W.WithinContent), m(w, S.EndTagClose)
            if (n && e.peekChar() === qe)
              return (
                (a = W.WithinContent),
                m(w, S.EndTagClose, he('error.closingBracketMissing', 'Closing bracket missing.'))
              )
            ...
            return (
              ...
              u.length > 0
                ...
                : e.skipWhitespace()
                  ...
                  : ((a = W.WithinTag),
                    e.advanceUntilChar(se),
                    w < e.pos() ? m(w, S.Unknown, he('error.startTagNameExpected', 'Start tag name expected.')) : E())
            )
          case W.WithinTag:
              ...
              : s && ((h = y()), h.length > 0)
                ...
                : e.advanceIfChars([ht, se])
                  ...
                  : e.advanceIfChar(se)
                    ...
                    : n && e.peekChar() === qe
                      ? ((a = W.WithinContent),
                        m(w, S.StartTagClose, he('error.closingBracketMissing', 'Closing bracket missing.')))
                      : (e.advance(1),
                        m(w, S.Unknown, he('error.unexpectedCharacterInTag', 'Unexpected character in tag.')))
          ...
          case W.BeforeAttributeValue:
            ...
            if (G.length > 0)
              return (
                e.peekChar() === se && e.peekChar(-1) === ht && (e.goBack(1), (G = G.substr(0, G.length - 1))),
                h === 'type' && (d = G),
                (a = W.WithinTag),
                (s = !1),
            ...
            return J === Fn || J === Bn
              ? (e.advance(1),
                ...
                h === 'type' && (d = e.getSource().substring(w + 1, e.pos() - 1)),
                (a = W.WithinTag),
                (s = !1),
                m(w, S.AttributeValue))
              : ((a = W.WithinTag), (s = !1), E())
          ...
          case W.WithinStyleContent:
            return e.advanceUntilRegExp(/<\/style/i), (a = W.WithinContent), w < e.pos() ? m(w, S.Styles) : E()
        }
    ...
    function pe(t) {
      return (
        !!t &&
        qt(Jn, t.toLowerCase(), function (i, o) {
    ...
    var jt = (function () {
      function t(i, o, n, e) {
        ;(this.start = i), (this.end = o), (this.children = n), (this.parent = e), (this.closed = !1)
      }
      return (
        ...
        (t.prototype.isSameTag = function (i) {
          return this.tag === void 0
            ? i === void 0
            : i !== void 0 && this.tag.length === i.length && this.tag.toLowerCase() === i
        }),
        ...
        switch (l) {
          ...
          case S.StartTagClose:
            n.parent &&
              ((n.end = i.getTokenEnd()),
              i.getTokenLength()
                ? ((n.startTagEnd = i.getTokenEnd()), n.tag && pe(n.tag) && ((n.closed = !0), (n = n.parent)))
                : (n = n.parent))
            break
          case S.StartTagSelfClose:
            n.parent && ((n.closed = !0), (n.end = i.getTokenEnd()), (n.startTagEnd = i.getTokenEnd()), (n = n.parent))
            break
          case S.EndTagOpen:
          ...
          case S.EndTagClose:
            ...
            if (s.parent) {
              ...
              ;(n.closed = !0), (n.endTagStart = e), (n.end = i.getTokenEnd()), (n = n.parent)
            }
            break
...
`,
    ...
    function pt(t, i) {
      for (var o = ''; i > 0; ) (i & 1) === 1 && (o += t), (t += t), (i = i >>> 1)
      return o
    }
    var Xn = 97,
      Yn = 122,
    ...
    function fe(t, i) {
      ...
      return (Xn <= o && o <= Yn) || ($n <= o && o <= Qn) || (Zn <= o && o <= Kn)
    }
    function Se(t) {
      return typeof t < 'u'
    }
    function Vt(t) {
      if (t) return typeof t == 'string' ? { kind: 'markdown', value: t } : { kind: 'markdown', value: t.value }
    }
    var Ge = (function () {
      function t(i, o) {
        var n = this
      ...
      return (
        ...
        (t.prototype.provideAttributes = function (i) {
          ...
          return e && e.attributes.forEach(n), this._globalAttributes.forEach(n), o
        }),
...
`))),
          ...
          for (; o; )
            try {
              if (
                ((n = 1),
                e &&
                  (a = s[0] & 2 ? e.return : s[0] ? e.throw || ((a = e.return) && a.call(e), 0) : e.next) &&
                  !(a = a.call(e, s[1])).done)
              )
                return a
      ...
      Yt = (function () {
        ...
        return (
          (t.prototype.onHtmlAttributeValue = function (i) {
            ri(i.tag, i.attribute) && this.atributeCompletions.push(i)
          }),
          (t.prototype.computeCompletions = function (i, o) {
            return Jt(this, void 0, void 0, function () {
              ...
              return Xt(this, function (g) {
                switch (g.label) {
                  case 0:
                    ;(n = { items: [], isIncomplete: !1 }), (e = 0), (a = this.atributeCompletions), (g.label = 1)
                  case 1:
                    return e < a.length
                      ? ((c = a[e]),
                        (l = ni(i.getText(c.range))),
                        ii(l) ? (l === '.' || l === '..' ? ((n.isIncomplete = !0), [3, 4]) : [3, 2]) : [3, 4])
                      : [3, 5]
                  case 2:
                    return (r = ai(c.value, l, c.range)), [4, this.providePathSuggestions(c.value, r, i, o)]
                  case 3:
                    for (s = g.sent(), u = 0, h = s; u < h.length; u++) (d = h[u]), n.items.push(d)
                    g.label = 4
                  case 4:
                    return e++, [3, 1]
                  case 5:
          ...
          (t.prototype.providePathSuggestions = function (i, o, n, e) {
            return Jt(this, void 0, void 0, function () {
              ...
              return Xt(this, function (m) {
                switch (m.label) {
                  case 0:
                    if (((a = i.substring(0, i.lastIndexOf('/') + 1)), (c = e.resolveReference(a || '.', n.uri)), !c))
                      return [3, 4]
                    m.label = 1
                  case 1:
                    return m.trys.push([1, 3, , 4]), (l = []), [4, this.readDirectory(c)]
                  case 2:
                    for (r = m.sent(), s = 0, u = r; s < u.length; s++)
                      (h = u[s]), (d = h[0]), (g = h[1]), d.charCodeAt(0) !== ti && l.push(oi(d, g === Oe.Directory, o))
                    return [2, l]
                  case 3:
                    return (y = m.sent()), [3, 4]
                  case 4:
    ...
    function ai(t, i, o) {
      ...
      if (e === -1) n = si(o, 1, -1)
        ...
        var a = i.slice(e + 1),
          c = Re(o.end, -1 - a.length),
          l = a.indexOf(' '),
          r = void 0
        l !== -1 ? (r = Re(c, l)) : (r = Re(o.end, -1)), (n = P.create(c, r))
      }
      return n
    }
    function oi(t, i, o) {
    ...
    var ui = function (t, i, o, n) {
      ...
      Qt = (function () {
        function t(i, o) {
          ;(this.lsOptions = i), (this.dataManager = o), (this.completionParticipants = [])
        }
        return (
          ...
          (t.prototype.doComplete2 = function (i, o, n, e, a) {
            return ui(this, void 0, void 0, function () {
              var c, l, r, s
              return ci(this, function (u) {
                switch (u.label) {
                  case 0:
                    if (!this.lsOptions.fileSystemProvider || !this.lsOptions.fileSystemProvider.readDirectory)
                      return [2, this.doComplete(i, o, n, a)]
                    ;(c = new Yt(this.lsOptions.fileSystemProvider.readDirectory)),
                      (l = this.completionParticipants),
                      (this.completionParticipants = [c].concat(l)),
                      (r = this.doComplete(i, o, n, a)),
                      (u.label = 1)
                  case 1:
                    return u.trys.push([1, , 3, 4]), [4, c.computeCompletions(i, e)]
                  case 2:
                    return (
                      (s = u.sent()),
                      [2, { isIncomplete: r.isIncomplete || s.isIncomplete, items: s.items.concat(r.items) }]
                    )
                  case 3:
          ...
          (t.prototype._doComplete = function (i, o, n, e) {
            var a = { isIncomplete: !1, items: [] },
              ...
              l = this.dataManager.getDataProviders().filter(function (x) {
                return x.isApplicable(i.languageId) && (!e || e[x.getId()] !== !1)
              }),
            ...
            var d = $(s, h.start),
              ...
              y
            function m(x, D) {
              return D === void 0 && (D = u), x > u && (x = u), { start: i.positionAt(x), end: i.positionAt(D) }
            }
            function A(x, D) {
              var L = m(x, D)
              return (
...
\r`.indexOf(L) >= 0
              ...
              for (D && (O = O.parent); O; ) {
                ...
                if (V && (!O.closed || (O.endTagStart && O.endTagStart > u))) {
                  ...
                  if (oe !== null && ue !== null && oe !== ue) {
                    var te = oe + '</' + V + j
                    ;(K.textEdit = Y.replace(m(x - 1 - ue.length), te)), (K.filterText = ue + '</' + V)
                  }
            ...
            function J(x, D) {
              ...
              if (!$t(s, D, W.AfterAttributeName, S.DelimiterAssign)) {
                var K = (L = e?.attributeDefaultValue) !== null && L !== void 0 ? L : 'doublequotes'
                K === 'empty' ? (V = '=$1') : K === 'singlequotes' ? (V = "='$1'") : (V = '="$1"')
              }
              var oe = G()
              return (
                (oe[j] = !1),
                    ...
                    if (!oe[te.name]) {
                      ...
                      te.valueSet !== 'v' &&
                        ...
                        (te.valueSet || te.name === 'style') &&
                          (re = { title: 'Suggest', command: 'editor.action.triggerSuggest' })),
                        a.items.push({
                          label: te.name,
                          kind: te.valueSet === 'handler' ? Q.Function : Q.Value,
            ...
            function p(x, D) {
              ...
              if (u > x && u <= D && di(s[x])) {
                ...
                var K = pi(s, u, O),
                  oe = mi(s, u, V)
                ;(L = m(K, oe)), (j = u >= O && u <= V ? s.substring(O, u) : ''), (q = !1)
              } else (L = m(x, D)), (j = s.substring(x, u)), (q = !0)
              if (c.length > 0)
                for (
                  var ue = g.toLowerCase(), te = y.toLowerCase(), de = m(x, D), re = 0, vt = c;
                  re < vt.length;
                  re++
                ) {
                  var wt = vt[re]
                  wt.onHtmlAttributeValue &&
                    wt.onHtmlAttributeValue({ document: i, position: o, tag: ue, attribute: te, value: j, range: de })
                }
              return (
                l.forEach(function (An) {
                  An.provideValues(g, y).forEach(function (ze) {
                    var _t = q ? '"' + ze.name + '"' : ze.name
                    a.items.push({
                      label: ze.name,
                      filterText: _t,
                      kind: Q.Unit,
                      documentation: le(ze, void 0, r),
            ...
            function b(x) {
              return u === d.getTokenEnd() && ((H = d.scan()), H === x && d.getTokenOffset() === u)
                ? d.getTokenEnd()
                : u
            }
            function N() {
              for (var x = 0, D = c; x < D.length; x++) {
                var L = D[x]
                L.onHtmlContent && L.onHtmlContent({ document: i, position: o })
              }
              return R()
            }
            function R() {
              for (var x = u - 1, D = o.character; x >= 0 && fe(s, x); ) x--, D--
              if (x >= 0 && s[x] === '&') {
                ...
                for (var q in me)
                  if (Gt(q, ';')) {
                    ...
                    a.items.push({
                      label: j,
                      kind: Q.Keyword,
                      documentation: hi('entity.propose', "Character entity representing '".concat(me[q], "'")),
            ...
            for (var H = d.scan(); H !== S.EOS && d.getTokenOffset() <= u; ) {
              switch (H) {
                case S.StartTagOpen:
                  ...
                  break
                case S.StartTag:
                  if (d.getTokenOffset() <= u && u <= d.getTokenEnd()) return A(d.getTokenOffset(), d.getTokenEnd())
                  g = d.getTokenText()
                  break
                case S.AttributeName:
                  if (d.getTokenOffset() <= u && u <= d.getTokenEnd()) return J(d.getTokenOffset(), d.getTokenEnd())
                  y = d.getTokenText()
                  break
                case S.DelimiterAssign:
                  ...
                  break
                case S.AttributeValue:
                  if (d.getTokenOffset() <= u && u <= d.getTokenEnd()) return p(d.getTokenOffset(), d.getTokenEnd())
                  break
                case S.Whitespace:
                  if (u <= d.getTokenEnd())
          ...
          (t.prototype.doQuoteComplete = function (i, o, n, e) {
            var a,
              c = i.offsetAt(o)
            if (c <= 0) return null
            var l = (a = e?.attributeDefaultValue) !== null && a !== void 0 ? a : 'doublequotes'
            if (l === 'empty') return null
            var r = i.getText().charAt(c - 1)
            if (r !== '=') return null
            var s = l === 'doublequotes' ? '"$1"' : "'$1'",
              u = n.findNodeBefore(c)
            if (u && u.attributes && u.start < c && (!u.endTagStart || u.endTagStart > c))
              for (var h = $(i.getText(), u.start), d = h.scan(); d !== S.EOS && h.getTokenEnd() <= c; ) {
                if (d === S.AttributeName && h.getTokenEnd() === c - 1)
                  return (
                    (d = h.scan()),
                    d !== S.DelimiterAssign || ((d = h.scan()), d === S.Unknown || d === S.AttributeValue) ? null : s
                  )
                d = h.scan()
              }
            return null
          ...
          (t.prototype.doTagComplete = function (i, o, n) {
            ...
            if (a === '>') {
              ...
              if (c && c.tag && !pe(c.tag) && c.start < e && (!c.endTagStart || c.endTagStart > e))
                for (var l = $(i.getText(), c.start), r = l.scan(); r !== S.EOS && l.getTokenEnd() <= e; ) {
                  if (r === S.StartTagClose && l.getTokenEnd() === e) return '$0</'.concat(c.tag, '>')
                  r = l.scan()
                }
            } else if (a === '/') {
              for (var c = n.findNodeBefore(e); c && c.closed && !(c.endTagStart && c.endTagStart > e); ) c = c.parent
              if (c && c.tag)
                for (var l = $(i.getText(), c.start), r = l.scan(); r !== S.EOS && l.getTokenEnd() <= e; ) {
                  if (r === S.EndTagOpen && l.getTokenEnd() === e) return ''.concat(c.tag, '>')
                  r = l.scan()
                }
            }
            return null
              ...
              this.doesSupportMarkdown() ||
                i.items.forEach(function (o) {
                  o.documentation &&
                    ...
                    (o.documentation = { kind: 'plaintext', value: o.documentation.value })
                }),
              i
            )
          }),
          (t.prototype.doesSupportMarkdown = function () {
            ...
            if (!Se(this.supportsMarkdown)) {
              if (!Se(this.lsOptions.clientCapabilities)) return (this.supportsMarkdown = !0), this.supportsMarkdown
              var e =
                (n =
                  (o =
                    (i = this.lsOptions.clientCapabilities.textDocument) === null || i === void 0
                      ? void 0
              ...
              this.supportsMarkdown = Array.isArray(e) && e.indexOf(ee.Markdown) !== -1
            }
        ...
        return (
          (t.prototype.doHover = function (i, o, n, e) {
                    ...
                    if (
                      (C.provideTags().forEach(function (D) {
                        if (D.name.toLowerCase() === U.toLowerCase()) {
                          var L = le(D, e, c)
                          L || (L = { kind: c ? 'markdown' : 'plaintext', value: '' }), (x = { contents: L, range: H })
                        }
                      }),
                      x)
                    )
              ...
              for (var I in me) {
                ...
                if (z === T) {
                  var v = me[I].charCodeAt(0).toString(16).toUpperCase(),
                    k = 'U+'
                  if (v.length < 4) for (var C = 4 - v.length, x = 0; x < C; ) (k += '0'), (x += 1)
                  k += v
                  var D = fi(
                    'entity.propose',
                    "Character entity representing '".concat(me[I], "', unicode equivalent '").concat(k, "'"),
                  )
            ...
            function m(U, H) {
              for (
                ...
                I !== S.EOS && (z.getTokenEnd() < l || (z.getTokenEnd() === l && I !== U));
              )
                I = z.scan()
              return I === U && l <= z.getTokenEnd()
                ? { start: i.positionAt(z.getTokenOffset()), end: i.positionAt(z.getTokenEnd()) }
                : null
            }
            function A() {
              for (var U = l - 1, H = o.character; U >= 0 && fe(s, U); ) U--, H--
              for (var z = U + 1, I = H; fe(s, z); ) z++, I++
              if (U >= 0 && s[U] === '&') {
                var F = null
                return (
                  s[z] === ';'
                    ? (F = P.create(X.create(o.line, H), X.create(o.line, I + 1)))
            ...
            if (f) return y(s, f)
            function p(U, H) {
              for (var z = $(i.getText(), U), I = z.scan(), F = void 0; I !== S.EOS && z.getTokenEnd() <= H; )
          ...
          (t.prototype.doesSupportMarkdown = function () {
            ...
            if (!Se(this.supportsMarkdown)) {
              ...
              var e =
                (n =
                  (o = (i = this.lsOptions.clientCapabilities) === null || i === void 0 ? void 0 : i.textDocument) ===
                    null || o === void 0
                    ? void 0
            ...
            ;(a.prototype.clone_empty = function () {
              ...
              (a.prototype._allow_wrap = function () {
                if (this._should_wrap()) {
                  ...
                  return (
                    r.set_indent(this.__wrap_point_indent_count, this.__wrap_point_alignment_count),
                    (r.__items = this.__items.slice(this.__wrap_point_index)),
                    (this.__items = this.__items.slice(0, this.__wrap_point_index)),
                    (r.__character_count += this.__character_count - this.__wrap_point_character_count),
                    (this.__character_count = this.__wrap_point_character_count),
                    r.__items[0] === ' ' && (r.__items.splice(0, 1), (r.__character_count -= 1)),
                    !0
                  )
                }
                return !1
...
`)
              ...
              (a.prototype.toString = function () {
                ...
                return (
                  this.is_empty()
                    ? this.__parent.indent_empty_lines && (r = this.__parent.get_indent_string(this.__indent_count))
                    : ((r = this.__parent.get_indent_string(this.__indent_count, this.__alignment_count)),
                      (r += this.__items.join(''))),
                  r
                )
              })
            function c(r, s) {
              ;(this.__cache = ['']),
                ...
                r.indent_with_tabs || (this.__indent_string = new Array(r.indent_size + 1).join(r.indent_char)),
                (s = s || ''),
                r.indent_level > 0 && (s = new Array(r.indent_level + 1).join(this.__indent_string)),
            ...
            ;(c.prototype.get_indent_size = function (r, s) {
              ...
              return (s = s || 0), r < 0 && (u = 0), (u += r * this.__indent_size), (u += s), u
            }),
...
` && (u = u.replace(/[\n]/g, r)),
          ...
          function (e) {
            ...
            ;(a.prototype._get_array = function (r, s) {
              ...
              return (
                typeof u == 'object'
                  ? u !== null && typeof u.concat == 'function' && (h = u.concat())
...
You passed in: '` +
              ...
              (a.prototype._get_selection_list = function (r, s, u) {
                ...
                if (((u = u || [s[0]]), !this._is_valid_selection(u, s))) throw new Error('Invalid Default Value!')
...
You passed in: '` +
            ...
            ;(e.exports.Options = a), (e.exports.normalizeOpts = l), (e.exports.mergeOpts = c)
          },
          ,
          function (e) {
            ...
            ;(c.prototype.restart = function () {
              ...
              (c.prototype.peek = function (l) {
                ...
                return (
                  (l = l || 0),
                  (l += this.__position),
                  l >= 0 && l < this.__input_length && (r = this.__input.charAt(l)),
                  r
                )
              }),
              ...
              (c.prototype.test = function (l, r) {
                return (
                  (r = r || 0), (r += this.__position), r >= 0 && r < this.__input_length ? !!this.__match(l, r) : !1
                )
              }),
              ...
              (c.prototype.read = function (l, r, s) {
                var u = '',
                  h
                return l && ((h = this.match(l)), h && (u += h[0])), r && (h || !l) && (u += this.readUntil(r, s)), u
              }),
              (c.prototype.readUntil = function (l, r) {
                ...
                return (
                  h ? ((u = h.index), r && (u += h[0].length)) : (u = this.__input_length),
              ...
              (c.prototype.get_regexp = function (l, r) {
                ...
                return (
                  r && a && (u = 'y'),
                  typeof l == 'string' && l !== '' ? (s = new RegExp(l, u)) : l && (s = new RegExp(l.source, u)),
                  s
                )
              }),
              ...
              (c.prototype.lookBack = function (l) {
                ...
                return r >= l.length && this.__input.substring(r - l.length, r).toLowerCase() === l
              }),
          ...
          function (e) {
            function a(c, l) {
              ;(c = typeof c == 'string' ? c : c.source),
                ...
                (this.__directives_block_pattern = new RegExp(c + / beautify( \w+[:]\w+)+ /.source + l, 'g')),
                (this.__directive_pattern = / (\w+)[:](\w+)/g),
                (this.__directives_end_ignore_pattern = new RegExp(c + /\sbeautify\signore:end\s/.source + l, 'g'))
            }
          ...
          function (e, a, c) {
            ...
            ;(w.prototype.eatString = function (M) {
              ...
              for (this._ch = this._input.next(); this._ch; ) {
                if (((B += this._ch), this._ch === '\\')) B += this._input.next()
                else if (
...
`
              ...
              (w.prototype.eatWhitespace = function (M) {
                for (var B = y.test(this._input.peek()), G = 0; y.test(this._input.peek()); )
                  (this._ch = this._input.next()),
                    M &&
                      this._ch ===
                        `
...
`,
                ...
                ;(this._output = new r(this._options, G)),
                  ...
                  (this._ch = null)
                for (
                  var J = 0, f = !1, p = !1, b = !1, N = !1, R = !1, U = this._ch, H, z, I;
                  ...
                  if (this._ch === '/' && this._input.peek() === '*') {
                    ...
                    T && T.ignore === 'start' && (F += h.readIgnored(this._input)),
                      this.print_string(F),
                    ...
                    if ((this.preserveSingleSpace(z), this._input.peek() === '{'))
                      ...
                      v.match(/[ :]$/) &&
                        ...
                        v in this.NESTED_AT_RULE
                          ? ((this._nestedLevel += 1), v in this.CONDITIONAL_GROUP_RULE && (b = !0))
                          : !f && J === 0 && v.indexOf(':') !== -1 && ((p = !0), this.indent())
                    }
                  else
                                ...
                                : this._ch === '('
                                  ? this._input.lookBack('url')
                                    ...
                                    : (this.preserveSingleSpace(z),
                                      ...
                                      this.indent())
                                  : this._ch === ')'
                                    ? (J && (J--, this.outdent()), this.print_string(this._ch))
                                    : this._ch === ','
                                      ? (this.print_string(this._ch),
                                        this.eatWhitespace(!0),
                                        this._options.selector_separator_newline && !p && J === 0 && !R && !N
                                          ? this._output.add_new_line()
                                          : (this._output.space_before_token = !0))
                                      : (this._ch === '>' || this._ch === '+' || this._ch === '~') && !p && J === 0
          ...
          function (e, a, c) {
            ...
            function r(s) {
              ...
              for (var d = 0; d < h.length; d++)
                h[d] !== 'expand' ? (this.brace_style = 'collapse') : (this.brace_style = h[d])
            }
...
You passed in: '` +
          ...
          function (e, a, c) {
            ...
            ;(d.prototype.tokenize = function () {
              ...
              for (var g, y = new r(h.START, ''), m = null, A = [], E = new s(); y.type !== h.EOF; ) {
                for (g = this._get_next_token(y, m); this._is_comment(g); ) E.add(g), (g = this._get_next_token(y, m))
                E.isEmpty() || ((g.comments_before = E), (E = new s())),
                  (g.parent = m),
                  this._is_opening(g)
                    ? (A.push(m), (m = g))
                    : m && this._is_closing(g, m) && ((g.opened = m), (m.closed = g), (m = A.pop()), (g.parent = m)),
                  (g.previous = y),
                  (y.next = g),
                  this.__tokens.add(g),
                  (y = g)
              ...
              (d.prototype._get_next_token = function (g, y) {
                ...
                return m ? this._create_token(h.RAW, m) : this._create_token(h.EOF, '')
              }),
          ...
          function (e) {
            ...
            ;(a.prototype.restart = function () {
              ...
              (a.prototype.next = function () {
                var c = null
                return this.hasNext() && ((c = this.__tokens[this.__position]), (this.__position += 1)), c
              }),
              (a.prototype.peek = function (c) {
                var l = null
                return (
                  (c = c || 0), (c += this.__position), c >= 0 && c < this.__tokens_length && (l = this.__tokens[c]), l
                )
              }),
          ...
          function (e, a, c) {
            ...
            ;(r.prototype = new l()),
              (r.prototype.__set_whitespace_patterns = function (s, u) {
                ;(s += '\\t '),
                  (u += '\\n\\r'),
                  (this._match_pattern = this._input.get_regexp('[' + s + u + ']+', !0)),
              ...
              (r.prototype.read = function () {
                ...
                if (s === ' ') this.whitespace_before_token = ' '
                  ...
                  ;(this.newline_count = u.length - 1), (this.whitespace_before_token = u[this.newline_count])
                }
                return s
              }),
              ...
              (r.prototype.__split = function (s, u) {
                ...
                for (var h = 0, d = [], g = s.exec(u); g; )
                  d.push(u.substring(h, g.index)), (h = g.index + g[0].length), (g = s.exec(u))
                return h < u.length ? d.push(u.substring(h, u.length)) : d.push(''), d
              }),
            ...
            ;(a.prototype.read = function () {
              ...
              return (
                (!this._starting_pattern || c) &&
                  (c += this._input.read(this._match_pattern, this._until_pattern, this._until_after)),
                c
              )
            }),
              ...
              (a.prototype.until_after = function (c) {
                var l = this._create()
                return (l._until_after = !0), (l._until_pattern = this._input.get_regexp(c)), l._update(), l
              }),
              (a.prototype.until = function (c) {
                var l = this._create()
                return (l._until_after = !1), (l._until_pattern = this._input.get_regexp(c)), l._update(), l
              }),
              (a.prototype.starting_with = function (c) {
                var l = this._create()
                return (l._starting_pattern = this._input.get_regexp(c, !0)), l._update(), l
              }),
              (a.prototype.matching = function (c) {
                var l = this._create()
                return (l._match_pattern = this._input.get_regexp(c, !0)), l._update(), l
              }),
          ...
          function (e, a, c) {
            ...
            function s(u, h) {
              l.call(this, u, h),
                ...
                h &&
                  ((this.__template_pattern = this._input.get_regexp(h.__template_pattern)),
                  (this._excluded = Object.assign(this._excluded, h._excluded)),
                  (this._disabled = Object.assign(this._disabled, h._disabled)))
              var d = new l(u)
              this.__patterns = {
            ...
            ;(s.prototype = new l()),
              ...
              (s.prototype.read_options = function (u) {
                var h = this._create()
                for (var d in r) h._disabled[d] = u.templating.indexOf(d) === -1
                return h._update(), h
              }),
              ...
              (s.prototype.read = function () {
                ...
                this._match_pattern
                  ...
                  : (u = this._input.read(this._starting_pattern, this.__template_pattern))
                ...
                return this._until_after && (u += this._input.readUntilAfter(this._until_pattern)), u
              }),
              (s.prototype.__set_templated_pattern = function () {
                var u = []
                this._disabled.php || u.push(this.__patterns.php._starting_pattern.source),
                  this._disabled.handlebars || u.push(this.__patterns.handlebars._starting_pattern.source),
                  this._disabled.erb || u.push(this.__patterns.erb._starting_pattern.source),
                  this._disabled.django ||
                    (u.push(this.__patterns.django._starting_pattern.source),
                    u.push(this.__patterns.django_value._starting_pattern.source),
                    u.push(this.__patterns.django_comment._starting_pattern.source)),
                  this._disabled.smarty || u.push(this.__patterns.smarty._starting_pattern.source),
                  this._until_pattern && u.push(this._until_pattern.source),
                  (this.__template_pattern = this._input.get_regexp('(?:' + u.join('|') + ')'))
              }),
              (s.prototype._read_template = function () {
                ...
                if (h === '<') {
                  ...
                  !this._disabled.php && !this._excluded.php && d === '?' && (u = u || this.__patterns.php.read()),
                    !this._disabled.erb && !this._excluded.erb && d === '%' && (u = u || this.__patterns.erb.read())
                } else
                  h === '{' &&
                    ...
                    this._disabled.django ||
                      ...
                      this._excluded.django ||
                        ((u = u || this.__patterns.django_comment.read()), (u = u || this.__patterns.django.read()))),
          ...
          function (e, a, c) {
            ...
            ;(g.prototype.current_line_has_match = function (f) {
              ...
              (g.prototype.set_space_before_token = function (f, p) {
                ;(this._output.space_before_token = f), (this._output.non_breaking_space = p)
              }),
              ...
              (g.prototype.print_preserved_newlines = function (f) {
                var p = 0
                f.type !== u.TEXT && f.previous.type !== u.TEXT && (p = f.newlines ? 1 : 0),
                  this.preserve_newlines &&
                    (p = f.newlines < this.max_preserve_newlines + 1 ? f.newlines : this.max_preserve_newlines + 1)
                for (var b = 0; b < p; b++) this.print_newline(b > 0)
                return p !== 0
              }),
              (g.prototype.traverse_whitespace = function (f) {
                return f.whitespace_before || f.newlines
                  ? (this.print_preserved_newlines(f) || (this._output.space_before_token = !0), !0)
                  : !1
              }),
              ...
              (g.prototype.print_token = function (f) {
                f.text &&
                  (this._output.set_indent(this.indent_level, this.alignment_size), this._output.add_token(f.text))
              }),
            ...
            var y = function (f) {
                for (var p = null, b = f.next; b.type !== u.EOF && f.closed !== b; ) {
              ...
              m = function (f, p) {
                var b = null,
                  N = null
                return p.closed
                  ? (f === 'script' ? (b = 'text/javascript') : f === 'style' && (b = 'text/css'),
                    (b = y(p) || b),
                    b.search('text/css') > -1
                      ? (N = 'css')
                      : b.search(
            ...
            ;(w.prototype.get_parser_token = function () {
              ...
              (w.prototype.record_tag = function (f) {
                var p = new E(this._current_frame, f, this._printer.indent_level)
...
`,
              ...
              (M.prototype._handle_tag_close = function (f, p, b) {
                ...
                return (
                  (f.alignment_size = 0),
                  (b.tag_complete = !0),
                  f.set_space_before_token(p.newlines || p.whitespace_before !== '', !0),
                  b.is_unformatted
                    ? f.add_raw_token(p)
                    : (b.tag_start_char === '<' &&
                        (f.set_space_before_token(p.text[0] === '/', !0),
                        this._is_wrap_attributes_force_expand_multiline && b.has_wrapped_attrs && f.print_newline(!1)),
                      f.print_token(p)),
                  b.indent_content &&
                    !(b.is_unformatted || b.is_content_unformatted) &&
                    (f.indent(), (b.indent_content = !1)),
                  !b.is_inline_element && !(b.is_unformatted || b.is_content_unformatted) && f.set_wrap_point(),
                  N
                )
              }),
              (M.prototype._handle_inside_tag = function (f, p, b, N) {
                ...
                if ((f.set_space_before_token(p.newlines || p.whitespace_before !== '', !0), b.is_unformatted))
                  f.add_raw_token(p)
                else if (b.tag_start_char === '{' && p.type === u.TEXT)
                  f.print_preserved_newlines(p) ? ((p.newlines = 0), f.add_raw_token(p)) : f.print_token(p)
                else {
                  if (
                    (p.type === u.ATTRIBUTE
                      ? (f.set_space_before_token(!0), (b.attr_count += 1))
                      : (p.type === u.EQUALS || (p.type === u.VALUE && p.previous.type === u.EQUALS)) &&
                    ...
                    if (this._is_wrap_attributes_force_expand_multiline && b.attr_count === 1) {
                      ...
                      do {
                        ...
                        I += 1
                      } while (I < 4 && F.type !== u.EOF && F.type !== u.TAG_CLOSE)
                      H = !z
                    }
                    H && (f.print_newline(!1), (R = !0))
                  }
                  f.print_token(p), (R = R || f.previous_token_wrapped()), (b.has_wrapped_attrs = R)
                }
                return U
              }),
              ...
              (M.prototype._print_custom_beatifier_text = function (f, p, b) {
                ...
                if (p.text !== '') {
                  ...
                  b.custom_beautifier_name === 'javascript' && typeof this._js_beautify == 'function'
                    ? (U = this._js_beautify)
                    : b.custom_beautifier_name === 'css' && typeof this._css_beautify == 'function'
                    ...
                    this._options.indent_scripts === 'keep'
                      ? (H = 0)
                      : this._options.indent_scripts === 'separate' && (H = -f.indent_level)
                  var F = f.get_full_indent(H)
                  if (
                    ((R = R.replace(/\n[ \t]*$/, '')),
                    b.custom_beautifier_name !== 'html' && R[0] === '<' && R.match(/^(<!--|<!\[CDATA\[)/))
                  ) {
                    var T = /^(<!--[^\n]*|<!\[CDATA\[)(\n?)([ \t\n]*)([\s\S]*)(-->|]]>)$/.exec(R)
                    if (!T) {
                      f.add_raw_token(p)
...
`),
                      ...
                      (T[2] ||
                        T[3].indexOf(`
`) !== -1) &&
                        ((T = T[3].match(/[ \t]+$/)), T && (p.whitespace_before = T[0]))
                  }
                  if (R)
                    if (U) {
                      var v = function () {
...
` +
              ...
              (M.prototype._handle_tag_open = function (f, p, b, N) {
                ...
                return (
                  ...
                  p.type === u.TAG_OPEN &&
                  p.text.indexOf('</') === 0
                    ? (f.add_raw_token(p), (R.start_tag_token = this._tag_stack.try_pop(R.tag_name)))
                  ...
                  !R.tag_complete && !R.is_unformatted && (f.alignment_size = R.alignment_size),
                  R
                )
              })
            var B = function (f, p) {
              if (
                ...
                ;(this.tag_start_char = p.text[0]),
                  (this.text = p.text),
                  this.tag_start_char === '<'
                    ? ((b = p.text.match(/^<([^\s>]*)/)), (this.tag_check = b ? b[1] : ''))
                    : ((b = p.text.match(/^{{(?:[\^]|#\*?)?([^\s}]+)/)),
                      (this.tag_check = b ? b[1] : ''),
                      p.text === '{{#>' && this.tag_check === '>' && p.next !== null && (this.tag_check = p.next.text)),
                  ...
                  (this.is_end_tag = !this.is_start_tag || (p.closed && p.closed.text === '/>')),
                  (this.is_end_tag =
                    this.is_end_tag ||
            ...
            ;(M.prototype._get_tag_open_token = function (f) {
              ...
              return (
                ...
                (p.is_end_tag = p.is_end_tag || A(p.tag_check, this._options.void_elements)),
                (p.is_empty_element = p.tag_complete || (p.is_start_tag && p.is_end_tag)),
                (p.is_unformatted = !p.tag_complete && A(p.tag_check, this._options.unformatted)),
                (p.is_content_unformatted = !p.is_empty_element && A(p.tag_check, this._options.content_unformatted)),
                (p.is_inline_element = A(p.tag_name, this._options.inline) || p.tag_start_char === '{'),
                p
              )
            }),
                ...
                if (
                  (b.is_empty_element ||
                    (b.is_end_tag
                      ...
                      : (this._do_optional_end_element(b) && (b.is_inline_element || f.print_newline(!1)),
                  ...
                  A(b.tag_check, this._options.extra_liners) &&
                    (f.print_newline(!1), f._output.just_added_blankline() || f.print_newline(!0)),
                  b.is_empty_element)
                ) {
...
`) === -1) ||
                  ...
                  var H = !1
                  ;(H = b.start_tag_token && b.start_tag_token.multiline_content),
                    (H =
                      H ||
                      (!b.is_inline_element &&
                    ...
                    b.tag_start_char === '<' &&
                      (b.tag_name === 'html'
                        ...
                        : b.tag_name === 'head'
                          ...
                          : b.tag_name === 'body' && (b.indent_content = this._options.indent_body_inner_html)),
              ...
              (M.prototype._calcluate_parent_multiline = function (f, p) {
                p.parent &&
                  ...
                  !((p.is_inline_element || p.is_unformatted) && p.parent.is_inline_element) &&
            ...
            ;(M.prototype._do_optional_end_element = function (f) {
              ...
              if (!(f.is_empty_element || !f.is_start_tag || !f.parent)) {
                if (f.tag_name === 'body') p = p || this._tag_stack.try_pop('head')
                else if (f.tag_name === 'li') p = p || this._tag_stack.try_pop('li', ['ol', 'ul'])
                else if (f.tag_name === 'dd' || f.tag_name === 'dt')
                  (p = p || this._tag_stack.try_pop('dt', ['dl'])), (p = p || this._tag_stack.try_pop('dd', ['dl']))
                else if (f.parent.tag_name === 'p' && G.indexOf(f.tag_name) !== -1) {
                  var b = f.parent.parent
                  ;(!b || J.indexOf(b.tag_name) === -1) && (p = p || this._tag_stack.try_pop('p'))
                } else
                  f.tag_name === 'rp' || f.tag_name === 'rt'
                    ? ((p = p || this._tag_stack.try_pop('rt', ['ruby', 'rtc'])),
                      (p = p || this._tag_stack.try_pop('rp', ['ruby', 'rtc'])))
                    : f.tag_name === 'optgroup'
                      ? (p = p || this._tag_stack.try_pop('optgroup', ['select']))
                      : f.tag_name === 'option'
                        ? (p = p || this._tag_stack.try_pop('option', ['select', 'datalist', 'optgroup']))
                        : f.tag_name === 'colgroup'
                          ...
                          : f.tag_name === 'thead'
                            ...
                            : f.tag_name === 'tbody' || f.tag_name === 'tfoot'
                              ...
                              : f.tag_name === 'tr'
                                ? ((p = p || this._tag_stack.try_pop('caption', ['table'])),
                                  (p = p || this._tag_stack.try_pop('colgroup', ['table'])),
                                  (p = p || this._tag_stack.try_pop('tr', ['table', 'thead', 'tbody', 'tfoot'])))
                                : (f.tag_name === 'th' || f.tag_name === 'td') &&
                                  ((p = p || this._tag_stack.try_pop('td', ['table', 'thead', 'tbody', 'tfoot', 'tr'])),
                                  (p = p || this._tag_stack.try_pop('th', ['table', 'thead', 'tbody', 'tfoot', 'tr'])))
            ...
            var l = c(9).Tokenizer,
              ...
              y = function (m, A) {
                ...
                if (
                  ...
                  this.__patterns.unformatted_content_delimiter = w.matching(M).until_after(M)
                }
              }
            ;(y.prototype = new l()),
              ...
              (y.prototype._get_next_token = function (m, A) {
                ...
                return w === null
                  ...
                  : ((E = E || this._read_open_handlebars(w, A)),
                    ...
                    (E = E || this._create_token(d.UNKNOWN, this._input.next())),
                    E)
              }),
              (y.prototype._read_comment_or_cdata = function (m) {
                ...
                if (m === '<') {
                  ...
                  M === '!' &&
                    ...
                    E
                      ? ((w = g.get_directives(E)), w && w.ignore === 'start' && (E += g.readIgnored(this._input)))
                      : (E = this.__patterns.cdata.read())),
                    E && ((A = this._create_token(d.COMMENT, E)), (A.directives = w))
                }
                return A
              }),
              (y.prototype._read_processing = function (m) {
                ...
                if (m === '<') {
                  var M = this._input.peek(1)
                  ;(M === '!' || M === '?') &&
                    ((E = this.__patterns.conditional_comment.read()), (E = E || this.__patterns.processing.read())),
                    E && ((A = this._create_token(d.COMMENT, E)), (A.directives = w))
                }
                return A
              }),
                  ...
                  A ||
                    (this._options.indent_handlebars &&
                      ...
                      (this._input.peek(2) === '!'
                        ...
                        : ((E = this.__patterns.handlebars_open.read()), (w = this._create_token(d.TAG_OPEN, E))))),
                  w
                )
              }),
              (y.prototype._read_close = function (m, A) {
                ...
                return (
                  A &&
                    (A.text[0] === '<' && (m === '>' || (m === '/' && this._input.peek(1) === '>'))
                      ? ((E = this._input.next()),
                      ...
                      : A.text[0] === '{' &&
                        m === '}' &&
                        this._input.peek(1) === '}' &&
                        (this._input.next(), this._input.next(), (w = this._create_token(d.TAG_CLOSE, '}}')))),
                  w
                )
              }),
              (y.prototype._read_attribute = function (m, A, E) {
                var w = null,
                  M = ''
                if (E && E.text[0] === '<')
                  if (m === '=') w = this._create_token(d.EQUALS, this._input.next())
                  else if (m === '"' || m === "'") {
                    var B = this._input.next()
                    m === '"' ? (B += this.__patterns.double_quote.read()) : (B += this.__patterns.single_quote.read()),
              ...
              (y.prototype._is_content_unformatted = function (m) {
                return (
                  ...
                  (this._options.content_unformatted.indexOf(m) !== -1 || this._options.unformatted.indexOf(m) !== -1)
                )
              }),
              (y.prototype._read_raw_content = function (m, A, E) {
                var w = ''
                if (E && E.text[0] === '{') w = this.__patterns.handlebars_raw_close.read()
                else if (A.type === d.TAG_CLOSE && A.opened.text[0] === '<' && A.text[0] !== '/') {
                  var M = A.opened.text.substr(1).toLowerCase()
                  if (M === 'script' || M === 'style') {
                    var B = this._read_comment_or_cdata(m)
                    if (B) return (B.type = d.TEXT), B
                    w = this._input.readUntil(new RegExp('</' + M + '[\\n\\r\\t ]*?>', 'ig'))
                  } else
    ...
    function sn(t, i, o) {
      ...
      if (i) {
        ...
        ;(u === n.length || an(n, u)) && (s = u), (i = P.create(t.positionAt(l), t.positionAt(s)))
        var h = n.substring(0, l)
        if (new RegExp(/.*[<][^>]*$/).test(h)) return (n = n.substring(l, s)), [{ range: i, newText: n }]
      ...
      var g = {
          ...
          unformatted: mt(o, 'unformatted', void 0),
          content_unformatted: mt(o, 'contentUnformatted', void 0),
          ...
          extra_liners: mt(o, 'extraLiners', void 0),
          wrap_attributes: ie(o, 'wrapAttributes', 'auto'),
          wrap_attributes_indent_size: ie(o, 'wrapAttributesIndentSize', void 0),
          eol: `
`,
          indent_scripts: ie(o, 'indentScripts', 'normal'),
          templating: vi(o, 'all'),
          unformatted_content_delimiter: ie(o, 'unformattedContentDelimiter', ''),
        },
        y = rn(bi(n), g)
      if (a > 0) {
        var m = o.insertSpaces ? pt(' ', c * a) : pt('	', a)
        ;(y = y
          .split(`
`)
          .join(
...
`.indexOf(t.charAt(i)) !== -1
    ...
    ln = (() => {
      ...
      var t = {
          470: n => {
            ...
            function a(l, r) {
              for (var s, u = '', h = 0, d = -1, g = 0, y = 0; y <= l.length; ++y) {
                ...
                if (s === 47) {
                  if (!(d === y - 1 || g === 1))
                    if (d !== y - 1 && g === 2) {
                      if (
                        ...
                        if (u.length > 2) {
                          var m = u.lastIndexOf('/')
                          if (m !== u.length - 1) {
                            m === -1 ? ((u = ''), (h = 0)) : (h = (u = u.slice(0, m)).length - 1 - u.lastIndexOf('/')),
                              (d = y),
                              (g = 0)
                            continue
                          }
                    ...
                    } else u.length > 0 ? (u += '/' + l.slice(d + 1, y)) : (u = l.slice(d + 1, y)), (h = y - d - 1)
                  ;(d = y), (g = 0)
                } else s === 46 && g !== -1 ? ++g : (g = -1)
              }
              return u
            ...
            var c = {
              resolve: function () {
                for (var l, r = '', s = !1, u = arguments.length - 1; u >= -1 && !s; u--) {
                  var h
                  u >= 0 ? (h = arguments[u]) : (l === void 0 && (l = process.cwd()), (h = l)),
                    e(h),
                    h.length !== 0 && ((r = h + '/' + r), (s = h.charCodeAt(0) === 47))
                }
                return (r = a(r, !s)), s ? (r.length > 0 ? '/' + r : '/') : r.length > 0 ? r : '.'
              },
              normalize: function (l) {
                if ((e(l), l.length === 0)) return '.'
                var r = l.charCodeAt(0) === 47,
                  s = l.charCodeAt(l.length - 1) === 47
                return (l = a(l, !r)).length !== 0 || r || (l = '.'), l.length > 0 && s && (l += '/'), r ? '/' + l : l
              },
              ...
              join: function () {
                ...
                for (var l, r = 0; r < arguments.length; ++r) {
                  var s = arguments[r]
                  e(s), s.length > 0 && (l === void 0 ? (l = s) : (l += '/' + s))
                }
                return l === void 0 ? '.' : c.normalize(l)
              },
              relative: function (l, r) {
                if ((e(l), e(r), l === r || (l = c.resolve(l)) === (r = c.resolve(r)))) return ''
                for (var s = 1; s < l.length && l.charCodeAt(s) === 47; ++s);
                for (var u = l.length, h = u - s, d = 1; d < r.length && r.charCodeAt(d) === 47; ++d);
                for (var g = r.length - d, y = h < g ? h : g, m = -1, A = 0; A <= y; ++A) {
                  if (A === y) {
                    if (g > y) {
                      if (r.charCodeAt(d + A) === 47) return r.slice(d + A + 1)
                      if (A === 0) return r.slice(d + A)
                    } else h > y && (l.charCodeAt(s + A) === 47 ? (m = A) : A === 0 && (m = 0))
                    break
                  }
                ...
                var w = ''
                for (A = s + m + 1; A <= u; ++A)
                  (A !== u && l.charCodeAt(A) !== 47) || (w.length === 0 ? (w += '..') : (w += '/..'))
                return w.length > 0 ? w + r.slice(d + m) : ((d += m), r.charCodeAt(d) === 47 && ++d, r.slice(d))
              },
              ...
              dirname: function (l) {
                if ((e(l), l.length === 0)) return '.'
                for (var r = l.charCodeAt(0), s = r === 47, u = -1, h = !0, d = l.length - 1; d >= 1; --d)
                ...
                if (r !== void 0 && r.length > 0 && r.length <= l.length) {
                  ...
                  for (s = l.length - 1; s >= 0; --s) {
                    ...
                    if (m === 47) {
                      ...
                      y === -1 && ((d = !1), (y = s + 1)),
                        g >= 0 && (m === r.charCodeAt(g) ? --g == -1 && (h = s) : ((g = -1), (h = y)))
                  }
                  return u === h ? (h = y) : h === -1 && (h = l.length), l.slice(u, h)
                }
                for (s = l.length - 1; s >= 0; --s)
              ...
              extname: function (l) {
                e(l)
                for (var r = -1, s = 0, u = -1, h = !0, d = 0, g = l.length - 1; g >= 0; --g) {
                  var y = l.charCodeAt(g)
                  if (y !== 47)
                    u === -1 && ((h = !1), (u = g + 1)),
                      y === 46 ? (r === -1 ? (r = g) : d !== 1 && (d = 1)) : r !== -1 && (d = -1)
                  else if (!h) {
                    s = g + 1
                    break
                  }
                }
                return r === -1 || u === -1 || d === 0 || (d === 1 && r === u - 1 && r === s + 1) ? '' : l.slice(r, u)
              },
              format: function (l) {
              ...
              parse: function (l) {
                ...
                var s,
                  ...
                  h = u === 47
                h ? ((r.root = '/'), (s = 1)) : (s = 0)
                for (var d = -1, g = 0, y = -1, m = !0, A = l.length - 1, E = 0; A >= s; --A)
                  if ((u = l.charCodeAt(A)) !== 47)
                    y === -1 && ((m = !1), (y = A + 1)),
                      u === 46 ? (d === -1 ? (d = A) : E !== 1 && (E = 1)) : d !== -1 && (E = -1)
                  else if (!m) {
                    g = A + 1
                    break
                  }
                return (
                  d === -1 || y === -1 || E === 0 || (E === 1 && d === y - 1 && d === g + 1)
                    ? y !== -1 && (r.base = r.name = g === 0 && h ? l.slice(1, y) : l.slice(g, y))
                    : (g === 0 && h
          ...
          447: (n, e, a) => {
            var c
            if ((a.r(e), a.d(e, { URI: () => w, Utils: () => H }), typeof process == 'object'))
              ...
              u =
                ((r = function (T, v) {
                  return (r =
                    ...
                    function (k, C) {
                      for (var x in C) Object.prototype.hasOwnProperty.call(C, x) && (k[x] = C[x])
                    })(T, v)
                }),
                function (T, v) {
                  ...
                  r(T, v), (T.prototype = v === null ? Object.create(v) : ((k.prototype = v.prototype), new k()))
                }),
              h = /^\w[\w\d+.-]*$/,
              d = /^\//,
              g = /^\/\//
                ...
                return (
                  ...
                  (T.prototype.with = function (v) {
                    ...
                    return (
                      ...
                      C === void 0 ? (C = this.authority) : C === null && (C = m),
                      x === void 0 ? (x = this.path) : x === null && (x = m),
                      D === void 0 ? (D = this.query) : D === null && (D = m),
                      L === void 0 ? (L = this.fragment) : L === null && (L = m),
                      k === this.scheme &&
                      C === this.authority &&
                      x === this.path &&
                      D === this.query &&
                  ...
                  (T.parse = function (v, k) {
                    ...
                    var C = E.exec(v)
                    return C
                      ? new B(C[2] || m, U(C[4] || m), U(C[5] || m), U(C[7] || m), U(C[9] || m), k)
                      : new B(m, m, m, m, m)
                  }),
                  (T.file = function (v) {
                    var k = m
                    if ((c && (v = v.replace(/\\/g, A)), v[0] === A && v[1] === A)) {
                      var C = v.indexOf(A, 2)
                      C === -1 ? ((k = v.substring(2)), (v = A)) : ((k = v.substring(2, C)), (v = v.substring(C) || A))
                    }
                    return new B('file', k, v, m, m)
                  }),
                  (T.from = function (v) {
                    var k = new B(v.scheme, v.authority, v.path, v.query, v.fragment)
                    return y(k, !0), k
                  }),
                  ...
                  (T.revive = function (v) {
                    if (v) {
                      ...
                      var k = new B(v)
                      return (k._formatted = v.external), (k._fsPath = v._sep === M ? v.fsPath : null), k
                    }
                    return v
                  }),
                  T
              ...
              B = (function (T) {
                ...
                return (
                  ...
                  (v.prototype.toString = function (k) {
                    return (
                      k === void 0 && (k = !1),
                      k ? b(this, !0) : (this._formatted || (this._formatted = b(this, !1)), this._formatted)
                    )
                  }),
            ...
            function J(T, v) {
              for (var k = void 0, C = -1, x = 0; x < T.length; x++) {
                ...
                if (
                  ...
                  C !== -1 && ((k += encodeURIComponent(T.substring(C, x))), (C = -1)),
                    k !== void 0 && (k += T.charAt(x))
                else {
                  k === void 0 && (k = T.substr(0, x))
                  var L = G[D]
                  L !== void 0
                    ? (C !== -1 && ((k += encodeURIComponent(T.substring(C, x))), (C = -1)), (k += L))
                    : C === -1 && (C = x)
                }
              }
              return C !== -1 && (k += encodeURIComponent(T.substring(C))), k !== void 0 ? k : T
            }
            function f(T) {
              for (var v = void 0, k = 0; k < T.length; k++) {
                var C = T.charCodeAt(k)
                C === 35 || C === 63 ? (v === void 0 && (v = T.substr(0, k)), (v += G[C])) : v !== void 0 && (v += T[k])
              }
              return v !== void 0 ? v : T
            }
            function p(T, v) {
            ...
            function b(T, v) {
              ...
              if ((x && ((C += x), (C += ':')), (D || x === 'file') && ((C += A), (C += A)), D)) {
                ...
                if (O !== -1) {
                  ...
                  ;(D = D.substr(O + 1)),
                    (O = V.indexOf(':')) === -1
                      ? (C += k(V, !1))
                      : ((C += k(V.substr(0, O), !1)), (C += ':'), (C += k(V.substr(O + 1), !1))),
                    (C += '@')
                }
              ...
              if (L) {
                if (L.length >= 3 && L.charCodeAt(0) === 47 && L.charCodeAt(2) === 58)
                  (K = L.charCodeAt(1)) >= 65 &&
                    K <= 90 &&
                    (L = '/'.concat(String.fromCharCode(K + 32), ':').concat(L.substr(3)))
                else if (L.length >= 2 && L.charCodeAt(1) === 58) {
                  var K
                  ;(K = L.charCodeAt(0)) >= 65 &&
                    K <= 90 &&
                    (L = ''.concat(String.fromCharCode(K + 32), ':').concat(L.substr(2)))
                }
                C += k(L, !0)
              }
              return q && ((C += '?'), (C += k(q, !1))), j && ((C += '#'), (C += v ? j : J(j, !1))), C
            }
            function N(T) {
              try {
              ...
              I = function (T, v, k) {
                if (k || arguments.length === 2)
                  for (var C, x = 0, D = v.length; x < D; x++)
                    (!C && x in v) || (C || (C = Array.prototype.slice.call(v, 0, x)), (C[x] = v[x]))
            ...
            ;(function (T) {
              ;(T.joinPath = function (v) {
                ...
                (T.dirname = function (v) {
                  ...
                  return k.length === 1 && k.charCodeAt(0) === 46 ? v : v.with({ path: k })
                }),
      ...
      return (
        (o.d = (n, e) => {
          for (var a in e) o.o(e, a) && !o.o(n, a) && Object.defineProperty(n, a, { enumerable: !0, get: e[a] })
        }),
    ...
    var { URI: un, Utils: Dr } = ln
    function ft(t) {
      var i = t[0],
        o = t[t.length - 1]
      return i === o && (i === "'" || i === '"') && (t = t.substr(1, t.length - 2)), t
    }
    function _i(t, i) {
    ...
    function yi(t, i, o, n) {
      if (!(/^\s*javascript\:/i.test(i) || /[\n\r]/.test(i))) {
        if (((i = i.replace(/^\s*/g, '')), /^https?:\/\//i.test(i) || /^file:\/\//i.test(i))) return i
    ...
    function Ti(t, i, o, n, e, a) {
      var c = ft(o)
      if (_i(c, t.languageId)) {
        c.length < o.length && (n++, e--)
        var l = yi(t.uri, c, i, a)
        if (!(!l || !ki(l))) return { range: P.create(t.positionAt(n), t.positionAt(e)), target: l }
      }
    }
    function ki(t) {
      try {
    ...
    function cn(t, i) {
      for (var o = [], n = $(t.getText(), 0), e = n.scan(), a = void 0, c = !1, l = void 0, r = {}; e !== S.EOS; ) {
        switch (e) {
          case S.StartTag:
            if (!l) {
          ...
          case S.AttributeValue:
            if (a === 'src' || a === 'href') {
              ...
              if (!c) {
                var h = Ti(t, i, u, n.getTokenOffset(), n.getTokenEnd(), l)
                h && o.push(h)
              }
              c && typeof l > 'u' && ((l = ft(u)), l && i && (l = i.resolveReference(l, t.uri))), (c = !1), (a = void 0)
            } else if (a === 'id') {
              var d = ft(n.getTokenText())
    ...
    function mn(t, i, o) {
      ...
      return (
        ((c && dn(c, i)) || (l && dn(l, i))) &&
          (c && a.push({ kind: ye.Read, range: c }), l && a.push({ kind: ye.Read, range: l })),
        a
      )
    }
    function hn(t, i) {
      return t.line < i.line || (t.line === i.line && t.character <= i.character)
    }
    function dn(t, i) {
      return hn(t.start, i) && hn(i, t.end)
    }
    function pn(t, i, o) {
      for (var n = $(i.getText(), o), e = n.scan(); e !== S.EOS && e !== t; ) e = n.scan()
      return e !== S.EOS ? { start: i.positionAt(n.getTokenOffset()), end: i.positionAt(n.getTokenEnd()) } : null
    }
    function fn(t, i) {
      var o = []
      return (
    ...
    function gn(t, i, o, n) {
      var e = Si(i),
        a = ve.create(t.uri, P.create(t.positionAt(i.start), t.positionAt(i.end))),
        c = { name: e, location: a, containerName: o, kind: Le.Field }
      n.push(c),
    ...
    function bn(t, i, o, n) {
      var e,
        a = t.offsetAt(i),
        c = n.findNodeAt(a)
      if (!c.tag || !Ai(c, a, c.tag)) return null
      var l = [],
        r = { start: t.positionAt(c.start + 1), end: t.positionAt(c.start + 1 + c.tag.length) }
      if ((l.push({ range: r, newText: o }), c.endTagStart)) {
        var s = { start: t.positionAt(c.endTagStart + 2), end: t.positionAt(c.endTagStart + 2 + c.tag.length) }
    ...
    function Ai(t, i, o) {
      return t.endTagStart && t.endTagStart + 2 <= i && i <= t.endTagStart + 2 + o.length
        ? !0
        : t.start + 1 <= i && i <= t.start + 1 + o.length
    }
    function vn(t, i, o) {
      var n = t.offsetAt(i),
        e = o.findNodeAt(n)
      if (!e.tag || !e.endTagStart) return null
      if (e.start + 1 <= n && n <= e.start + 1 + e.tag.length) {
        var a = n - 1 - e.start + e.endTagStart + 2
        return t.positionAt(a)
      }
      if (e.endTagStart + 2 <= n && n <= e.endTagStart + 2 + e.tag.length) {
        var a = n - 2 - e.endTagStart + e.start + 1
        return t.positionAt(a)
      }
      return null
    }
    function gt(t, i, o) {
      ...
      return e.endTagStart &&
        ((e.start + 1 <= n && n <= e.start + 1 + a) || (e.endTagStart + 2 <= n && n <= e.endTagStart + 2 + a))
        ? [
            P.create(t.positionAt(e.start + 1), t.positionAt(e.start + 1 + a)),
            P.create(t.positionAt(e.endTagStart + 2), t.positionAt(e.endTagStart + 2 + a)),
          ]
        : null
    }
    function xi(t, i) {
    ...
    function wn(t, i) {
            ...
            if (A)
              if (A[1]) a.push({ startLine: u, tagName: '' })
                ...
                if (h >= 0) {
                  ...
                  a.length = h
                  var y = u
                  ;(u = d.startLine), y > u && l !== u && r({ startLine: u, endLine: y, kind: we.Region })
                }
              }
            else {
              var y = t.positionAt(o.getTokenOffset() + o.getTokenLength()).line
      ...
      return e.length > E ? xi(e, E) : e
    }
    function yn(t, i) {
      function o(n) {
        for (var e = Di(t, n), a = void 0, c = void 0, l = e.length - 1; l >= 0; l--) {
          var r = e[l]
          ;(!a || r[0] !== a[0] || r[1] !== a[1]) &&
            (c = Te.create(P.create(t.positionAt(e[l][0]), t.positionAt(e[l][1])), c)),
            (a = r)
        }
    ...
    function Di(t, i) {
      ...
      if (e.startTagEnd && !e.endTagStart) {
        ...
        var c = P.create(t.positionAt(e.startTagEnd - 2), t.positionAt(e.startTagEnd)),
          l = t.getText(c)
        l === '/>' ? a.unshift([e.start + 1, e.startTagEnd - 2]) : a.unshift([e.start + 1, e.startTagEnd - 1])
        var r = _n(t, e, n)
      ...
      if ((a.unshift([e.start, e.end]), e.start < n && n < e.startTagEnd)) {
        ...
        return e.startTagEnd <= n && n <= e.endTagStart
          ...
          : (n >= e.endTagStart + 2 && a.unshift([e.endTagStart + 2, e.end - 1]), a)
    }
    function Ei(t) {
      for (
        var i = t,
      ...
      for (
        ...
        switch (l) {
          case S.AttributeName: {
            ...
            a <= c.getTokenEnd() && s.unshift([c.getTokenOffset(), c.getTokenEnd()]), (u = !0), (h = c.getTokenOffset())
            break
          }
          case S.AttributeValue: {
            if (!u) break
            ...
            a >= c.getTokenOffset() &&
              ...
              ((d[0] === '"' && d[d.length - 1] === '"') || (d[0] === "'" && d[d.length - 1] === "'")) &&
    ...
    *   To learn about this declaration in Firefox for Mobile, see [this article](https://developer.mozilla.org/en-US/docs/Mobile/Viewport_meta_tag "Mobile/Viewport meta tag").`,
        ...
        },
        {
          ...
          attributes: [
            ...
            {
              name: 'onpopstate',
              description: { kind: 'markdown', value: 'Function to call when the user has navigated session history.' },
            },
            {
              name: 'onstorage',
...
The resource should be downloaded after other higher-priority page resources.`,
        ...
        },
        {
          ...
          attributes: [
            ...
            {
              name: 'type',
              description: { kind: 'markdown', value: 'The MIME\xA0type to use to select the plug-in to instantiate.' },
            },
            {
              name: 'width',
              description: {
...
See [Browser compatibility](#Browser_compatibility) for notes on browser support. See also [Async scripts for asm.js](https://developer.mozilla.org/en-US/docs/Games/Techniques/Async_scripts).`,
      ...
      globalAttributes: [
        ...
        },
        {
          ...
          references: [
            { name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/HTML/Global_attributes/contextmenu' },
          ],
        },
        {
          name: 'dir',
        ...
        },
        {
          ...
          references: [
            { name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/HTML/Global_attributes/exportparts' },
          ],
        },
        {
          name: 'hidden',
        ...
        },
        {
          ...
          valueSet: 'b',
          references: [
            { name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/HTML/Global_attributes/spellcheck' },
          ],
        },
        {
          name: 'style',
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`,
        ...
        {
          name: 'ontimeupdate',
          description: { kind: 'markdown', value: 'The time indicated by the currentTime attribute has been updated.' },
        },
        ...
        },
        {
          ...
          description: { kind: 'markdown', value: 'The pointer is unlikely to produce any more events.' },
        },
        {
          name: 'onpointerdown',
        ...
        {
          name: 'onpointerenter',
          description: { kind: 'markdown', value: 'Pointing device is moved inside the hit-testing boundary.' },
        },
        {
          name: 'onpointerleave',
          description: { kind: 'markdown', value: 'Pointing device is moved out of the hit-testing boundary.' },
        },
        {
        ...
        {
          name: 'onpointerover',
          description: { kind: 'markdown', value: 'The pointing device is moved into the hit-testing boundary.' },
        },
        {
          name: 'onpointerup',
      ...
      valueSets: [
        ...
        },
        {
          ...
          values: [
            {
              name: 'false',
              description: { kind: 'markdown', value: '(default) Indicates the element does not have a popup.' },
            },
    ...
    var Tn = (function () {
      function t(i) {
        ;(this.dataProviders = []), this.setDataProviders(i.useDefaultDataProvider !== !1, i.customDataProviders || [])
      }
      return (
        (t.prototype.setDataProviders = function (i, o) {
          var n
          ;(this.dataProviders = []),
            i && this.dataProviders.push(new Ge('html5', bt)),
    ...
    function kn(t) {
      ...
      return {
        ...
        findOnTypeRenameRanges: gt,
        findLinkedEditingRanges: gt,
      }
    }
    function Sn(t, i) {
      return new Ge(t, i)
    ...
    var Je = class {
      constructor(i, o) {
        ;(this._ctx = i), (this._languageSettings = o.languageSettings), (this._languageId = o.languageId)
        let n = this._languageSettings.data,
          e = n?.useDefaultDataProvider,
          a = []
        if (n?.dataProviders) for (let c in n.dataProviders) a.push(Sn(c, n.dataProviders[c]))
        this._languageService = kn({ useDefaultDataProvider: e, customDataProviders: a })
      }
      async doComplete(i, o) {
        ...
        return Promise.resolve(
          this._languageService.doComplete(n, o, e, this._languageSettings && this._languageSettings.suggest),
        )
      }
      async format(i, o, n) {
      ...
      _getTextDocument(i) {
        ...
        for (let n of o) if (n.uri.toString() === i) return Me.create(i, this._languageId, n.version, n.getValue())
        return null
      }
    }
    function Mi(t, i) {
