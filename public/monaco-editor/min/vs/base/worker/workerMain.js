...
;(function () {
  var X = [
    ...
    J = function (q) {
      for (var n = [], M = 0, A = q.length; M < A; M++) n[M] = X[q[M]]
      return n
    }
  const Ne = this,
  ...
  ;(function (q) {
    ...
    class n {
      ...
      static _isWindows() {
        return typeof navigator < 'u' && navigator.userAgent && navigator.userAgent.indexOf('Windows') >= 0
          ? !0
          : typeof process < 'u'
  ...
  ;(function (q) {
    class n {
      constructor(d, b, p) {
        ;(this.type = d), (this.detail = b), (this.timestamp = p)
      }
    }
    q.LoaderEvent = n
    class M {
      ...
      record(d, b) {
        this._events.push(new n(d, b, q.Utilities.getHighPerformanceTimestamp()))
      }
      getEvents() {
        return this._events
      }
  ...
  ;(function (q) {
    class n {
      ...
      static recursiveClone(A) {
        ...
        return (
          n.forEachProperty(A, (d, b) => {
            b && typeof b == 'object' ? (i[d] = n.recursiveClone(b)) : (i[d] = b)
          }),
          i
        )
      }
      ...
      static getHighPerformanceTimestamp() {
        return (
          this.PERFORMANCE_NOW_PROBED ||
            ...
            (this.HAS_PERFORMANCE_NOW = q.global.performance && typeof q.global.performance.now == 'function')),
          this.HAS_PERFORMANCE_NOW ? q.global.performance.now() : Date.now()
        )
      }
    }
    ;(n.NEXT_ANONYMOUS_ID = 1), (n.PERFORMANCE_NOW_PROBED = !1), (n.HAS_PERFORMANCE_NOW = !1), (q.Utilities = n)
  })(le || (le = {}))
  var le
  ;(function (q) {
    function n(i) {
    ...
    class M {
      static validateConfigurationOptions(d) {
        ...
        if (
          ...
          typeof d.onError != 'function' && (d.onError = b),
          Array.isArray(d.ignoreDuplicateModules) || (d.ignoreDuplicateModules = []),
          d.baseUrl.length > 0 && (q.Utilities.endsWith(d.baseUrl, '/') || (d.baseUrl += '/')),
          typeof d.cspNonce != 'string' && (d.cspNonce = ''),
          typeof d.preferScriptTags > 'u' && (d.preferScriptTags = !1),
          d.nodeCachedData &&
            typeof d.nodeCachedData == 'object' &&
            (typeof d.nodeCachedData.seed != 'string' && (d.nodeCachedData.seed = 'seed'),
            (typeof d.nodeCachedData.writeDelay != 'number' || d.nodeCachedData.writeDelay < 0) &&
      ...
      static mergeConfigurationOptions(d = null, b = null) {
        let p = q.Utilities.recursiveClone(b || {})
        return (
          q.Utilities.forEachProperty(d, (h, o) => {
            h === 'ignoreDuplicateModules' && typeof p.ignoreDuplicateModules < 'u'
              ? (p.ignoreDuplicateModules = p.ignoreDuplicateModules.concat(o))
              : h === 'paths' && typeof p.paths < 'u'
                ? q.Utilities.forEachProperty(o, (L, e) => (p.paths[L] = e))
                : h === 'config' && typeof p.config < 'u'
                  ? q.Utilities.forEachProperty(o, (L, e) => (p.config[L] = e))
                  : (p[h] = q.Utilities.recursiveClone(o))
          }),
    ...
    class A {
      constructor(d, b) {
        if (
          ((this._env = d),
          (this.options = M.mergeConfigurationOptions(b)),
      ...
      _createSortedPathsRules() {
        ;(this.sortedPathsRules = []),
          q.Utilities.forEachProperty(this.options.paths, (d, b) => {
            Array.isArray(b)
              ? this.sortedPathsRules.push({ from: d, to: b })
              : this.sortedPathsRules.push({ from: d, to: [b] })
          }),
          this.sortedPathsRules.sort((d, b) => b.from.length - d.from.length)
      }
      cloneAndMerge(d) {
      ...
      _applyPaths(d) {
        ...
        for (let p = 0, h = this.sortedPathsRules.length; p < h; p++)
          if (((b = this.sortedPathsRules[p]), q.Utilities.startsWith(d, b.from))) {
            let o = []
            for (let L = 0, e = b.to.length; L < e; L++) o.push(b.to[L] + d.substr(b.from.length))
            return o
          }
        return [d]
      }
      ...
      _addUrlArgsIfNecessaryToUrls(d) {
        if (this.options.urlArgs) for (let b = 0, p = d.length; b < p; b++) d[b] = this._addUrlArgsToUrl(d[b])
        return d
      }
      moduleIdToPaths(d) {
        if (
        ...
        let b = d,
          p
        if (!q.Utilities.endsWith(b, '.js') && !q.Utilities.isAbsolutePath(b)) {
          p = this._applyPaths(b)
          for (let h = 0, o = p.length; h < o; h++)
            (this.isBuild() && p[h] === 'empty:') ||
              (q.Utilities.isAbsolutePath(p[h]) || (p[h] = this.options.baseUrl + p[h]),
              !q.Utilities.endsWith(p[h], '.js') && !q.Utilities.containsQueryString(p[h]) && (p[h] = p[h] + '.js'))
        } else !q.Utilities.endsWith(b, '.js') && !q.Utilities.containsQueryString(b) && (b = b + '.js'), (p = [b])
        return this._addUrlArgsIfNecessaryToUrls(p)
      }
      requireToUrl(d) {
        let b = d
        return (
          q.Utilities.isAbsolutePath(b) ||
            ((b = this._applyPaths(b)[0]), q.Utilities.isAbsolutePath(b) || (b = this.options.baseUrl + b)),
          this._addUrlArgsIfNecessaryToUrl(b)
        )
      }
      isBuild() {
      ...
      shouldInvokeFactory(d) {
        return !!(
          ...
          (this.options.buildForceInvokeFactory && this.options.buildForceInvokeFactory[d])
        )
      }
  ...
  ;(function (q) {
    class n {
      ...
      load(o, L, e, a) {
        if (!this._scriptLoader)
          ...
          } else this._env.isNode ? (this._scriptLoader = new d(this._env)) : (this._scriptLoader = new M())
        let u = { callback: e, errorback: a }
        if (this._callbackMap.hasOwnProperty(L)) {
          this._callbackMap[L].push(u)
          return
        }
        ;(this._callbackMap[L] = [u]),
          this._scriptLoader.load(
            o,
            L,
            () => this.triggerCallback(L),
            c => this.triggerErrorback(L, c),
          )
      }
      triggerCallback(o) {
      ...
      triggerErrorback(o, L) {
        ...
        delete this._callbackMap[o]
        for (let a = 0; a < e.length; a++) e[a].errorback(L)
      }
    }
    class M {
      ...
      load(o, L, e, a) {
        if (/^node\|/.test(L)) {
          let u = o.getConfig().getOptionsLiteral(),
            c = b(o.getRecorder(), u.nodeRequire || q.global.nodeRequire),
            m = L.split('|'),
            f = null
          try {
            f = c(m[1])
          ...
          u.setAttribute('async', 'async'), u.setAttribute('type', 'text/javascript'), this.attachListeners(u, e, a)
          const { trustedTypesPolicy: c } = o.getConfig().getOptionsLiteral()
          c && (L = c.createScriptURL(L)), u.setAttribute('src', L)
          const { cspNonce: m } = o.getConfig().getOptionsLiteral()
          m && u.setAttribute('nonce', m), document.getElementsByTagName('head')[0].appendChild(u)
        }
      }
    }
    function A(h) {
    ...
    class i {
      ...
      _canUseEval(o) {
        return this._cachedCanUseEval === null && (this._cachedCanUseEval = A(o)), this._cachedCanUseEval
      }
      load(o, L, e, a) {
        if (/^node\|/.test(L)) {
          ...
          if (
            !(/^((http:)|(https:)|(file:))/.test(L) && L.substring(0, self.origin.length) !== self.origin) &&
            this._canUseEval(o)
          ) {
            fetch(L)
              .then(m => {
              ...
              .then(m => {
                ;(m = `${m}
//# sourceURL=${L}`),
                  (u ? self.eval(u.createScript('', m)) : new Function(m)).call(self),
                  e()
              })
              .then(void 0, a)
            return
          ...
          try {
            u && (L = u.createScriptURL(L)), importScripts(L), e()
          } catch (m) {
            a(m)
          }
        }
    ...
    class d {
      ...
      _initNodeRequire(o, L) {
        const { nodeCachedData: e } = L.getConfig().getOptionsLiteral()
        ...
        u.prototype._compile = function (m, f) {
          ...
          try {
            ...
            ;(C = R.slice(0, 16)), (S.cachedData = R.slice(16)), w.record(60, E)
          } catch {
            w.record(61, E)
          }
          const r = new a._vm.Script(y, S),
            s = r.runInThisContext(S),
            l = a._path.dirname(f),
            _ = c(this),
            g = [this.exports, _, this, f, l, process, Re, Buffer],
            v = s.apply(this.exports, g)
          return a._handleCachedData(r, y, E, !S.cachedData, L), a._verifyCachedData(r, y, E, C, L), v
        }
      }
      load(o, L, e, a) {
        const u = o.getConfig().getOptionsLiteral(),
        ...
        if (/^node\|/.test(L)) {
          ...
          const y = this._path.normalize(L),
            ...
            E = !!u.nodeCachedData,
            S = E ? this._getCachedDataPath(u.nodeCachedData, L) : void 0
          this._readSourceAndCachedData(y, S, f, (C, r, s, l) => {
            if (C) {
              a(C)
              return
            }
            let _
            r.charCodeAt(0) === d._BOM ? (_ = d._PREFIX + r.substring(1) + d._SUFFIX) : (_ = d._PREFIX + r + d._SUFFIX),
              (_ = m(_, y))
            const g = { filename: w, cachedData: s },
              v = this._createAndEvalScript(o, _, g, e, a)
            this._handleCachedData(v, _, S, E && !s, o), this._verifyCachedData(v, _, S, l, o)
          })
        }
      }
      _createAndEvalScript(o, L, e, a, u) {
        const c = o.getRecorder()
        c.record(31, e.filename)
        const m = new this._vm.Script(L, e),
        ...
        return (
          (E.amd = y.amd),
          f.call(q.global, o.getGlobalAMDRequireFunc(), E, e.filename, this._path.dirname(e.filename)),
      ...
      _getCachedDataPath(o, L) {
        const e = this._crypto
            ...
            .update(process.arch, '')
            .digest('hex'),
          a = this._path.basename(L).replace(/\.js$/, '')
        return this._path.join(o.path, `${a}-${e}.code`)
      }
      _handleCachedData(o, L, e, a, u) {
        o.cachedDataRejected
          ? this._fs.unlink(e, c => {
              u.getRecorder().record(62, e), this._createAndWriteCachedData(o, L, e, u), c && u.getConfig().onError(c)
            })
          : a && this._createAndWriteCachedData(o, L, e, u)
      }
      _createAndWriteCachedData(o, L, e, a) {
        let u = Math.ceil(a.getConfig().getOptionsLiteral().nodeCachedData.writeDelay * (1 + Math.random())),
          c = -1,
          m = 0,
          f
        const y = () => {
          setTimeout(() => {
            f || (f = this._crypto.createHash('md5').update(L, 'utf8').digest())
            ...
            if (!(w.length === 0 || w.length === c || m >= 5)) {
              ...
              ;(c = w.length),
                this._fs.writeFile(e, Buffer.concat([f, w]), E => {
                  E && a.getConfig().onError(E), a.getRecorder().record(63, e), y()
                })
            }
          }, u * Math.pow(4, m++))
        }
      ...
      _readSourceAndCachedData(o, L, e, a) {
        if (!L) this._fs.readFile(o, { encoding: 'utf8' }, a)
        else {
          let u,
            c,
            m,
          ...
          this._fs.readFile(o, { encoding: 'utf8' }, (w, E) => {
            ...
            this._fs.readFile(L, (w, E) => {
              !w && E && E.length > 0 ? ((m = E.slice(0, 16)), (c = E.slice(16)), e.record(60, L)) : e.record(61, L),
                y()
            })
        }
      }
      _verifyCachedData(o, L, e, a, u) {
        a &&
          (o.cachedDataRejected ||
            setTimeout(
              () => {
                const c = this._crypto.createHash('md5').update(L, 'utf8').digest()
                a.equals(c) ||
                  (u
                    .getConfig()
                    .onError(
                      new Error(`FAILED TO VERIFY CACHED DATA, deleting stale '${e}' now, but a RESTART IS REQUIRED`),
                    ),
                  this._fs.unlink(e, m => {
  ...
  ;(function (q) {
    ...
    class M {
      ...
      static _invokeFactory(h, o, L, e) {
        return h.shouldInvokeFactory(o)
          ? h.shouldCatchError()
            ? this._safeInvokeFunction(L, e)
            : { returnedValue: L.apply(q.global, e), producedError: null }
      ...
      complete(h, o, L, e) {
        ...
        if (this._callback)
          if (typeof this._callback == 'function') {
            ...
            let u = M._invokeFactory(o, this.strId, this._callback, L)
            ;(a = u.producedError),
        ...
        if (a) {
          ...
          ;(u.phase = 'factory'), (u.moduleId = this.strId), (u.neededBy = e(this.id)), (this.error = u), o.onError(u)
        }
        ;(this.dependencies = null), (this._callback = null), (this._errorback = null), (this.moduleIdResolver = null)
      }
      onDependencyError(h) {
        return (this._isComplete = !0), (this.error = h), this._errorback ? (this._errorback(h), !0) : !1
      }
      isComplete() {
    ...
    class A {
      ...
      getModuleId(h) {
        ...
        return (
          typeof o > 'u' &&
            ((o = this._nextId++), this._strModuleIdToIntModuleId.set(h, o), (this._intModuleIdToStrModuleId[o] = h)),
          o
        )
      }
      getStrModuleId(h) {
    ...
    class d {
      constructor(h, o, L) {
        ;(this.id = h), (this.pluginId = o), (this.pluginParam = L)
      }
    }
    q.PluginDependency = d
    class b {
      constructor(h, o, L, e, a = 0) {
        ;(this._env = h),
      ...
      reset() {
        return new b(this._env, this._scriptLoader, this._defineFunc, this._requireFunc, this._loaderAvailableTimestamp)
      }
      ...
      static _findRelevantLocationInStack(h, o) {
        ...
        for (let u = 0; u < a.length; u++) {
          ...
          if (c) {
            ...
            if (((m = m.substr(w)), (m = L(m)), m === e)) {
              let E = { line: parseInt(f, 10), col: parseInt(y, 10) }
      ...
      getBuildInfo() {
        ...
        for (let L = 0, e = this._modules2.length; L < e; L++) {
          ...
          h[o++] = {
            id: a.strId,
            path: u,
            defineLocation: u && c ? b._findRelevantLocationInStack(u, c) : null,
            dependencies: m,
            shim: null,
            exports: a.exports,
          }
        ...
        return (
          this._recorder ||
            (this._config.shouldRecordStats()
              ? (this._recorder = new q.LoaderEventRecorder(this._loaderAvailableTimestamp))
      ...
      enqueueDefineAnonymousModule(h, o) {
        ...
        let L = null
        this._config.isBuild() && (L = new Error('StackLocation').stack || null),
          (this._currentAnonymousDefineCall = { stack: L, dependencies: h, callback: o })
      }
      defineModule(h, o, L, e, a, u = new n(h)) {
        let c = this._moduleIdProvider.getModuleId(h)
        if (this._modules2[c]) {
          this._config.isDuplicateMessageIgnoredFor(h) || console.warn("Duplicate definition of module '" + h + "'")
          return
        }
        let m = new M(c, h, this._normalizeDependencies(o, u), L, e, u)
        ;(this._modules2[c] = m),
      ...
      _normalizeDependency(h, o) {
        ...
        let L = h.indexOf('!')
        if (L >= 0) {
          let e = o.resolveModule(h.substr(0, L)),
            a = o.resolveModule(h.substr(L + 1)),
      ...
      _normalizeDependencies(h, o) {
        let L = [],
          e = 0
        for (let a = 0, u = h.length; a < u; a++) L[e++] = this._normalizeDependency(h[a], o)
        return L
      }
      _relativeRequire(h, o, L, e) {
        if (typeof o == 'string') return this.synchronousRequire(o, h)
        this.defineModule(q.Utilities.generateAnonymousModule(), o, L, e, null, h)
      }
      synchronousRequire(h, o = new n(h)) {
        let L = this._normalizeDependency(h, o),
      ...
      configure(h, o) {
        ...
        o ? (this._config = new q.Configuration(this._env, h)) : (this._config = this._config.cloneAndMerge(h)),
      ...
      _onLoad(h) {
        if (this._currentAnonymousDefineCall !== null) {
          ...
          ;(this._currentAnonymousDefineCall = null),
            this.defineModule(this._moduleIdProvider.getStrModuleId(h), o.dependencies, o.callback, null, o.stack)
        }
      }
      _createLoadError(h, o) {
        let L = this._moduleIdProvider.getStrModuleId(h),
          e = (this._inverseDependencies2[h] || []).map(u => this._moduleIdProvider.getStrModuleId(u))
        const a = q.ensureError(o)
        return (a.phase = 'loading'), (a.moduleId = L), (a.neededBy = e), a
      }
      _onLoadError(h, o) {
        const L = this._createLoadError(h, o)
        this._modules2[h] ||
          (this._modules2[h] = new M(h, this._moduleIdProvider.getStrModuleId(h), [], () => {}, null, null))
        let e = []
        ...
        for (a.push(L), e[h] = !0; a.length > 0; ) {
          ...
          if (c)
            for (let m = 0, f = c.length; m < f; m++) {
              ...
              w && !e[y.id] && ((e[y.id] = !0), a.push(w))
            }
        }
        return !1
      }
      _findCyclePath(h, o, L) {
        if (h === o || L === 50) return [h]
        let e = this._modules2[h]
        if (!e) return null
        let a = e.dependencies
        if (a)
          for (let u = 0, c = a.length; u < c; u++) {
            let m = this._findCyclePath(a[u].id, o, L + 1)
            if (m !== null) return m.push(h), m
          }
        return null
      }
      _createRequire(h) {
        let o = (L, e, a) => this._relativeRequire(h, L, e, a)
        return (
          (o.toUrl = L => this._config.requireToUrl(h.resolveModule(L))),
      ...
      _loadModule(h) {
        ...
        let a = -1,
          u = c => {
            if ((a++, a >= L.length)) this._onLoadError(h, c)
            else {
              let m = L[a],
                f = this.getRecorder()
              ...
              f.record(10, m),
                this._scriptLoader.load(
                  ...
                  m,
                  () => {
                    this._config.isBuild() && (this._buildInfoPath[h] = m), f.record(11, m), this._onLoad(h)
                  },
                  y => {
                    f.record(12, m), u(y)
                  },
      ...
      _loadPluginDependency(h, o) {
        ...
        ;(L.error = e => {
          ...
          h.load(o.pluginParam, this._createRequire(n.ROOT), L, this._config.getOptionsLiteral())
      }
      _resolve(h) {
          ...
          for (let L = 0, e = o.length; L < e; L++) {
            ...
            if (this._hasDependencyPath(a.id, h.id)) {
              ...
              c.reverse(),
                ...
                console.warn(
                  c
                    .map(m => this._moduleIdProvider.getStrModuleId(m))
                    .join(` => 
`),
                ),
                h.unresolvedDependenciesCount--
            ...
            if (
              ((this._inverseDependencies2[a.id] = this._inverseDependencies2[a.id] || []),
      ...
      _onModuleComplete(h) {
        ...
        if (L)
          for (let m = 0, f = L.length; m < f; m++) {
            ...
            if (y === i.MODULE) {
              e[m] = { id: h.strId, config: () => this._config.getConfigForModule(h.strId) }
              continue
            }
            if (y === i.REQUIRE) {
        ...
        const a = m => (this._inverseDependencies2[m] || []).map(f => this._moduleIdProvider.getStrModuleId(f))
        ...
        if (c) {
          ...
          for (let m = 0, f = c.length; m < f; m++) this._loadPluginDependency(h.exports, c[m])
        }
      }
    }
    q.ModuleManager = b
  ...
  ;(function (q) {
    ...
    let M = null
    const A = function (p, h, o) {
      typeof p != 'string' && ((o = h), (h = p), (p = null)),
        (typeof h != 'object' || !Array.isArray(h)) && ((o = h), (h = null)),
        h || (h = ['require', 'exports', 'module']),
        p ? M.defineModule(p, h, o, null, null) : M.enqueueDefineAnonymousModule(h, o)
    }
    A.amd = { jQuery: !0 }
    const i = function (p, h = !1) {
        M.configure(p, h)
      },
      d = function () {
    ...
    function b() {
      if (typeof q.global.require < 'u' || typeof require < 'u') {
        ...
        if (typeof p == 'function' && typeof p.resolve == 'function') {
          const h = q.ensureRecordedNodeRequire(M.getRecorder(), p)
    ...
    ;(q.init = b),
      (typeof q.global.define != 'function' || !q.global.define.amd) &&
        ((M = new q.ModuleManager(n, q.createScriptLoader(n), A, d, q.Utilities.getHighPerformanceTimestamp())),
        typeof q.global.require < 'u' && typeof q.global.require != 'function' && d.config(q.global.require),
        (Y = function () {
          return A.apply(null, arguments)
        }),
        (Y.amd = A.amd),
        typeof doNotInitLoader > 'u' && b())
  })(le || (le = {})),
    Y(X[19], J([0, 1]), function (q, n) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.load = n.create = n.setPseudoTranslation = n.getConfiguredDefaultLocale = n.localize2 = n.localize = void 0)
          ...
          y.length === 0
            ...
            : (w = f.replace(/\{(\d+)\}/g, (E, S) => {
                ...
                return (
                  typeof r == 'string'
                    ? (s = r)
                    : (typeof r == 'number' || typeof r == 'boolean' || r === void 0 || r === null) && (s = String(r)),
                  s
                )
              })),
      ...
      function o(f) {
        return (y, w, ...E) => ({ value: i(f[y], E), original: i(w, E) })
      }
      function L(f, y, ...w) {
        return i(y, w)
      }
      ...
      function m(f, y, w, E) {
        ...
        if (!f || f.length === 0)
          return w({
            ...
            getConfiguredDefaultLocale: () => {
              var g
              return (g = C.availableLanguages) === null || g === void 0 ? void 0 : g['*']
            },
          })
        ...
        const _ = g => {
          Array.isArray(g)
            ? ((g.localize = h(g)), (g.localize2 = o(g)))
            : ((g.localize = h(g[f])), (g.localize2 = o(g[f]))),
        ...
        typeof C.loadBundle == 'function'
          ? C.loadBundle(f, r, (g, v) => {
              g ? y([f + '.nls'], _) : _(v)
            })
          : C.translationServiceUrl && !s
            ? (async () => {
                var g
                try {
                  ...
                  if (!r.includes('-')) return console.error(v), y([f + '.nls'], _)
                  try {
                    const R = r.split('-')[0],
                      N = await p(C.translationServiceUrl, R, f)
                    return (
                      ((g = C.availableLanguages) !== null && g !== void 0) || (C.availableLanguages = {}),
                      (C.availableLanguages['*'] = R),
                      _(N)
                    )
                  } catch (R) {
                    return console.error(R), y([f + '.nls'], _)
                  }
                }
              })()
            : y([f + l], _, g => {
                if (l === '.nls') {
                  console.error('Failed trying to load default language strings', g)
                  return
                }
                console.error(
    ...
    (function () {
      ...
      function M(L, e) {
        ...
        try {
          return (a = self.trustedTypes) === null || a === void 0 ? void 0 : a.createPolicy(L, e)
        } catch (u) {
          console.warn(u)
          return
        }
      ...
      function i() {
        try {
          return (A ? globalThis.eval(A.createScript('', 'true')) : new Function('true')).call(globalThis), !0
        } catch {
          return !1
        }
      }
      function d() {
        return new Promise((L, e) => {
          ...
          if (
            !(
              /^((http:)|(https:)|(file:))/.test(a) && a.substring(0, globalThis.origin.length) !== globalThis.origin
            ) &&
            i()
          ) {
            fetch(a)
              ...
              .then(c => {
                ;(c = `${c}
//# sourceURL=${a}`),
                  (A ? globalThis.eval(A.createScript('', c)) : new Function(c)).call(globalThis),
                  L()
              })
              .then(void 0, e)
            return
          }
          A ? importScripts(A.createScriptURL(a)) : importScripts(a), L()
        })
      }
      function b() {
        require.config({ baseUrl: n, catchError: !0, trustedTypesPolicy: A, amdModulesPattern: /^vs\// })
      }
      function p(L) {
        d().then(() => {
          b(),
            require([L], function (e) {
              setTimeout(function () {
                const a = e.create((u, c) => {
                  globalThis.postMessage(u, c)
                }, null)
                for (globalThis.onmessage = u => a.onmessage(u.data, u.ports); o.length > 0; ) {
                  const u = o.shift()
      ...
      typeof globalThis.define == 'function' && globalThis.define.amd && b()
      let h = !0
      const o = []
    ...
    Y(X[7], J([0, 1]), function (q, n) {
      ...
      n.tail2 = A
      function i(k, O, I = (W, z) => W === z) {
        if (k === O) return !0
        if (!k || !O || k.length !== O.length) return !1
        for (let W = 0, z = k.length; W < z; W++) if (!I(k[W], O[W])) return !1
        return !0
      }
      n.equals = i
      function d(k, O) {
      ...
      function h(k, O, I) {
        ...
        for (const se of O) {
          const ce = I(se, W)
          ce < 0 ? z.push(se) : ce > 0 ? G.push(se) : t.push(se)
        }
        return k < z.length ? h(k, z, I) : k < z.length + t.length ? t[0] : h(k - (z.length + t.length), G, I)
      }
      n.quickSelect = h
      function o(k, O) {
        const I = []
        let W
        for (const z of k.slice(0).sort(O)) !W || O(W[0], z) !== 0 ? ((W = [z]), I.push(W)) : W.push(z)
        return I
      }
      n.groupBy = o
      function* L(k, O) {
        let I, W
        for (const z of k) W !== void 0 && O(W, z) ? I.push(z) : (I && (yield I), (I = [z])), (W = z)
        I && (yield I)
      }
      n.groupAdjacentBy = L
      function e(k, O) {
        for (let I = 0; I <= k.length; I++) O(I === 0 ? void 0 : k[I - 1], I === k.length ? void 0 : k[I])
      }
      n.forEachAdjacent = e
      function a(k, O) {
        for (let I = 0; I < k.length; I++) O(I === 0 ? void 0 : k[I - 1], k[I], I + 1 === k.length ? void 0 : k[I + 1])
      }
      ...
      function E(k, O) {
        ...
        const W = []
        if (I <= O) for (let z = I; z < O; z++) W.push(z)
        else for (let z = I; z > O; z--) W.push(z)
        return W
      }
      n.range = E
      function S(k, O, I) {
      ...
      function _(k, O, I) {
        const W = v(k, O),
          ...
          G = I.length
        k.length = z + G
        for (let t = z - 1; t >= W; t--) k[t + G] = k[t]
        for (let t = 0; t < G; t++) k[t + W] = I[t]
      }
      n.insertInto = _
      function g(k, O, I, W) {
        const z = v(k, O)
        let G = k.splice(z, I)
        return G === void 0 && (G = []), _(k, z, W), G
      }
      n.splice = g
      function v(k, O) {
      ...
      ;(function (k) {
        ...
        ;(k.isNeitherLessOrGreaterThan = z), (k.greaterThan = 1), (k.lessThan = -1), (k.neitherLessOrGreaterThan = 0)
      })(R || (n.CompareResult = R = {}))
      function N(k, O) {
        return (I, W) => O(k(I), k(W))
      }
      n.compareBy = N
      function D(...k) {
        return (O, I) => {
          for (const W of k) {
            const z = W(O, I)
            if (!R.isNeitherLessOrGreaterThan(z)) return z
          }
      ...
      class B {
        ...
        takeWhile(O) {
          ...
          const W = I === this.firstIdx ? null : this.items.slice(this.firstIdx, I)
          return (this.firstIdx = I), W
        }
        takeFromEndWhile(O) {
          let I = this.lastIdx
          for (; I >= 0 && O(this.items[I]); ) I--
          const W = I === this.lastIdx ? null : this.items.slice(I + 1, this.lastIdx + 1)
          return (this.lastIdx = I), W
        }
        peek() {
      ...
      class V {
        ...
        filter(O) {
          return new V(I => this.iterate(W => (O(W) ? I(W) : !0)))
        }
        map(O) {
          return new V(I => this.iterate(W => I(O(W))))
        }
        findLast(O) {
          let I
          return this.iterate(W => (O(W) && (I = W), !0)), I
        }
        findLastMaxBy(O) {
          let I,
            W = !0
          return this.iterate(z => ((W || R.isGreaterThan(O(z, I))) && ((W = !1), (I = z)), !0)), I
        }
      }
      ;(n.CallbackIterable = V), (V.empty = new V(k => {}))
    }),
    Y(X[11], J([0, 1]), function (q, n) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.mapFindFirst =
          n.findMaxIdxBy =
      ...
      n.findFirstMonotonous = b
      function p(c, m, f = 0, y = c.length) {
        let w = f,
          E = y
        for (; w < E; ) {
          const S = Math.floor((w + E) / 2)
        ...
        findLastMonotonous(m) {
          if (h.assertInvariants) {
            if (this._prevFindLastPredicate) {
              for (const y of this._array)
                if (this._prevFindLastPredicate(y) && !m(y))
                  throw new Error(
    ...
    Y(X[32], J([0, 1]), function (q, n) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }), (n.CachedFunction = n.LRUCachedFunction = void 0)
      class M {
        constructor(d) {
        ...
        get(d) {
          ...
          return this.lastArgKey !== b && ((this.lastArgKey = b), (this.lastCache = this.fn(d))), this.lastCache
        }
      }
      ...
      class A {
        ...
        get(d) {
          ...
          const b = this.fn(d)
          return this._map.set(d, b), b
        }
      }
      n.CachedFunction = A
    }),
    Y(X[33], J([0, 1]), function (q, n) {
      'use strict'
      ...
      class i {
        constructor(h, o, L, e) {
          ;(this._hslaBrand = void 0),
            ...
            (this.l = M(Math.max(Math.min(1, L), 0), 3)),
            (this.a = M(Math.max(Math.min(1, e), 0), 3))
        }
        static equals(h, o) {
        ...
        static fromRGBA(h) {
          ...
          const y = (c + u) / 2,
            w = u - c
          if (w > 0) {
            switch (((f = Math.min(y <= 0.5 ? w / (2 * y) : w / (2 - 2 * y), 1)), u)) {
              case o:
                m = (L - e) / w + (L < e ? 6 : 0)
                break
              case L:
          ...
          return new i(m, f, y, a)
        }
        static _hue2rgb(h, o, L) {
          return (
            L < 0 && (L += 1),
            L > 1 && (L -= 1),
            L < 1 / 6 ? h + (o - h) * 6 * L : L < 1 / 2 ? o : L < 2 / 3 ? h + (o - h) * (2 / 3 - L) * 6 : h
          )
        }
        static toRGBA(h) {
          const o = h.h / 360,
          ...
          if (L === 0) u = c = m = e
            ...
            const f = e < 0.5 ? e * (1 + L) : e + L - e * L,
              y = 2 * e - f
            ;(u = i._hue2rgb(y, f, o + 1 / 3)), (c = i._hue2rgb(y, f, o)), (m = i._hue2rgb(y, f, o - 1 / 3))
          }
      ...
      class d {
        constructor(h, o, L, e) {
          ;(this._hsvaBrand = void 0),
            (this.h = Math.max(Math.min(360, h), 0) | 0),
            (this.s = M(Math.max(Math.min(1, o), 0), 3)),
            (this.v = M(Math.max(Math.min(1, L), 0), 3)),
            (this.a = M(Math.max(Math.min(1, e), 0), 3))
        }
        static equals(h, o) {
      ...
      class b {
        static fromHex(h) {
          return b.Format.CSS.parseHex(h) || b.red
        }
        static equals(h, o) {
        ...
        equals(h) {
          return !!h && A.equals(this.rgba, h.rgba) && i.equals(this.hsla, h.hsla) && d.equals(this.hsva, h.hsva)
        }
        getRelativeLuminance() {
          const h = b._relativeLuminanceForComponent(this.rgba.r),
            o = b._relativeLuminanceForComponent(this.rgba.g),
            L = b._relativeLuminanceForComponent(this.rgba.b),
            e = 0.2126 * h + 0.7152 * o + 0.0722 * L
          return M(e, 4)
        }
        ...
        lighten(h) {
          return new b(new i(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * h, this.hsla.a))
        }
        darken(h) {
          return new b(new i(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * h, this.hsla.a))
        }
        transparent(h) {
          const { r: o, g: L, b: e, a } = this.rgba
          return new b(new A(o, L, e, a * h))
        }
        isTransparent() {
        ...
        opposite() {
          return new b(new A(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a))
        }
        makeOpaque(h) {
          if (this.isOpaque() || h.rgba.a !== 1) return this
          const { r: o, g: L, b: e, a } = this.rgba
          return new b(
            new A(h.rgba.r - a * (h.rgba.r - o), h.rgba.g - a * (h.rgba.g - L), h.rgba.b - a * (h.rgba.b - e), 1),
          )
        }
        toString() {
          return this._toString || (this._toString = b.Format.CSS.format(this)), this._toString
        }
        static getLighterColor(h, o, L) {
          if (h.isLighterThan(o)) return h
          L = L || 0.5
          const e = h.getRelativeLuminance(),
            a = o.getRelativeLuminance()
          return (L = (L * (a - e)) / a), h.lighten(L)
        }
        static getDarkerColor(h, o, L) {
          if (h.isDarkerThan(o)) return h
          L = L || 0.5
          const e = h.getRelativeLuminance(),
            a = o.getRelativeLuminance()
          return (L = (L * (e - a)) / e), h.darken(L)
        }
      }
      ;(n.Color = b),
        (b.white = new b(new A(255, 255, 255, 1))),
        (b.black = new b(new A(0, 0, 0, 1))),
        (b.red = new b(new A(255, 0, 0, 1))),
        (b.blue = new b(new A(0, 0, 255, 1))),
        (b.green = new b(new A(0, 255, 0, 1))),
        (b.cyan = new b(new A(0, 255, 255, 1))),
        (b.lightgrey = new b(new A(211, 211, 211, 1))),
        (b.transparent = new b(new A(0, 0, 0, 0))),
        (function (p) {
          let h
          ;(function (o) {
            let L
            ;(function (e) {
              ...
              function c(r) {
                return r.hsla.a === 1
                  ...
                  : p.Format.CSS.formatHSLA(r)
              }
              e.formatHSL = c
              function m(r) {
                return `hsla(${r.hsla.h}, ${(r.hsla.s * 100).toFixed(2)}%, ${(r.hsla.l * 100).toFixed(
                  2,
                )}%, ${r.hsla.a.toFixed(2)})`
              }
              e.formatHSLA = m
              ...
              function S(r) {
                ...
                if (s === 7) {
                  const l = 16 * C(r.charCodeAt(1)) + C(r.charCodeAt(2)),
                    _ = 16 * C(r.charCodeAt(3)) + C(r.charCodeAt(4)),
                    g = 16 * C(r.charCodeAt(5)) + C(r.charCodeAt(6))
                  return new p(new A(l, _, g, 1))
                }
                if (s === 9) {
                  const l = 16 * C(r.charCodeAt(1)) + C(r.charCodeAt(2)),
                    _ = 16 * C(r.charCodeAt(3)) + C(r.charCodeAt(4)),
                  ...
                  return new p(new A(l, _, g, v / 255))
                }
                if (s === 4) {
                  const l = C(r.charCodeAt(1)),
                    _ = C(r.charCodeAt(2)),
                    g = C(r.charCodeAt(3))
                  return new p(new A(16 * l + l, 16 * _ + _, 16 * g + g))
                }
                if (s === 5) {
                  const l = C(r.charCodeAt(1)),
                    _ = C(r.charCodeAt(2)),
                    g = C(r.charCodeAt(3)),
                    v = C(r.charCodeAt(4))
                  return new p(new A(16 * l + l, 16 * _ + _, 16 * g + g, (16 * v + v) / 255))
                }
                return null
              }
              e.parseHex = S
    ...
    Y(X[34], J([0, 1]), function (q, n) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }), (n.DiffChange = void 0)
      class M {
        constructor(i, d, b, p) {
          ;(this.originalStart = i), (this.originalLength = d), (this.modifiedStart = b), (this.modifiedLength = p)
        }
        getOriginalEnd() {
...
` +
      ...
      function A(m) {
        p(m) || n.errorHandler.onUnexpectedError(m)
      }
      n.onUnexpectedError = A
      function i(m) {
        p(m) || n.errorHandler.onUnexpectedExternalError(m)
      }
      n.onUnexpectedExternalError = i
      function d(m) {
        if (m instanceof Error) {
          const { name: f, message: y } = m,
            w = m.stacktrace || m.stack
          return { $isError: !0, name: f, message: y, stack: w, noTelemetry: u.isErrorNoTelemetry(m) }
        }
        return m
      }
      ...
      const b = 'Canceled'
      function p(m) {
        return m instanceof h ? !0 : m instanceof Error && m.name === b && m.message === b
      }
      n.isCancellationError = p
      class h extends Error {
        constructor() {
          super(b), (this.name = this.message)
        }
      }
      ...
      class c extends Error {
        constructor(f) {
          super(f || 'An unexpected bug occurred.'), Object.setPrototypeOf(this, c.prototype)
        }
      }
      n.BugIndicatingError = c
    }),
    Y(X[12], J([0, 1, 5]), function (q, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.checkAdjacentItems = n.assertFn = n.softAssert = n.assertNever = n.ok = void 0)
      function A(h, o) {
        if (!h) throw new Error(o ? `Assertion failed (${o})` : 'Assertion Failed')
      }
      n.ok = A
      function i(h, o = 'Unreachable') {
        throw new Error(o)
      }
      n.assertNever = i
      function d(h) {
        h || (0, M.onUnexpectedError)(new M.BugIndicatingError('Assertion Failed'))
      }
      n.softAssert = d
      function b(h) {
        if (!h()) {
    ...
    Y(X[20], J([0, 1]), function (q, n) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }), (n.createSingleCallFunction = void 0)
      function M(A, i) {
        const d = this
        let b = !1,
          p
        return function () {
          ...
          if (((b = !0), i))
            try {
              p = A.apply(d, arguments)
            } finally {
              i()
            }
          else p = A.apply(d, arguments)
          return p
        }
      }
      n.createSingleCallFunction = M
    }),
    Y(X[21], J([0, 1]), function (q, n) {
      'use strict'
      ...
      ;(function (A) {
        ...
        A.from = o
        function* L(r) {
          for (let s = r.length - 1; s >= 0; s--) yield r[s]
        }
        A.reverse = L
        function e(r) {
        ...
        A.first = a
        function u(r, s) {
          for (const l of r) if (s(l)) return !0
          return !1
        }
        A.some = u
        function c(r, s) {
          for (const l of r) if (s(l)) return l
        }
        A.find = c
        function* m(r, s) {
          for (const l of r) s(l) && (yield l)
        }
        A.filter = m
        function* f(r, s) {
          let l = 0
          for (const _ of r) yield s(_, l++)
        }
        A.map = f
        function* y(...r) {
        ...
        function w(r, s, l) {
          let _ = l
          for (const g of r) _ = s(_, g)
          return _
        }
        A.reduce = w
        function* E(r, s, l = r.length) {
          for (s < 0 && (s += r.length), l < 0 ? (l += r.length) : l > r.length && (l = r.length); s < l; s++)
            yield r[s]
        }
        A.slice = E
        function S(r, s = Number.POSITIVE_INFINITY) {
          const l = []
          if (s === 0) return [l, r]
          const _ = r[Symbol.iterator]()
          for (let g = 0; g < s; g++) {
            const v = _.next()
            if (v.done) return [l, A.empty()]
            l.push(v.value)
          }
          return [
            l,
        ...
        async function C(r) {
          const s = []
          for await (const l of r) s.push(l)
          return Promise.resolve(s)
        }
        A.asyncToArray = C
      })(M || (n.Iterable = M = {}))
    }),
    Y(X[35], J([0, 1]), function (q, n) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.KeyChord =
          n.KeyCodeUtils =
        ...
        for (const m of a) {
          ...
          if (
            (c[y] ||
              ...
              (h[w.toLowerCase()] = y),
              f &&
                ((n.IMMUTABLE_CODE_TO_KEY_CODE[y] = E),
                E !== 0 &&
                  E !== 3 &&
                  E !== 5 &&
                  E !== 4 &&
                  E !== 6 &&
                  E !== 57 &&
                  (n.IMMUTABLE_KEY_CODE_TO_CODE[E] = y))),
            !u[E])
          ) {
            if (((u[E] = !0), !S))
              throw new Error(`String representation missing for key code ${E} around scan code ${w}`)
            A.define(E, S), i.define(E, s || S), d.define(E, l || s || S)
          }
          C && (n.EVENT_KEY_CODE_MAP[C] = E), r && (n.NATIVE_WINDOWS_KEY_CODE_TO_KEY_CODE[r] = E)
        }
    ...
    Y(X[13], J([0, 1, 20, 21]), function (q, n, M, A) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.DisposableMap =
          n.ImmortalReference =
      ...
      function u(r) {
        if (A.Iterable.is(r)) {
          ...
          if (s.length > 1) throw new AggregateError(s, 'Encountered errors while disposing of store')
      ...
      ;(n.Disposable = y), (y.None = Object.freeze({ dispose() {} }))
      class w {
        constructor() {
        ...
        set value(s) {
          ...
          this._isDisposed ||
            s === this._value ||
            ((l = this._value) === null || l === void 0 || l.dispose(), s && o(s, this), (this._value = s))
        }
        clear() {
          this.value = void 0
        }
      ...
      class C {
        ...
        set(s, l, _ = !1) {
          ...
          this._isDisposed &&
            ...
            _ || (g = this._store.get(s)) === null || g === void 0 || g.dispose(),
            this._store.set(s, l)
        }
        deleteAndDispose(s) {
          var l
          ;(l = this._store.get(s)) === null || l === void 0 || l.dispose(), this._store.delete(s)
        }
        [Symbol.iterator]() {
    ...
    Y(X[22], J([0, 1]), function (q, n) {
      ...
      class A {
        ...
        clear() {
          ...
          for (; d !== M.Undefined; ) {
            const b = d.next
            ;(d.prev = M.Undefined), (d.next = M.Undefined), (d = b)
          }
          ;(this._first = M.Undefined), (this._last = M.Undefined), (this._size = 0)
        }
        unshift(d) {
        ...
        _insert(d, b) {
          const p = new M(d)
          if (this._first === M.Undefined) (this._first = p), (this._last = p)
          else if (b) {
            const o = this._last
          ...
          if (d.prev !== M.Undefined && d.next !== M.Undefined) {
            ...
            d.prev === M.Undefined && d.next === M.Undefined
              ...
              : d.next === M.Undefined
                ...
                : d.prev === M.Undefined && ((this._first = this._first.next), (this._first.prev = M.Undefined))
          this._size -= 1
        }
        *[Symbol.iterator]() {
          let d = this._first
    ...
    Y(X[37], J([0, 1]), function (q, n) {
      ...
      class b {
        constructor(a, u) {
          if (((this[M] = 'ResourceMap'), a instanceof b))
            (this.map = new Map(a.map)), (this.toKey = u ?? b.defaultToKey)
          else if (d(a)) {
            ;(this.map = new Map()), (this.toKey = u ?? b.defaultToKey)
            for (const [c, m] of a) this.set(c, m)
          } else (this.map = new Map()), (this.toKey = a ?? b.defaultToKey)
        }
        set(a, u) {
        ...
        get(a) {
          var u
          return (u = this.map.get(this.toKey(a))) === null || u === void 0 ? void 0 : u.value
        }
        has(a) {
      ...
      ;(n.ResourceMap = b), (b.defaultToKey = e => e.toString())
      class p {
        constructor() {
          ;(this[A] = 'LinkedMap'),
            (this._map = new Map()),
        ...
        forEach(a, u) {
          ...
          let m = this._head
          for (; m; ) {
            if ((u ? a.bind(u)(m.value, m.key, this) : a(m.value, m.key, this), this._state !== c))
        ...
        keys() {
          ...
          const m = {
            ...
            next() {
              if (a._state !== u) throw new Error('LinkedMap got modified during iteration.')
              if (c) {
        ...
        touch(a, u) {
          ...
          if (!(u !== 1 && u !== 2)) {
            if (u === 1) {
              ...
              const c = a.next,
                m = a.previous
              a === this._tail ? ((m.next = void 0), (this._tail = m)) : ((c.previous = m), (m.next = c)),
                (a.previous = void 0),
                (a.next = this._head),
              ...
              const c = a.next,
                m = a.previous
              a === this._head ? ((c.previous = void 0), (this._head = c)) : ((c.previous = m), (m.next = c)),
                (a.next = void 0),
      ...
      class o {
        constructor(a) {
          if (((this._m1 = new Map()), (this._m2 = new Map()), a)) for (const [u, c] of a) this.set(u, c)
        }
        clear() {
    ...
    Y(X[23], J([0, 1]), function (q, n) {
      ...
      class A {
        ...
        constructor(d) {
          ;(this._now = M && d === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance)),
    ...
    Y(X[9], J([0, 1, 5, 20, 13, 22, 23]), function (q, n, M, A, i, d, b) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.Relay =
          n.EventBufferer =
      ...
      ;(function (g) {
        ...
        function N(K) {
          return (j, Z = null, Q) => {
            ...
            return (
              (ne = K(
                ie => {
                  if (!ee) return ne ? ne.dispose() : (ee = !0), j.call(Z, ie)
                },
                null,
                Q,
              )),
        ...
        g.once = N
        function D(K, j, Z) {
          return k((Q, ee = null, ne) => K(ie => Q.call(ee, j(ie)), null, ne), Z)
        }
        g.map = D
        function x(K, j, Z) {
          return k(
        ...
        g.forEach = x
        function T(K, j, Z) {
          return k((Q, ee = null, ne) => K(ie => j(ie) && Q.call(ee, ie), null, ne), Z)
        }
        g.filter = T
        function F(K) {
          return K
        ...
        function B(...K) {
          return (j, Z = null, Q) => {
            const ee = (0, i.combinedDisposable)(...K.map(ne => ne(ie => j.call(Z, ie))))
            return O(ee, Q)
          }
        }
        g.any = B
        ...
        function I(K, j, Z = 100, Q = !1, ee = !1, ne, ie) {
          let ae,
            P,
            U,
            H = 0,
          ...
          const te = {
            ...
            onWillAddFirstListener() {
              ae = K(ue => {
                H++,
                  (P = j(P, ue)),
                  Q && !U && (re.fire(P), (P = void 0)),
                  ($ = () => {
                    const ge = P
                    ;(P = void 0), (U = void 0), (!Q || H > 1) && re.fire(ge), (H = 0)
                  }),
                  typeof Z == 'number'
                    ? (clearTimeout(U), (U = setTimeout($, Z)))
                    : U === void 0 && ((U = 0), queueMicrotask($))
              })
            },
          ...
          ie || v(te)
          const re = new y(te)
          return ie?.add(re), re.event
        }
        g.debounce = I
        function W(K, j = 0, Z) {
          return g.debounce(K, (Q, ee) => (Q ? (Q.push(ee), Q) : [ee]), j, void 0, !0, void 0, Z)
        }
        g.accumulate = W
        function z(K, j = (Q, ee) => Q === ee, Z) {
          let Q = !0,
            ee
          return T(
            K,
        ...
        g.latch = z
        function G(K, j, Z) {
          return [g.filter(K, j, Z), g.filter(K, Q => !j(Q), Z)]
        }
        g.split = G
        function t(K, j = !1, Z = [], Q) {
          let ee = Z.slice(),
            ne = K(P => {
              ee ? ee.push(P) : ae.fire(P)
            })
          Q && Q.add(ne)
          const ie = () => {
              ee?.forEach(P => ae.fire(P)), (ee = null)
            },
            ae = new y({
              onWillAddFirstListener() {
                ne || ((ne = K(P => ae.fire(P))), Q && Q.add(ne))
              },
              onDidAddFirstListener() {
                ee && (j ? setTimeout(ie) : ie())
              },
              onDidRemoveLastListener() {
                ne && ne.dispose(), (ne = null)
              },
            })
          return Q && Q.add(ae), ae.event
        }
        g.buffer = t
        function se(K, j) {
          return (Q, ee, ne) => {
        ...
        class me {
          ...
          forEach(j) {
            return this.steps.push(Z => (j(Z), Z)), this
          }
          filter(j) {
            return this.steps.push(Z => (j(Z) ? Z : ce)), this
          }
          reduce(j, Z) {
            let Q = Z
          ...
          latch(j = (Z, Q) => Z === Q) {
            ...
            return (
              this.steps.push(ee => {
                const ne = Z || !j(ee, Q)
                return (Z = !1), (Q = ee), ne ? ee : ce
              }),
              this
            )
          }
          evaluate(j) {
            for (const Z of this.steps) if (((j = Z(j)), j === ce)) break
            return j
          }
        }
        function ve(K, j, Z = Q => Q) {
          const Q = (...ae) => ie.fire(Z(...ae)),
            ee = () => K.on(j, Q),
            ne = () => K.removeListener(j, Q),
            ie = new y({ onWillAddFirstListener: ee, onDidRemoveLastListener: ne })
          return ie.event
        }
        g.fromNodeEventEmitter = ve
        function pe(K, j, Z = Q => Q) {
          const Q = (...ae) => ie.fire(Z(...ae)),
        ...
        class Ce {
          constructor(j, Z) {
            ...
            Z || v(Q), (this.emitter = new y(Q)), Z && Z.add(this.emitter)
          }
          beginUpdate(j) {
            this._counter++
          }
        ...
        function Se(K, j) {
          return new Ce(K, j).emitter.event
        }
        g.fromObservable = Se
        function ye(K) {
          return (j, Z, Q) => {
            ...
            const ie = {
              ...
              endUpdate() {
                ee--, ee === 0 && (K.reportChanges(), ne && ((ne = !1), j.call(Z)))
              },
            ...
            K.addObserver(ie), K.reportChanges()
            const ae = {
              dispose() {
                K.removeObserver(ie)
              },
            }
            return Q instanceof i.DisposableStore ? Q.add(ae) : Array.isArray(Q) && Q.push(ae), ae
          }
        }
        g.fromObservableLight = ye
      })(o || (n.Event = o = {}))
      class L {
        constructor(v) {
          ;(this.listenerCount = 0),
            ...
            (this.durations = []),
            (this.name = `${v}_${L._idPool++}`),
            L.all.add(this)
        }
        start(v) {
          ;(this._stopWatch = new b.StopWatch()), (this.listenerCount = v)
        }
        stop() {
          if (this._stopWatch) {
      ...
      ;(n.EventProfiling = L), (L.all = new Set()), (L._idPool = 0)
      let e = -1
      class a {
        ...
        check(v, R) {
          ...
          if ((this._stacks.set(v.value, D + 1), (this._warnCountdown -= 1), this._warnCountdown <= 0)) {
            ...
            let x,
              T = 0
            for (const [F, B] of this._stacks) (!x || T < B) && ((x = F), (T = B))
            console.warn(
...
`),
      ...
      class y {
        constructor(v) {
          ...
          ;(this._size = 0),
            (this._options = v),
            (this._leakageMon =
              e > 0 || (!((R = this._options) === null || R === void 0) && R.leakWarningThreshold)
                ? new a(
                    (D = (N = this._options) === null || N === void 0 ? void 0 : N.leakWarningThreshold) !== null &&
                      D !== void 0
                      ? D
                      : e,
                  )
                : void 0),
            (this._perfMon =
              !((x = this._options) === null || x === void 0) && x._profName ? new L(this._options._profName) : void 0),
            (this._deliveryQueue = (T = this._options) === null || T === void 0 ? void 0 : T.deliveryQueue)
        }
        dispose() {
          var v, R, N, D
          if (!this._disposed) {
            if (
              ((this._disposed = !0),
              ((v = this._deliveryQueue) === null || v === void 0 ? void 0 : v.current) === this &&
              ...
              if (p) {
                ...
                queueMicrotask(() => {
                  f(x, T => {
                    var F
                    return (F = T.stack) === null || F === void 0 ? void 0 : F.print()
                  })
                })
              }
            ...
            ((v = this._event) !== null && v !== void 0) ||
              (this._event = (R, N, D) => {
                ...
                this._leakageMon &&
                  ...
                  ((k.stack = u.create()), (O = this._leakageMon.check(k.stack, this._size + 1))),
                  p && (k.stack = I ?? u.create()),
                  this._listeners
                    ? this._listeners instanceof c
                      ? (((V = this._deliveryQueue) !== null && V !== void 0) || (this._deliveryQueue = new E()),
                        (this._listeners = [this._listeners, k]))
                      : this._listeners.push(k)
                    : ((T = (x = this._options) === null || x === void 0 ? void 0 : x.onWillAddFirstListener) ===
                        null ||
                        T === void 0 ||
                        T.call(x, this),
                      (this._listeners = k),
                      (B = (F = this._options) === null || F === void 0 ? void 0 : F.onDidAddFirstListener) === null ||
                        B === void 0 ||
                        B.call(F, this)),
                  this._size++
        ...
        _removeListener(v) {
          var R, N, D, x
          if (
            ((N = (R = this._options) === null || R === void 0 ? void 0 : R.onWillRemoveListener) === null ||
              N === void 0 ||
              N.call(R, this),
            !this._listeners)
          )
          ...
          if (this._size === 1) {
            ;(this._listeners = void 0),
              (x = (D = this._options) === null || D === void 0 ? void 0 : D.onDidRemoveLastListener) === null ||
                x === void 0 ||
                x.call(D, this),
              (this._size = 0)
            return
          ...
          if (this._size * m <= T.length) {
            ...
            for (let k = 0; k < T.length; k++)
              T[k]
                ? (T[V++] = T[k])
                : B && (this._deliveryQueue.end--, V < this._deliveryQueue.i && this._deliveryQueue.i--)
            T.length = V
          }
        }
        _deliver(v, R) {
          var N
          if (!v) return
          const D = ((N = this._options) === null || N === void 0 ? void 0 : N.onListenerError) || M.onUnexpectedError
          if (!D) {
            v.value(R)
            return
          }
        ...
        fire(v) {
          ...
          if (
            (!((R = this._deliveryQueue) === null || R === void 0) &&
              R.current &&
              (this._deliverQueue(this._deliveryQueue), (N = this._perfMon) === null || N === void 0 || N.stop()),
      ...
      class _ {
        ...
        set input(v) {
          ;(this.inputEvent = v),
            this.listening &&
              (this.inputEventListener.dispose(), (this.inputEventListener = v(this.emitter.fire, this.emitter)))
        }
        dispose() {
    ...
    Y(X[38], J([0, 1, 9]), function (q, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }), (n.CancellationTokenSource = n.CancellationToken = void 0)
      const A = Object.freeze(function (p, h) {
        const o = setTimeout(p.bind(h), 0)
        return {
          dispose() {
            clearTimeout(o)
          },
      ...
      ;(function (p) {
        function h(o) {
          return o === p.None || o === p.Cancelled || o instanceof d
            ? !0
            : !o || typeof o != 'object'
              ? !1
              : typeof o.isCancellationRequested == 'boolean' && typeof o.onCancellationRequested == 'function'
        }
        ;(p.isCancellationToken = h),
          (p.None = Object.freeze({ isCancellationRequested: !1, onCancellationRequested: M.Event.None })),
          (p.Cancelled = Object.freeze({ isCancellationRequested: !0, onCancellationRequested: A }))
      ...
      class d {
        ...
        get onCancellationRequested() {
          return this._isCancelled ? A : (this._emitter || (this._emitter = new M.Emitter()), this._emitter.event)
        }
        dispose() {
      ...
      class b {
        ...
        dispose(h = !1) {
          ...
          h && this.cancel(),
            ...
            this._token ? this._token instanceof d && this._token.dispose() : (this._token = i.None)
        }
      }
      n.CancellationTokenSource = b
    }),
    Y(X[6], J([0, 1, 32, 36]), function (q, n, M, A) {
      'use strict'
      var i
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      function p(P, ...U) {
        return U.length === 0
          ? P
          : P.replace(b, function (H, $) {
              const te = parseInt($, 10)
              return isNaN(te) || te < 0 || te >= U.length ? H : U[te]
            })
      }
      n.format = p
      function h(P) {
        return P.replace(/[<>"'&]/g, U => {
          switch (U) {
            case '<':
              return '&lt;'
            case '>':
      ...
      function u(P, U) {
        ...
        let te = $,
          re = -1
        for (; (re = P.lastIndexOf(U, te - 1)), !(re === -1 || re + H !== te); ) {
          if (re === 0) return ''
          te = re
        }
      ...
      function f(P, U, H = {}) {
        ...
        U || (P = L(P)),
          H.wholeWord &&
            (/\B/.test(P.charAt(0)) || (P = '\\b' + P), /\B/.test(P.charAt(P.length - 1)) || (P = P + '\\b'))
        let $ = ''
        return (
          H.global && ($ += 'g'),
          H.matchCase || ($ += 'i'),
      ...
      n.regExpLeadsToEndlessLoop = y
      function w(P) {
        return P.split(/\r\n|\r|\n/)
      }
      n.splitLines = w
      function E(P) {
        for (let U = 0, H = P.length; U < H; U++) {
          const $ = P.charCodeAt(U)
          if ($ !== 32 && $ !== 9) return U
        }
        return -1
      }
      n.firstNonWhitespaceIndex = E
      function S(P, U = 0, H = P.length) {
        for (let $ = U; $ < H; $++) {
          const te = P.charCodeAt($)
          if (te !== 32 && te !== 9) return P.substring(U, $)
        }
        return P.substring(U, H)
      }
      n.getLeadingWhitespace = S
      function C(P, U = P.length - 1) {
        for (let H = U; H >= 0; H--) {
          const $ = P.charCodeAt(H)
          if ($ !== 32 && $ !== 9) return H
        }
        return -1
      }
      ...
      n.compare = r
      function s(P, U, H = 0, $ = P.length, te = 0, re = U.length) {
        for (; H < $ && te < re; H++, te++) {
          const fe = P.charCodeAt(H),
            oe = U.charCodeAt(te)
          if (fe < oe) return -1
          if (fe > oe) return 1
        }
        const ue = $ - H,
          ge = re - te
        return ue < ge ? -1 : ue > ge ? 1 : 0
      }
      n.compareSubstring = s
      function l(P, U) {
        return _(P, U, 0, P.length, 0, U.length)
      }
      n.compareIgnoreCase = l
      function _(P, U, H = 0, $ = P.length, te = 0, re = U.length) {
        for (; H < $ && te < re; H++, te++) {
          let fe = P.charCodeAt(H),
            oe = U.charCodeAt(te)
          if (fe === oe) continue
          if (fe >= 128 || oe >= 128) return s(P.toLowerCase(), U.toLowerCase(), H, $, te, re)
          v(fe) && (fe -= 32), v(oe) && (oe -= 32)
          const he = fe - oe
          if (he !== 0) return he
        }
        const ue = $ - H,
      ...
      n.compareSubstringIgnoreCase = _
      function g(P) {
        return P >= 48 && P <= 57
      }
      n.isAsciiDigit = g
      ...
      function N(P, U) {
        return P.length === U.length && _(P, U) === 0
      }
      n.equalsIgnoreCase = N
      function D(P, U) {
        const H = U.length
        return U.length > P.length ? !1 : _(P, U, 0, H) === 0
      }
      n.startsWithIgnoreCase = D
      function x(P, U) {
        const H = Math.min(P.length, U.length)
        let $
        for ($ = 0; $ < H; $++) if (P.charCodeAt($) !== U.charCodeAt($)) return $
        return H
      }
      n.commonPrefixLength = x
      function T(P, U) {
        const H = Math.min(P.length, U.length)
        let $
        const te = P.length - 1,
          re = U.length - 1
        for ($ = 0; $ < H; $++) if (P.charCodeAt(te - $) !== U.charCodeAt(re - $)) return $
        return H
      }
      ...
      n.isLowSurrogate = B
      function V(P, U) {
        return ((P - 55296) << 10) + (U - 56320) + 65536
      }
      n.computeCodePoint = V
      function k(P, U, H) {
        const $ = P.charCodeAt(H)
        if (F($) && H + 1 < U) {
          const te = P.charCodeAt(H + 1)
          if (B(te)) return V($, te)
        }
        return $
      }
      ...
      function O(P, U) {
        const H = P.charCodeAt(U - 1)
        if (B(H) && U > 1) {
          const $ = P.charCodeAt(U - 2)
          if (F($)) return V($, H)
        }
        return H
      }
      class I {
        ...
        constructor(U, H = 0) {
          ;(this._str = U), (this._len = U.length), (this._offset = H)
        }
        setOffset(U) {
          this._offset = U
        }
        prevCodePoint() {
          const U = O(this._str, this._offset)
          return (this._offset -= U >= 65536 ? 2 : 1), U
        }
        nextCodePoint() {
          const U = k(this._str, this._len, this._offset)
          return (this._offset += U >= 65536 ? 2 : 1), U
        }
        eol() {
      ...
      class W {
        ...
        constructor(U, H = 0) {
          this._iterator = new I(U, H)
        }
        nextGraphemeLength() {
          const U = j.getInstance(),
            H = this._iterator,
            $ = H.offset
          let te = U.getGraphemeBreakType(H.nextCodePoint())
          for (; !H.eol(); ) {
            const re = H.offset,
              ue = U.getGraphemeBreakType(H.nextCodePoint())
            if (K(te, ue)) {
              H.setOffset(re)
              break
            }
        ...
        prevGraphemeLength() {
          const U = j.getInstance(),
            H = this._iterator,
            $ = H.offset
          let te = U.getGraphemeBreakType(H.prevCodePoint())
          for (; H.offset > 0; ) {
            const re = H.offset,
              ue = U.getGraphemeBreakType(H.prevCodePoint())
            if (K(ue, te)) {
              H.setOffset(re)
              break
            }
      ...
      function z(P, U) {
        return new W(P, U).nextGraphemeLength()
      }
      n.nextCharLength = z
      function G(P, U) {
        return new W(P, U).prevGraphemeLength()
      }
      n.prevCharLength = G
      function t(P, U) {
        U > 0 && B(P.charCodeAt(U)) && U--
        const H = U + z(P, U)
        return [H - G(P, H), H]
      }
      n.getCharContainingOffset = t
      let se
      function ce() {
        return /(?:[\u05BE\u05C0\u05C3\u05C6\u05D0-\u05F4\u0608\u060B\u060D\u061B-\u064A\u066D-\u066F\u0671-\u06D5\u06E5\u06E6\u06EE\u06EF\u06FA-\u0710\u0712-\u072F\u074D-\u07A5\u07B1-\u07EA\u07F4\u07F5\u07FA\u07FE-\u0815\u081A\u0824\u0828\u0830-\u0858\u085E-\u088E\u08A0-\u08C9\u200F\uFB1D\uFB1F-\uFB28\uFB2A-\uFD3D\uFD50-\uFDC7\uFDF0-\uFDFC\uFE70-\uFEFC]|\uD802[\uDC00-\uDD1B\uDD20-\uDE00\uDE10-\uDE35\uDE40-\uDEE4\uDEEB-\uDF35\uDF40-\uDFFF]|\uD803[\uDC00-\uDD23\uDE80-\uDEA9\uDEAD-\uDF45\uDF51-\uDF81\uDF86-\uDFF6]|\uD83A[\uDC00-\uDCCF\uDD00-\uDD43\uDD4B-\uDFFF]|\uD83B[\uDC00-\uDEBB])/
      }
      function me(P) {
        return se || (se = ce()), se.test(P)
      }
      n.containsRTL = me
      const ve = /^[\t\n\r\x20-\x7E]*$/
      function pe(P) {
      ...
      ;(n.isBasicASCII = pe), (n.UNUSUAL_LINE_TERMINATORS = /[\u2028\u2029]/)
      function Le(P) {
        return n.UNUSUAL_LINE_TERMINATORS.test(P)
      }
      n.containsUnusualLineTerminators = Le
      function we(P) {
        return (P >= 11904 && P <= 55215) || (P >= 63744 && P <= 64255) || (P >= 65281 && P <= 65374)
      }
      n.isFullWidthCharacter = we
      function be(P) {
        return (
          (P >= 127462 && P <= 127487) ||
          P === 8986 ||
      ...
      ;(n.isEmojiImprecise = be), (n.UTF8_BOM_CHARACTER = String.fromCharCode(65279))
      function Ce(P) {
        return !!(P && P.length > 0 && P.charCodeAt(0) === 65279)
      }
      n.startsWithUTF8BOM = Ce
      function Se(P, U = !1) {
        return P ? (U && (P = P.replace(/\\./g, '')), P.toLowerCase() !== P) : !1
      }
      n.containsUppercaseCharacter = Se
      function ye(P) {
        return (P = P % (2 * 26)), P < 26 ? String.fromCharCode(97 + P) : String.fromCharCode(65 + P - 26)
      }
      n.singleLetterHash = ye
      function K(P, U) {
        return P === 0
          ? U !== 5 && U !== 7
          : P === 2 && U === 3
            ? !1
            : P === 4 || P === 2 || P === 3 || U === 4 || U === 2 || U === 3
              ? !0
              : !(
                  (P === 8 && (U === 8 || U === 9 || U === 11 || U === 12)) ||
                  ((P === 11 || P === 9) && (U === 9 || U === 10)) ||
                  ((P === 12 || P === 10) && U === 10) ||
                  U === 5 ||
                  U === 13 ||
      ...
      class j {
        ...
        getGraphemeBreakType(U) {
          ...
          for (; te <= $; )
            if (U < H[3 * te]) te = 2 * te
            else if (U > H[3 * te + 1]) te = 2 * te + 1
            else return H[3 * te + 2]
          return 0
        }
      }
      j._INSTANCE = null
      ...
      function ee(P, U) {
        ...
        if (!be($)) return
        let te = H.offset
        return te > 0 && H.prevCodePoint() === 8205 && (te = H.offset), te
      }
      function ne(P) {
      ...
      ;(n.AmbiguousCharacters = ie),
        (i = ie),
        (ie.ambiguousCharacterData = new A.Lazy(() =>
          JSON.parse(
        ...
        (ie.cache = new M.LRUCachedFunction(P => {
          function U(oe) {
            const he = new Map()
            for (let de = 0; de < oe.length; de += 2) he.set(oe[de], oe[de + 1])
            return he
          }
          function H(oe, he) {
            const de = new Map(oe)
            for (const [_e, Ee] of he) de.set(_e, Ee)
            return de
          }
          function $(oe, he) {
            if (!oe) return he
            const de = new Map()
            for (const [_e, Ee] of oe) he.has(_e) && de.set(_e, Ee)
            return de
          }
          const te = i.ambiguousCharacterData.value
          let re = P.filter(oe => !oe.startsWith('_') && oe in te)
          re.length === 0 && (re = ['_default'])
          let ue
          for (const oe of re) {
            const he = U(te[oe])
            ue = $(ue, he)
          }
          const ge = U(te._common),
            fe = H(ge, ue)
          return new i(fe)
        })),
        (ie._locales = new A.Lazy(() => Object.keys(i.ambiguousCharacterData.value).filter(P => !P.startsWith('_'))))
      class ae {
        static getRawData() {
          return JSON.parse(
        ...
        static getData() {
          return this._data || (this._data = new Set(ae.getRawData())), this._data
        }
        static isInvisibleCharacter(U) {
          return ae.getData().has(U)
        }
        static get codePoints() {
          return ae.getData()
        }
      }
      ;(n.InvisibleCharacters = ae), (ae._data = void 0)
    }),
    Y(X[39], J([0, 1, 6]), function (q, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      function p(m, f) {
        f = d(149417, f)
        for (let y = 0, w = m.length; y < w; y++) f = d(m.charCodeAt(y), f)
        return f
      }
      n.stringHash = p
      function h(m, f) {
        return (f = d(104579, f)), m.reduce((y, w) => i(w, y), f)
      }
      function o(m, f) {
        return (
          (f = d(181387, f)),
      ...
      function e(m, f = 0, y = m.byteLength, w = 0) {
        for (let E = 0; E < y; E++) m[f + E] = w
      }
      function a(m, f, y = '0') {
        for (; m.length < f; ) m = y + m
        return m
      }
      function u(m, f = 32) {
      ...
      class c {
          ...
          for (S !== 0 ? ((C = S), (r = -1), (S = 0)) : ((C = f.charCodeAt(0)), (r = 0)); ; ) {
            ...
            if (M.isHighSurrogate(C))
              if (r + 1 < y) {
                ...
                M.isLowSurrogate(l) ? (r++, (s = M.computeCodePoint(C, l))) : (s = 65533)
              } else {
                S = C
                break
              }
            else M.isLowSurrogate(C) && (s = 65533)
            if (((E = this._push(w, E, s)), r++, r < y)) C = f.charCodeAt(r)
            else break
          }
        ...
        _push(f, y, w) {
          return (
            w < 128
              ? (f[y++] = w)
              : w < 2048
                ? ((f[y++] = 192 | ((w & 1984) >>> 6)), (f[y++] = 128 | ((w & 63) >>> 0)))
                : w < 65536
                  ? ((f[y++] = 224 | ((w & 61440) >>> 12)),
                    (f[y++] = 128 | ((w & 4032) >>> 6)),
                    (f[y++] = 128 | ((w & 63) >>> 0)))
                  : ((f[y++] = 240 | ((w & 1835008) >>> 18)),
                    (f[y++] = 128 | ((w & 258048) >>> 12)),
                    (f[y++] = 128 | ((w & 4032) >>> 6)),
                    (f[y++] = 128 | ((w & 63) >>> 0))),
            y >= 64 &&
        ...
        _step() {
          const f = c._bigBlock32,
            y = this._buffDV
          for (let g = 0; g < 64; g += 4) f.setUint32(g, y.getUint32(g, !1), !1)
          for (let g = 64; g < 320; g += 4)
            f.setUint32(
              g,
              L(
                f.getUint32(g - 12, !1) ^ f.getUint32(g - 32, !1) ^ f.getUint32(g - 56, !1) ^ f.getUint32(g - 64, !1),
                1,
              ),
              !1,
            )
          ...
          for (let g = 0; g < 80; g++)
            g < 20
              ? ((s = (E & S) | (~E & C)), (l = 1518500249))
              : g < 40
                ? ((s = E ^ S ^ C), (l = 1859775393))
                : g < 60
                  ? ((s = (E & S) | (E & C) | (S & C)), (l = 2400959708))
                  : ((s = E ^ S ^ C), (l = 3395469782)),
              (_ = (L(w, 5) + s + r + l + f.getUint32(g * 4, !1)) & 4294967295),
              (r = C),
              (C = S),
              (S = L(E, 30)),
              (E = w),
    ...
    Y(X[24], J([0, 1, 34, 39]), function (q, n, M, A) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }), (n.LcsDiff = n.stringDiff = n.StringDiffSequence = void 0)
      class i {
        constructor(e) {
          this.source = e
        }
      ...
      function d(L, e, a) {
        return new o(new i(L), new i(e)).ComputeDiff(a).changes
      }
      n.stringDiff = d
      class b {
        static Assert(e, a) {
      ...
      class h {
        ...
        MarkNextChange() {
          ;(this.m_originalCount > 0 || this.m_modifiedCount > 0) &&
            this.m_changes.push(
              new M.DiffChange(this.m_originalStart, this.m_originalCount, this.m_modifiedStart, this.m_modifiedCount),
            ),
            (this.m_originalCount = 0),
            (this.m_modifiedCount = 0),
            (this.m_originalStart = 1073741824),
      ...
      class o {
        constructor(e, a, u = null) {
          ;(this.ContinueProcessingPredicate = u), (this._originalSequence = e), (this._modifiedSequence = a)
          const [c, m, f] = o._getElements(e),
            [y, w, E] = o._getElements(a)
        ...
        _ComputeDiff(e, a, u, c, m) {
          const f = [!1]
          let y = this.ComputeDiffRecursive(e, a, u, c, f)
          return m && (y = this.PrettifyChanges(y)), { quitEarly: f[0], changes: y }
        }
        ComputeDiffRecursive(e, a, u, c, m) {
          ...
          if (e > a || u > c) {
            ...
            return (
              u <= c
                ? (b.Assert(e === a + 1, 'originalStart should only be one more than originalEnd'),
                  (C = [new M.DiffChange(e, 0, u, c - u + 1)]))
                : e <= a
                  ? (b.Assert(u === c + 1, 'modifiedStart should only be one more than modifiedEnd'),
                    (C = [new M.DiffChange(e, a - e + 1, u, 0)]))
                  : (b.Assert(e === a + 1, 'originalStart should only be one more than originalEnd'),
                    b.Assert(u === c + 1, 'modifiedStart should only be one more than modifiedEnd'),
                    (C = [])),
              C
          ...
          const f = [0],
            y = [0],
            w = this.ComputeRecursionPoint(e, a, u, c, f, y, m),
            E = f[0],
            S = y[0]
          if (w !== null) return w
          if (!m[0]) {
            const C = this.ComputeDiffRecursive(e, E, u, S, m)
            let r = []
            return (
              m[0]
                ? (r = [new M.DiffChange(E + 1, a - (E + 1) + 1, S + 1, c - (S + 1) + 1)])
                : (r = this.ComputeDiffRecursive(E + 1, a, S + 1, c, m)),
              this.ConcatenateChanges(C, r)
            )
          }
          return [new M.DiffChange(e, a - e + 1, u, c - u + 1)]
        }
        WALKTRACE(e, a, u, c, m, f, y, w, E, S, C, r, s, l, _, g, v, R) {
          let N = null,
            D = null,
            x = new h(),
            T = a,
          ...
          do {
            ...
            O === T || (O < F && E[O - 1] < E[O + 1])
              ? ((C = E[O + 1]),
                (l = C - B - c),
                C < V && x.MarkNextChange(),
                (V = C),
                x.AddModifiedElement(C + 1, l),
                (B = O + 1 - e))
              : ((C = E[O - 1] + 1),
                (l = C - B - c),
                C < V && x.MarkNextChange(),
                (V = C - 1),
                x.AddOriginalElement(C, l + 1),
                (B = O - 1 - e)),
              k >= 0 && ((E = this.m_forwardHistory[k]), (e = E[0]), (T = 1), (F = E.length - 1))
          } while (--k >= -1)
          if (((N = x.getReverseChanges()), R[0])) {
            ...
            if (N !== null && N.length > 0) {
              ...
              ;(O = Math.max(O, W.getOriginalEnd())), (I = Math.max(I, W.getModifiedEnd()))
            }
            D = [new M.DiffChange(O, r - O + 1, I, _ - I + 1)]
          } else {
            ;(x = new h()),
              (T = f),
              (F = y),
              (B = s[0] - g[0] - w),
              (V = 1073741824),
              (k = v ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2)
            do {
              const O = B + m
              O === T || (O < F && S[O - 1] >= S[O + 1])
                ? ((C = S[O + 1] - 1),
                  ...
                  C > V && x.MarkNextChange(),
                  (V = C + 1),
                  x.AddOriginalElement(C + 1, l + 1),
                  (B = O + 1 - m))
                : ((C = S[O - 1]),
                  (l = C - B - w),
                  C > V && x.MarkNextChange(),
                  (V = C),
                  x.AddModifiedElement(C + 1, l + 1),
                  (B = O - 1 - m)),
                k >= 0 && ((S = this.m_reverseHistory[k]), (m = S[0]), (T = 1), (F = S.length - 1))
            } while (--k >= -1)
            D = x.getChanges()
          }
          return this.ConcatenateChanges(N, D)
        }
        ComputeRecursionPoint(e, a, u, c, m, f, y) {
          let w = 0,
            E = 0,
            S = 0,
            C = 0,
            r = 0,
            s = 0
          e--, u--, (m[0] = 0), (f[0] = 0), (this.m_forwardHistory = []), (this.m_reverseHistory = [])
          const l = a - e + (c - u),
            _ = l + 1,
            g = new Int32Array(_),
            v = new Int32Array(_),
            ...
            F = (N - R) % 2 === 0
          ;(g[R] = e), (v[N] = a), (y[0] = !1)
          for (let B = 1; B <= l / 2 + 1; B++) {
            let V = 0,
              k = 0
            ;(S = this.ClipDiagonalBound(R - B, B, R, _)), (C = this.ClipDiagonalBound(R + B, B, R, _))
            for (let I = S; I <= C; I += 2) {
              I === S || (I < C && g[I - 1] < g[I + 1]) ? (w = g[I + 1]) : (w = g[I - 1] + 1), (E = w - (I - R) - D)
              const W = w
              for (; w < a && E < c && this.ElementsAreEqual(w + 1, E + 1); ) w++, E++
              if (((g[I] = w), w + E > V + k && ((V = w), (k = E)), !F && Math.abs(I - N) <= B - 1 && w >= v[I]))
                return (
                  (m[0] = w),
                  (f[0] = E),
                  W <= v[I] && 1447 > 0 && B <= 1447 + 1
                    ? this.WALKTRACE(R, S, C, D, N, r, s, x, g, v, w, a, m, E, c, f, F, y)
                    : null
                )
            }
            const O = (V - e + (k - u) - B) / 2
            if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(V, O))
              return (
                (y[0] = !0),
                (m[0] = V),
                (f[0] = k),
            ...
            ;(r = this.ClipDiagonalBound(N - B, B, N, _)), (s = this.ClipDiagonalBound(N + B, B, N, _))
            for (let I = r; I <= s; I += 2) {
              I === r || (I < s && v[I - 1] >= v[I + 1]) ? (w = v[I + 1] - 1) : (w = v[I - 1]), (E = w - (I - N) - x)
              const W = w
              for (; w > e && E > u && this.ElementsAreEqual(w, E); ) w--, E--
              if (((v[I] = w), F && Math.abs(I - R) <= B && w <= g[I]))
                return (
                  (m[0] = w),
                  (f[0] = E),
                  W >= g[I] && 1447 > 0 && B <= 1447 + 1
                    ? this.WALKTRACE(R, S, C, D, N, r, s, x, g, v, w, a, m, E, c, f, F, y)
                    : null
                )
            }
            if (B <= 1447) {
              let I = new Int32Array(C - S + 2)
              ;(I[0] = R - S + 1),
                p.Copy2(g, S, I, 1, C - S + 1),
                this.m_forwardHistory.push(I),
                (I = new Int32Array(s - r + 2)),
                (I[0] = N - r + 1),
                p.Copy2(v, r, I, 1, s - r + 1),
                this.m_reverseHistory.push(I)
            }
          }
          return this.WALKTRACE(R, S, C, D, N, r, s, x, g, v, w, a, m, E, c, f, F, y)
        }
        PrettifyChanges(e) {
          for (let a = 0; a < e.length; a++) {
            const u = e[a],
              c = a < e.length - 1 ? e[a + 1].originalStart : this._originalElementsOrHash.length,
              m = a < e.length - 1 ? e[a + 1].modifiedStart : this._modifiedElementsOrHash.length,
              f = u.originalLength > 0,
              y = u.modifiedLength > 0
            for (
              ;
              u.originalStart + u.originalLength < c &&
              u.modifiedStart + u.modifiedLength < m &&
              (!f || this.OriginalElementsAreEqual(u.originalStart, u.originalStart + u.originalLength)) &&
              (!y || this.ModifiedElementsAreEqual(u.modifiedStart, u.modifiedStart + u.modifiedLength));
            ) {
              const E = this.ElementsAreStrictEqual(u.originalStart, u.modifiedStart)
              if (
                this.ElementsAreStrictEqual(u.originalStart + u.originalLength, u.modifiedStart + u.modifiedLength) &&
                !E
              )
                break
          ...
          for (let a = e.length - 1; a >= 0; a--) {
            ...
            if (a > 0) {
              const C = e[a - 1]
              ;(c = C.originalStart + C.originalLength), (m = C.modifiedStart + C.modifiedLength)
            }
            const f = u.originalLength > 0,
              y = u.modifiedLength > 0
            let w = 0,
              E = this._boundaryScore(u.originalStart, u.originalLength, u.modifiedStart, u.modifiedLength)
            for (let C = 1; ; C++) {
              const r = u.originalStart - C,
                s = u.modifiedStart - C
              if (
                r < c ||
                s < m ||
                (f && !this.OriginalElementsAreEqual(r, r + u.originalLength)) ||
                (y && !this.ModifiedElementsAreEqual(s, s + u.modifiedLength))
              )
                break
              const _ = (r === c && s === m ? 5 : 0) + this._boundaryScore(r, u.originalLength, s, u.modifiedLength)
              _ > E && ((E = _), (w = C))
            }
            ;(u.originalStart -= w), (u.modifiedStart -= w)
            const S = [null]
            if (a > 0 && this.ChangesOverlap(e[a - 1], e[a], S)) {
              ;(e[a - 1] = S[0]), e.splice(a, 1), a++
              continue
            }
          }
          if (this._hasStrings)
            for (let a = 1, u = e.length; a < u; a++) {
              const c = e[a - 1],
                ...
                r = C - S
              if (f < 5 && E < 20 && r < 20) {
                const s = this._findBetterContiguousSequence(y, E, S, r, f)
                if (s) {
                  const [l, _] = s
                  ;(l !== c.originalStart + c.originalLength || _ !== c.modifiedStart + c.modifiedLength) &&
                    ((c.originalLength = l - c.originalStart),
                    (c.modifiedLength = _ - c.modifiedStart),
                    (m.originalStart = l + f),
                    (m.modifiedStart = _ + f),
        ...
        _findBetterContiguousSequence(e, a, u, c, m) {
          ...
          for (let C = e; C < f; C++)
            for (let r = u; r < y; r++) {
              const s = this._contiguousSequenceScore(C, r, m)
              s > 0 && s > w && ((w = s), (E = C), (S = r))
            }
          return w > 0 ? [E, S] : null
        }
        ...
        _OriginalRegionIsBoundary(e, a) {
          ...
          if (a > 0) {
            const u = e + a
            if (this._OriginalIsBoundary(u - 1) || this._OriginalIsBoundary(u)) return !0
          }
          return !1
        }
        ...
        _ModifiedRegionIsBoundary(e, a) {
          ...
          if (a > 0) {
            const u = e + a
            if (this._ModifiedIsBoundary(u - 1) || this._ModifiedIsBoundary(u)) return !0
          }
          return !1
        }
        ...
        ConcatenateChanges(e, a) {
          ...
          if (this.ChangesOverlap(e[e.length - 1], a[0], u)) {
            ...
            return (
              p.Copy(e, 0, c, 0, e.length - 1), (c[e.length - 1] = u[0]), p.Copy(a, 1, c, e.length, a.length - 1), c
            )
          } else {
            const c = new Array(e.length + a.length)
            return p.Copy(e, 0, c, 0, e.length), p.Copy(a, 0, c, e.length, a.length), c
          }
        }
        ChangesOverlap(e, a, u) {
          if (
            (b.Assert(e.originalStart <= a.originalStart, 'Left change is not less than or equal to right change'),
            b.Assert(e.modifiedStart <= a.modifiedStart, 'Left change is not less than or equal to right change'),
            ...
            return (
              ...
              e.modifiedStart + e.modifiedLength >= a.modifiedStart &&
                (y = a.modifiedStart + a.modifiedLength - e.modifiedStart),
              (u[0] = new M.DiffChange(c, m, f, y)),
              !0
            )
    ...
    Y(X[40], J([0, 1, 25]), function (q, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }), (n.Codicon = n.getCodiconFontCharacters = void 0)
      const A = Object.create(null)
      function i(b, p) {
        if ((0, M.isString)(p)) {
          const h = A[p]
          if (h === void 0) throw new Error(`${b} references an unknown codicon: ${p}`)
          p = h
        }
        return (A[b] = p), { id: b }
      }
    ...
    Y(X[14], J([0, 1, 25]), function (q, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.createProxyObject =
          n.getAllMethodNames =
      ...
      function i(u) {
        ...
        for (; c.length > 0; ) {
          ...
          for (const f in m)
            if (d.call(m, f)) {
              const y = m[f]
              typeof y == 'object' && !Object.isFrozen(y) && !(0, M.isTypedArray)(y) && c.push(y)
            }
        }
        return u
      }
      ...
      function p(u, c, m) {
        ...
        if (Array.isArray(u)) {
          const y = []
          for (const w of u) y.push(p(w, c, m))
          return y
        }
        if ((0, M.isObject)(u)) {
          ...
          m.add(u)
          const y = {}
          for (const w in u) d.call(u, w) && (y[w] = p(u[w], c, m))
          return m.delete(u), y
        }
        return u
      }
        ...
        return (0, M.isObject)(u)
          ? ((0, M.isObject)(c) &&
              Object.keys(c).forEach(f => {
                f in u
                  ? m && ((0, M.isObject)(u[f]) && (0, M.isObject)(c[f]) ? h(u[f], c[f], m) : (u[f] = c[f]))
                  : (u[f] = c[f])
              }),
            u)
          : c
      ...
      function o(u, c) {
        ...
        if (Array.isArray(u)) {
          ...
          for (m = 0; m < y.length; m++) if (!o(u[y[m]], c[y[m]])) return !1
        }
        return !0
      }
      n.equals = o
      function L(u) {
        let c = []
        for (; Object.prototype !== u; ) (c = c.concat(Object.getOwnPropertyNames(u))), (u = Object.getPrototypeOf(u))
        return c
      }
      n.getAllPropertyNames = L
      function e(u) {
        const c = []
        for (const m of L(u)) typeof u[m] == 'function' && c.push(m)
        return c
      }
      ...
      function a(u, c) {
        const m = y =>
          ...
          f = {}
        for (const y of u) f[y] = m(y)
        return f
      }
      n.createProxyObject = a
    }),
    Y(X[26], J([0, 1]), function (q, n) {
      'use strict'
    ...
    Y(X[27], J([0, 1, 26]), function (q, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }), (n.CharacterSet = n.CharacterClassifier = void 0)
      class A {
        constructor(b) {
          const p = (0, M.toUint8)(b)
          ;(this._defaultValue = p), (this._asciiMap = A._createAsciiMap(p)), (this._map = new Map())
        }
        static _createAsciiMap(b) {
          const p = new Uint8Array(256)
          return p.fill(b), p
        }
        set(b, p) {
          const h = (0, M.toUint8)(p)
          b >= 0 && b < 256 ? (this._asciiMap[b] = h) : this._map.set(b, h)
        }
        get(b) {
          return b >= 0 && b < 256 ? this._asciiMap[b] : this._map.get(b) || this._defaultValue
        }
        clear() {
      ...
      class i {
        ...
        add(b) {
          this._actual.set(b, 1)
        }
        has(b) {
          return this._actual.get(b) === 1
        }
        clear() {
    ...
    Y(X[3], J([0, 1, 5]), function (q, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }), (n.OffsetRangeSet = n.OffsetRange = void 0)
      class A {
        static addRange(b, p) {
          let h = 0
          for (; h < p.length && p[h].endExclusive < b.start; ) h++
          let o = h
          for (; o < p.length && p[o].start <= b.endExclusive; ) o++
          if (h === o) p.splice(h, 0, b)
          else {
            const L = Math.min(b.start, p[h].start),
              e = Math.max(b.endExclusive, p[o - 1].endExclusive)
            p.splice(h, o - h, new A(L, e))
          }
        }
        static ofLength(b) {
          return new A(0, b)
        }
        static ofStartAndLength(b, p) {
          return new A(b, b + p)
        }
        constructor(b, p) {
          if (((this.start = b), (this.endExclusive = p), b > p))
        ...
        delta(b) {
          return new A(this.start + b, this.endExclusive + b)
        }
        deltaStart(b) {
          return new A(this.start + b, this.endExclusive)
        }
        deltaEnd(b) {
          return new A(this.start, this.endExclusive + b)
        }
        get length() {
        ...
        contains(b) {
          return this.start <= b && b < this.endExclusive
        }
        join(b) {
          return new A(Math.min(this.start, b.start), Math.max(this.endExclusive, b.endExclusive))
        }
        intersect(b) {
          const p = Math.max(this.start, b.start),
            h = Math.min(this.endExclusive, b.endExclusive)
          if (p <= h) return new A(p, h)
        }
        intersects(b) {
          const p = Math.max(this.start, b.start),
            h = Math.min(this.endExclusive, b.endExclusive)
        ...
        isBefore(b) {
          return this.endExclusive <= b.start
        }
        isAfter(b) {
          return this.start >= b.endExclusive
        }
        slice(b) {
          return b.slice(this.start, this.endExclusive)
        }
        clip(b) {
          if (this.isEmpty) throw new M.BugIndicatingError(`Invalid clipping range: ${this.toString()}`)
          return Math.max(this.start, Math.min(this.endExclusive - 1, b))
        }
        clipCyclic(b) {
          if (this.isEmpty) throw new M.BugIndicatingError(`Invalid clipping range: ${this.toString()}`)
          return b < this.start
            ? this.endExclusive - ((this.start - b) % this.length)
            : b >= this.endExclusive
              ? this.start + ((b - this.start) % this.length)
              : b
        }
        forEach(b) {
          for (let p = this.start; p < this.endExclusive; p++) b(p)
        }
      }
      n.OffsetRange = A
      class i {
        ...
        addRange(b) {
          let p = 0
          for (; p < this._sortedRanges.length && this._sortedRanges[p].endExclusive < b.start; ) p++
          let h = p
          for (; h < this._sortedRanges.length && this._sortedRanges[h].start <= b.endExclusive; ) h++
          if (p === h) this._sortedRanges.splice(p, 0, b)
          else {
            const o = Math.min(b.start, this._sortedRanges[p].start),
              L = Math.max(b.endExclusive, this._sortedRanges[h - 1].endExclusive)
            this._sortedRanges.splice(p, h - p, new A(o, L))
          }
        }
        toString() {
          return this._sortedRanges.map(b => b.toString()).join(', ')
        }
        intersectsStrict(b) {
          let p = 0
          for (; p < this._sortedRanges.length && this._sortedRanges[p].endExclusive <= b.start; ) p++
          return p < this._sortedRanges.length && this._sortedRanges[p].start < b.endExclusive
        }
        intersectWithRange(b) {
          const p = new i()
          for (const h of this._sortedRanges) {
            const o = h.intersect(b)
            o && p.addRange(o)
          }
          return p
        }
        intersectWithRangeLength(b) {
          return this.intersectWithRange(b).length
        }
        get length() {
          return this._sortedRanges.reduce((b, p) => b + p.length, 0)
        }
      }
      n.OffsetRangeSet = i
    }),
    Y(X[4], J([0, 1]), function (q, n) {
      'use strict'
    ...
    Y(X[2], J([0, 1, 4]), function (q, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }), (n.Range = void 0)
      class A {
        constructor(d, b, p, h) {
          d > p || (d === p && b > h)
            ? ((this.startLineNumber = p), (this.startColumn = h), (this.endLineNumber = d), (this.endColumn = b))
            : ((this.startLineNumber = d), (this.startColumn = b), (this.endLineNumber = p), (this.endColumn = h))
        }
        isEmpty() {
        ...
        static containsPosition(d, b) {
          return !(
            b.lineNumber < d.startLineNumber ||
            b.lineNumber > d.endLineNumber ||
            (b.lineNumber === d.startLineNumber && b.column < d.startColumn) ||
            (b.lineNumber === d.endLineNumber && b.column > d.endColumn)
          )
        }
        static strictContainsPosition(d, b) {
          return !(
            b.lineNumber < d.startLineNumber ||
            b.lineNumber > d.endLineNumber ||
            (b.lineNumber === d.startLineNumber && b.column <= d.startColumn) ||
        ...
        static containsRange(d, b) {
          return !(
            b.startLineNumber < d.startLineNumber ||
            b.endLineNumber < d.startLineNumber ||
            b.startLineNumber > d.endLineNumber ||
            b.endLineNumber > d.endLineNumber ||
            (b.startLineNumber === d.startLineNumber && b.startColumn < d.startColumn) ||
            (b.endLineNumber === d.endLineNumber && b.endColumn > d.endColumn)
          )
        }
        strictContainsRange(d) {
          return A.strictContainsRange(this, d)
        }
        static strictContainsRange(d, b) {
          return !(
            b.startLineNumber < d.startLineNumber ||
            b.endLineNumber < d.startLineNumber ||
            b.startLineNumber > d.endLineNumber ||
        ...
        static plusRange(d, b) {
          let p, h, o, L
          return (
            b.startLineNumber < d.startLineNumber
              ? ((p = b.startLineNumber), (h = b.startColumn))
              : b.startLineNumber === d.startLineNumber
                ? ((p = b.startLineNumber), (h = Math.min(b.startColumn, d.startColumn)))
                : ((p = d.startLineNumber), (h = d.startColumn)),
            b.endLineNumber > d.endLineNumber
              ? ((o = b.endLineNumber), (L = b.endColumn))
              : b.endLineNumber === d.endLineNumber
                ? ((o = b.endLineNumber), (L = Math.max(b.endColumn, d.endColumn)))
                : ((o = d.endLineNumber), (L = d.endColumn)),
            new A(p, h, o, L)
          )
        }
        intersectRanges(d) {
        ...
        static intersectRanges(d, b) {
          let p = d.startLineNumber,
            h = d.startColumn,
            o = d.endLineNumber,
            L = d.endColumn
          const e = b.startLineNumber,
            a = b.startColumn,
            u = b.endLineNumber,
            c = b.endColumn
          return (
            p < e ? ((p = e), (h = a)) : p === e && (h = Math.max(h, a)),
            o > u ? ((o = u), (L = c)) : o === u && (L = Math.min(L, c)),
            p > o || (p === o && h > L) ? null : new A(p, h, o, L)
          )
        }
        equalsRange(d) {
          return A.equalsRange(this, d)
        }
        static equalsRange(d, b) {
          return !d && !b
            ? !0
            : !!d &&
                !!b &&
                d.startLineNumber === b.startLineNumber &&
                d.startColumn === b.startColumn &&
                d.endLineNumber === b.endLineNumber &&
                d.endColumn === b.endColumn
        }
        getEndPosition() {
        ...
        setEndPosition(d, b) {
          return new A(this.startLineNumber, this.startColumn, d, b)
        }
        setStartPosition(d, b) {
          return new A(d, b, this.endLineNumber, this.endColumn)
        }
        collapseToStart() {
        ...
        delta(d) {
          return new A(this.startLineNumber + d, this.startColumn, this.endLineNumber + d, this.endColumn)
        }
        static fromPositions(d, b = d) {
          return new A(d.lineNumber, d.column, b.lineNumber, b.column)
        }
        static lift(d) {
          return d ? new A(d.startLineNumber, d.startColumn, d.endLineNumber, d.endColumn) : null
        }
        static isIRange(d) {
          return (
            d &&
        ...
        static areIntersectingOrTouching(d, b) {
          return !(
            d.endLineNumber < b.startLineNumber ||
            (d.endLineNumber === b.startLineNumber && d.endColumn < b.startColumn) ||
            b.endLineNumber < d.startLineNumber ||
            (b.endLineNumber === d.startLineNumber && b.endColumn < d.startColumn)
          )
        }
        static areIntersecting(d, b) {
          return !(
            d.endLineNumber < b.startLineNumber ||
            (d.endLineNumber === b.startLineNumber && d.endColumn <= b.startColumn) ||
            b.endLineNumber < d.startLineNumber ||
        ...
        static compareRangesUsingStarts(d, b) {
          if (d && b) {
            const o = d.startLineNumber | 0,
              L = b.startLineNumber | 0
            if (o === L) {
        ...
        static compareRangesUsingEnds(d, b) {
          return d.endLineNumber === b.endLineNumber
            ? d.endColumn === b.endColumn
              ? d.startLineNumber === b.startLineNumber
                ? d.startColumn - b.startColumn
                : d.startLineNumber - b.startLineNumber
    ...
    Y(X[10], J([0, 1, 5, 3, 2, 11]), function (q, n, M, A, i, d) {
      ...
      class b {
        ...
        delta(o) {
          return new b(this.startLineNumber + o, this.endLineNumberExclusive + o)
        }
        deltaLength(o) {
          return new b(this.startLineNumber, this.endLineNumberExclusive + o)
        }
        get length() {
        ...
        toInclusiveRange() {
          return this.isEmpty
            ? null
            : new i.Range(this.startLineNumber, 1, this.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER)
        }
        toExclusiveRange() {
        ...
        toOffsetRange() {
          return new A.OffsetRange(this.startLineNumber - 1, this.endLineNumberExclusive - 1)
        }
      }
      n.LineRange = b
      class p {
        ...
        addRange(o) {
          if (o.length === 0) return
          const L = (0, d.findFirstIdxMonotonousOrArrLen)(
              this._normalizedRanges,
              a => a.endLineNumberExclusive >= o.startLineNumber,
            ),
            e =
              (0, d.findLastIdxMonotonous)(this._normalizedRanges, a => a.startLineNumber <= o.endLineNumberExclusive) +
              1
          if (L === e) this._normalizedRanges.splice(L, 0, o)
          else if (L === e - 1) {
            const a = this._normalizedRanges[L]
            this._normalizedRanges[L] = a.join(o)
          } else {
            const a = this._normalizedRanges[L].join(this._normalizedRanges[e - 1]).join(o)
            this._normalizedRanges.splice(L, e - L, a)
          }
        }
        contains(o) {
          ...
          for (; e < this._normalizedRanges.length || a < o._normalizedRanges.length; ) {
            ...
            u === null
              ...
              : u.endLineNumberExclusive >= c.startLineNumber
                ? (u = new b(u.startLineNumber, Math.max(u.endLineNumberExclusive, c.endLineNumberExclusive)))
                : (L.push(u), (u = c))
          }
          return u !== null && L.push(u), new p(L)
        }
        subtractFrom(o) {
          const L = (0, d.findFirstIdxMonotonousOrArrLen)(
              this._normalizedRanges,
            ...
            e =
              (0, d.findLastIdxMonotonous)(this._normalizedRanges, c => c.startLineNumber <= o.endLineNumberExclusive) +
              1
          ...
          for (let c = L; c < e; c++) {
            ...
            m.startLineNumber > u && a.push(new b(u, m.startLineNumber)), (u = m.endLineNumberExclusive)
          }
          return u < o.endLineNumberExclusive && a.push(new b(u, o.endLineNumberExclusive)), new p(a)
        }
        toString() {
        ...
        getIntersection(o) {
          ...
          for (; e < this._normalizedRanges.length && a < o._normalizedRanges.length; ) {
            const u = this._normalizedRanges[e],
              ...
              m = u.intersect(c)
            m && !m.isEmpty && L.push(m), u.endLineNumberExclusive < c.endLineNumberExclusive ? e++ : a++
          }
          return new p(L)
        }
        getWithDelta(o) {
    ...
    Y(X[41], J([0, 1, 4, 2]), function (q, n, M, A) {
      'use strict'
      ...
      class i extends A.Range {
        ...
        equalsSelection(b) {
          return i.selectionsEqual(this, b)
        }
        static selectionsEqual(b, p) {
          return (
            b.selectionStartLineNumber === p.selectionStartLineNumber &&
            b.selectionStartColumn === p.selectionStartColumn &&
            b.positionLineNumber === p.positionLineNumber &&
            b.positionColumn === p.positionColumn
          )
        }
        getDirection() {
        ...
        setEndPosition(b, p) {
          return this.getDirection() === 0
            ? new i(this.startLineNumber, this.startColumn, b, p)
            : new i(b, p, this.startLineNumber, this.startColumn)
        }
        getPosition() {
        ...
        setStartPosition(b, p) {
          return this.getDirection() === 0
            ? new i(b, p, this.endLineNumber, this.endColumn)
            : new i(this.endLineNumber, this.endColumn, b, p)
        }
        static fromPositions(b, p = b) {
          return new i(b.lineNumber, b.column, p.lineNumber, p.column)
        }
        static fromRange(b, p) {
          return p === 0
            ? new i(b.startLineNumber, b.startColumn, b.endLineNumber, b.endColumn)
            : new i(b.endLineNumber, b.endColumn, b.startLineNumber, b.startColumn)
        }
        static liftSelection(b) {
          return new i(b.selectionStartLineNumber, b.selectionStartColumn, b.positionLineNumber, b.positionColumn)
        }
        static selectionsArrEqual(b, p) {
          if ((b && !p) || (!b && p)) return !1
          if (!b && !p) return !0
          if (b.length !== p.length) return !1
          for (let h = 0, o = b.length; h < o; h++) if (!this.selectionsEqual(b[h], p[h])) return !1
          return !0
        }
        static isISelection(b) {
          return (
            b &&
            typeof b.selectionStartLineNumber == 'number' &&
            typeof b.selectionStartColumn == 'number' &&
            typeof b.positionLineNumber == 'number' &&
            typeof b.positionColumn == 'number'
          )
        }
        static createWithDirection(b, p, h, o, L) {
          return L === 0 ? new i(b, p, h, o) : new i(h, o, b, p)
        }
      }
      n.Selection = i
    }),
    Y(X[42], J([0, 1, 27]), function (q, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      class A extends M.CharacterClassifier {
        constructor(b) {
          super(0)
          for (let p = 0, h = b.length; p < h; p++) this.set(b.charCodeAt(p), 2)
      ...
      function i(d) {
        const b = {}
        return p => (b.hasOwnProperty(p) || (b[p] = d(p)), b[p])
      }
      n.getMapForWordSeparators = i(d => new A(d))
    }),
    Y(X[28], J([0, 1, 21, 22]), function (q, n, M, A) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.getWordAtText = n.ensureValidWordDefinition = n.DEFAULT_WORD_REGEXP = n.USUAL_WORD_SEPARATORS = void 0),
        (n.USUAL_WORD_SEPARATORS = '`~!@#$%^&*()-=+[{]}\\|;:\'",.<>/?')
      function i(o = '') {
        let L = '(-?\\d*\\.\\d\\w*)|([^'
        for (const e of n.USUAL_WORD_SEPARATORS) o.indexOf(e) >= 0 || (L += '\\' + e)
        return (L += '\\s]+)'), new RegExp(L, 'g')
      }
      n.DEFAULT_WORD_REGEXP = i()
      function d(o) {
        let L = n.DEFAULT_WORD_REGEXP
        if (o && o instanceof RegExp)
          if (o.global) L = o
            ...
            o.ignoreCase && (e += 'i'),
              o.multiline && (e += 'm'),
              o.unicode && (e += 'u'),
              (L = new RegExp(o.source, e))
          }
        return (L.lastIndex = 0), L
      }
      n.ensureValidWordDefinition = d
      const b = new A.LinkedList()
      b.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 })
      function p(o, L, e, a, u) {
        if (((L = d(L)), u || (u = M.Iterable.first(b)), e.length > u.maxLen)) {
          let w = o - u.maxLen / 2
          return w < 0 ? (w = 0) : (a += w), (e = e.substring(w, o + u.maxLen / 2)), p(o, L, e, a, u)
        }
        const c = Date.now(),
          m = o - 1 - a
        let f = -1,
        ...
        if (y) {
          const w = { word: y[0], startColumn: a + 1 + y.index, endColumn: a + 1 + y.index + y[0].length }
    ...
    Y(X[8], J([0, 1, 7, 5, 3]), function (q, n, M, A, i) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.DateTimeout = n.InfiniteTimeout = n.OffsetPair = n.SequenceDiff = n.DiffAlgorithmResult = void 0)
      class d {
        static trivial(e, a) {
          return new d([new b(i.OffsetRange.ofLength(e.length), i.OffsetRange.ofLength(a.length))], !1)
        }
        static trivialTimedOut(e, a) {
          return new d([new b(i.OffsetRange.ofLength(e.length), i.OffsetRange.ofLength(a.length))], !0)
        }
        constructor(e, a) {
      ...
      class b {
        static invert(e, a) {
          ...
          return (
            (0, M.forEachAdjacent)(e, (c, m) => {
              u.push(
                b.fromOffsetPairs(
                  c ? c.getEndExclusives() : p.zero,
                  m ? m.getStarts() : new p(a, (c ? c.seq2Range.endExclusive - c.seq1Range.endExclusive : 0) + a),
                ),
              )
            }),
            u
        ...
        static fromOffsetPairs(e, a) {
          return new b(new i.OffsetRange(e.offset1, a.offset1), new i.OffsetRange(e.offset2, a.offset2))
        }
        constructor(e, a) {
          ;(this.seq1Range = e), (this.seq2Range = a)
        }
        swap() {
          return new b(this.seq2Range, this.seq1Range)
        }
        toString() {
          return `${this.seq1Range} <-> ${this.seq2Range}`
        }
        join(e) {
          return new b(this.seq1Range.join(e.seq1Range), this.seq2Range.join(e.seq2Range))
        }
        delta(e) {
          return e === 0 ? this : new b(this.seq1Range.delta(e), this.seq2Range.delta(e))
        }
        deltaStart(e) {
          return e === 0 ? this : new b(this.seq1Range.deltaStart(e), this.seq2Range.deltaStart(e))
        }
        deltaEnd(e) {
          return e === 0 ? this : new b(this.seq1Range.deltaEnd(e), this.seq2Range.deltaEnd(e))
        }
        intersect(e) {
          const a = this.seq1Range.intersect(e.seq1Range),
            u = this.seq2Range.intersect(e.seq2Range)
          if (!(!a || !u)) return new b(a, u)
        }
        getStarts() {
      ...
      ;(n.OffsetPair = p), (p.zero = new p(0, 0)), (p.max = new p(Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER))
      class h {
        isValid() {
          return !0
        }
    ...
    Y(X[29], J([0, 1, 3, 8]), function (q, n, M, A) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }), (n.MyersDiffAlgorithm = void 0)
      class i {
        compute(o, L, e = A.InfiniteTimeout.instance) {
          if (o.length === 0 || L.length === 0) return A.DiffAlgorithmResult.trivial(o, L)
          const a = o,
            u = L
          function c(s, l) {
            for (; s < a.length && l < u.length && a.getElement(s) === u.getElement(l); ) s++, l++
            return s
          }
          let m = 0
          const f = new b()
          ...
          e: for (;;) {
            ...
            for (w = s; w <= l; w += 2) {
              let _ = 0
              const g = w === l ? -1 : f.get(w + 1),
                v = w === s ? -1 : f.get(w - 1) + 1
              _++
              const R = Math.min(Math.max(g, v), a.length),
                N = R - w
              if ((_++, R > a.length || N > u.length)) continue
              const D = c(R, N)
              f.set(w, D)
              const x = R === g ? y.get(w + 1) : y.get(w - 1)
              if ((y.set(w, D !== R ? new d(x, R, N, D - R) : x), f.get(w) === a.length && f.get(w) - w === u.length))
                break e
            }
          }
          let E = y.get(w)
          ...
          for (;;) {
            const s = E ? E.x + E.length : 0,
              l = E ? E.y + E.length : 0
            if (
              ((s !== C || l !== r) && S.push(new A.SequenceDiff(new M.OffsetRange(s, C), new M.OffsetRange(l, r))), !E)
            )
              break
            ;(C = E.x), (r = E.y), (E = E.prev)
          }
          return S.reverse(), new A.DiffAlgorithmResult(S, !1)
        }
      }
      n.MyersDiffAlgorithm = i
      class d {
        constructor(o, L, e, a) {
          ;(this.prev = o), (this.x = L), (this.y = e), (this.length = a)
        }
      }
      class b {
        constructor() {
    ...
    Y(X[43], J([0, 1, 7, 3, 8]), function (q, n, M, A, i) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      function d(c, m, f) {
        let y = f
        return (y = b(c, m, y)), (y = b(c, m, y)), (y = p(c, m, y)), y
      }
        ...
        for (let E = 1; E < f.length; E++) {
          ...
          if (C.seq1Range.isEmpty || C.seq2Range.isEmpty) {
            ...
            for (
              ...
              s <= r &&
              !(
                c.getElement(C.seq1Range.start - s) !== c.getElement(C.seq1Range.endExclusive - s) ||
                m.getElement(C.seq2Range.start - s) !== m.getElement(C.seq2Range.endExclusive - s)
              );
              s++
            );
            if ((s--, s === r)) {
              y[y.length - 1] = new i.SequenceDiff(
                new A.OffsetRange(S.seq1Range.start, C.seq1Range.endExclusive - r),
                new A.OffsetRange(S.seq2Range.start, C.seq2Range.endExclusive - r),
              )
              continue
            }
            C = C.delta(-s)
        ...
        for (let E = 0; E < y.length - 1; E++) {
          ...
          if (C.seq1Range.isEmpty || C.seq2Range.isEmpty) {
            ...
            for (
              ...
              s < r &&
              !(
                !c.isStronglyEqual(C.seq1Range.start + s, C.seq1Range.endExclusive + s) ||
                !m.isStronglyEqual(C.seq2Range.start + s, C.seq2Range.endExclusive + s)
              );
              s++
            );
            if (s === r) {
              y[E + 1] = new i.SequenceDiff(
                new A.OffsetRange(C.seq1Range.start + r, S.seq1Range.endExclusive),
                new A.OffsetRange(C.seq2Range.start + r, S.seq2Range.endExclusive),
              )
              continue
            }
            s > 0 && (C = C.delta(s))
      ...
      function p(c, m, f) {
        ...
        for (let y = 0; y < f.length; y++) {
          const w = y > 0 ? f[y - 1] : void 0,
            ...
            C = new A.OffsetRange(w ? w.seq1Range.endExclusive + 1 : 0, S ? S.seq1Range.start - 1 : c.length),
            r = new A.OffsetRange(w ? w.seq2Range.endExclusive + 1 : 0, S ? S.seq2Range.start - 1 : m.length)
          E.seq1Range.isEmpty
            ? (f[y] = h(E, c, m, C, r))
            : E.seq2Range.isEmpty && (f[y] = h(E.swap(), m, c, r, C).swap())
        }
        return f
      }
      function h(c, m, f, y, w) {
        let S = 1
        for (
          ;
          c.seq1Range.start - S >= y.start &&
          c.seq2Range.start - S >= w.start &&
          f.isStronglyEqual(c.seq2Range.start - S, c.seq2Range.endExclusive - S) &&
          S < 100;
        )
          S++
        S--
        ...
        for (
          ;
          c.seq1Range.start + C < y.endExclusive &&
          c.seq2Range.endExclusive + C < w.endExclusive &&
          f.isStronglyEqual(c.seq2Range.start + C, c.seq2Range.endExclusive + C) &&
          C < 100;
        )
          C++
        if (S === 0 && C === 0) return c
        let r = 0,
          s = -1
        for (let l = -S; l <= C; l++) {
          const _ = c.seq2Range.start + l,
            g = c.seq2Range.endExclusive + l,
            v = c.seq1Range.start + l,
            R = m.getBoundaryScore(v) + f.getBoundaryScore(_) + f.getBoundaryScore(g)
          R > s && ((s = R), (r = l))
        }
        return c.delta(r)
      }
      function o(c, m, f) {
        ...
        for (const w of f) {
          ...
          w.seq1Range.start - E.seq1Range.endExclusive <= 2 || w.seq2Range.start - E.seq2Range.endExclusive <= 2
            ? (y[y.length - 1] = new i.SequenceDiff(E.seq1Range.join(w.seq1Range), E.seq2Range.join(w.seq2Range)))
            : y.push(w)
        }
        return y
      }
      ...
      function L(c, m, f) {
        const y = i.SequenceDiff.invert(f, c.length),
          w = []
        let E = new i.OffsetPair(0, 0)
        function S(r, s) {
          if (r.offset1 < E.offset1 || r.offset2 < E.offset2) return
          const l = c.findWordContaining(r.offset1),
            _ = m.findWordContaining(r.offset2)
          if (!l || !_) return
          let g = new i.SequenceDiff(l, _)
          const v = g.intersect(s)
          let R = v.seq1Range.length,
            N = v.seq2Range.length
          for (; y.length > 0; ) {
            const D = y[0]
            if (!(D.seq1Range.intersects(l) || D.seq2Range.intersects(_))) break
            const T = c.findWordContaining(D.seq1Range.start),
              F = m.findWordContaining(D.seq2Range.start),
              B = new i.SequenceDiff(T, F),
              V = B.intersect(D)
            if (
              ((R += V.seq1Range.length),
              (N += V.seq2Range.length),
              (g = g.join(B)),
              g.seq1Range.endExclusive >= D.seq1Range.endExclusive)
            )
              y.shift()
            else break
          }
          R + N < ((g.seq1Range.length + g.seq2Range.length) * 2) / 3 && w.push(g), (E = g.getEndExclusives())
        }
        for (; y.length > 0; ) {
          const r = y.shift()
          r.seq1Range.isEmpty || (S(r.getStarts(), r), S(r.getEndExclusives().delta(-1), r))
        }
        return e(f, w)
      }
      n.extendDiffsToEntireWordIfAppropriate = L
      function e(c, m) {
        const f = []
        for (; c.length > 0 || m.length > 0; ) {
          const y = c[0],
            w = m[0]
          let E
          y && (!w || y.seq1Range.start < w.seq1Range.start) ? (E = c.shift()) : (E = m.shift()),
          ...
          for (let C = 1; C < y.length; C++) {
            let l = function (g, v) {
              ...
              return (
                ...
                (g.seq1Range.length + g.seq2Range.length > 5 || v.seq1Range.length + v.seq2Range.length > 5)
              )
            }
            const r = y[C],
              s = S[S.length - 1]
            l(s, r) ? ((E = !0), (S[S.length - 1] = S[S.length - 1].join(r))) : S.push(r)
          }
          y = S
        } while (w++ < 10 && E)
        return y
          ...
          for (let r = 1; r < y.length; r++) {
            let _ = function (v, R) {
              ...
              const T = c.countLinesIn(v.seq1Range),
                ...
                B = m.countLinesIn(v.seq2Range),
                V = v.seq2Range.length,
                k = c.countLinesIn(R.seq1Range),
                O = R.seq1Range.length,
                I = m.countLinesIn(R.seq2Range),
                W = R.seq2Range.length,
                z = 2 * 40 + 50
              function G(t) {
                return Math.min(t, z)
              }
              return (
                Math.pow(Math.pow(G(T * 40 + F), 1.5) + Math.pow(G(B * 40 + V), 1.5), 1.5) +
                  Math.pow(Math.pow(G(k * 40 + O), 1.5) + Math.pow(G(I * 40 + W), 1.5), 1.5) >
                (z ** 1.5) ** 1.5 * 1.3
              )
            }
            const s = y[r],
              l = C[C.length - 1]
            _(l, s) ? ((E = !0), (C[C.length - 1] = C[C.length - 1].join(s))) : C.push(s)
          }
          y = C
        } while (w++ < 10 && E)
        const S = []
        return (
          (0, M.forEachWithNeighbors)(y, (C, r, s) => {
            let l = r
            function _(x) {
              return x.length > 0 && x.trim().length <= 3 && r.seq1Range.length + r.seq2Range.length > 100
            }
            const g = c.extendToFullLines(r.seq1Range),
              v = c.getText(new A.OffsetRange(g.start, r.seq1Range.start))
            _(v) && (l = l.deltaStart(-v.length))
            const R = c.getText(new A.OffsetRange(r.seq1Range.endExclusive, g.endExclusive))
            _(R) && (l = l.deltaEnd(R.length))
            const N = i.SequenceDiff.fromOffsetPairs(
                C ? C.getEndExclusives() : i.OffsetPair.zero,
                s ? s.getStarts() : i.OffsetPair.max,
              ),
              D = l.intersect(N)
            S.length > 0 && D.getStarts().equals(S[S.length - 1].getEndExclusives())
              ? (S[S.length - 1] = S[S.length - 1].join(D))
              : S.push(D)
          }),
          S
        )
    ...
    Y(X[44], J([0, 1]), function (q, n) {
      ...
      class M {
        ...
        getBoundaryScore(d) {
          const b = d === 0 ? 0 : A(this.lines[d - 1]),
            p = d === this.lines.length ? 0 : A(this.lines[d])
          return 1e3 - (b + p)
        }
        getText(d) {
...
`)
        ...
        isStronglyEqual(d, b) {
          return this.lines[d] === this.lines[b]
        }
      }
      n.LineSequence = M
      function A(i) {
    ...
    Y(X[15], J([0, 1]), function (q, n) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }), (n.LineRangeFragment = n.isSpace = n.Array2D = void 0)
      class M {
        constructor(b, p) {
          ;(this.width = b), (this.height = p), (this.array = []), (this.array = new Array(b * p))
        }
        get(b, p) {
          return this.array[b + p * this.width]
        }
        set(b, p, h) {
          this.array[b + p * this.width] = h
        }
      }
      n.Array2D = M
      function A(d) {
      ...
      class i {
        static getKey(b) {
          let p = this.chrKeys.get(b)
          return p === void 0 && ((p = this.chrKeys.size), this.chrKeys.set(b, p)), p
        }
        constructor(b, p, h) {
          ;(this.range = b), (this.lines = p), (this.source = h), (this.histogram = [])
          let o = 0
          for (let L = b.startLineNumber - 1; L < b.endLineNumberExclusive - 1; L++) {
            const e = p[L]
...
`)
        ...
        computeSimilarity(b) {
          var p, h
          let o = 0
          const L = Math.max(this.histogram.length, b.histogram.length)
          for (let e = 0; e < L; e++)
            o += Math.abs(
              ((p = this.histogram[e]) !== null && p !== void 0 ? p : 0) -
                ((h = b.histogram[e]) !== null && h !== void 0 ? h : 0),
            )
          return 1 - o / (this.totalCount + b.totalCount)
        }
      }
      ;(n.LineRangeFragment = i), (i.chrKeys = new Map())
    }),
    Y(X[45], J([0, 1, 3, 8, 15]), function (q, n, M, A, i) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }), (n.DynamicProgrammingDiffing = void 0)
      class d {
        compute(p, h, o = A.InfiniteTimeout.instance, L) {
          if (p.length === 0 || h.length === 0) return A.DiffAlgorithmResult.trivial(p, h)
          const e = new i.Array2D(p.length, h.length),
            a = new i.Array2D(p.length, h.length),
            u = new i.Array2D(p.length, h.length)
          for (let S = 0; S < p.length; S++)
            for (let C = 0; C < h.length; C++) {
              if (!o.isValid()) return A.DiffAlgorithmResult.trivialTimedOut(p, h)
              const r = S === 0 ? 0 : e.get(S - 1, C),
                s = C === 0 ? 0 : e.get(S, C - 1)
              let l
              p.getElement(S) === h.getElement(C)
                ? (S === 0 || C === 0 ? (l = 0) : (l = e.get(S - 1, C - 1)),
                  S > 0 && C > 0 && a.get(S - 1, C - 1) === 3 && (l += u.get(S - 1, C - 1)),
                  (l += L ? L(S, C) : 1))
                : (l = -1)
              const _ = Math.max(r, s, l)
              if (_ === l) {
                const g = S > 0 && C > 0 ? u.get(S - 1, C - 1) : 0
                u.set(S, C, g + 1), a.set(S, C, 3)
              } else _ === r ? (u.set(S, C, 0), a.set(S, C, 1)) : _ === s && (u.set(S, C, 0), a.set(S, C, 2))
              e.set(S, C, _)
            }
          const c = []
          let m = p.length,
          ...
          function y(S, C) {
            ;(S + 1 !== m || C + 1 !== f) &&
              c.push(new A.SequenceDiff(new M.OffsetRange(S + 1, m), new M.OffsetRange(C + 1, f))),
              (m = S),
              (f = C)
          }
          let w = p.length - 1,
            E = h.length - 1
          for (; w >= 0 && E >= 0; ) a.get(w, E) === 3 ? (y(w, E), w--, E--) : a.get(w, E) === 1 ? w-- : E--
          return y(-1, -1), c.reverse(), new A.DiffAlgorithmResult(c, !1)
        }
      }
      n.DynamicProgrammingDiffing = d
    }),
    Y(X[30], J([0, 1, 11, 3, 4, 2, 15]), function (q, n, M, A, i, d, b) {
      'use strict'
      ...
      class p {
        constructor(u, c, m) {
          ...
          let f = !1
          c.start > 0 && c.endExclusive >= u.length && ((c = new A.OffsetRange(c.start - 1, c.endExclusive)), (f = !0)),
            (this.lineRange = c),
...
`.charCodeAt(0),
              ...
              (this.firstCharOffsetByLine[y - this.lineRange.start + 1] = this.elements.length))
          }
        ...
        getBoundaryScore(u) {
          ...
          if (c === 8) return 150
          let f = 0
          return c !== m && ((f += 10), c === 0 && m === 1 && (f += 1)), (f += L(c)), (f += L(m)), f
        }
        translateOffset(u) {
          if (this.lineRange.isEmpty) return new i.Position(this.lineRange.start + 1, 1)
          const c = (0, M.findLastIdxMonotonous)(this.firstCharOffsetByLine, m => m <= u)
        ...
        translateRange(u) {
          return d.Range.fromPositions(this.translateOffset(u.start), this.translateOffset(u.endExclusive))
        }
        ...
        countLinesIn(u) {
          return this.translateOffset(u.endExclusive).lineNumber - this.translateOffset(u.start).lineNumber
        }
        isStronglyEqual(u, c) {
        ...
        extendToFullLines(u) {
          var c, m
          const f =
              (c = (0, M.findLastMonotonous)(this.firstCharOffsetByLine, w => w <= u.start)) !== null && c !== void 0
                ? c
                : 0,
            y =
              (m = (0, M.findFirstMonotonous)(this.firstCharOffsetByLine, w => u.endExclusive <= w)) !== null &&
              m !== void 0
                ? m
                : this.elements.length
          return new A.OffsetRange(f, y)
        }
      }
      ...
      const o = { [0]: 0, [1]: 0, [2]: 0, [3]: 10, [4]: 2, [5]: 30, [6]: 3, [7]: 10, [8]: 10 }
      function L(a) {
        return o[a]
      }
      function e(a) {
    ...
    Y(X[31], J([0, 1]), function (q, n) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }), (n.MovedText = n.LinesDiff = void 0)
      class M {
        constructor(d, b, p) {
          ;(this.changes = d), (this.moves = b), (this.hitTimeout = p)
        }
      }
      n.LinesDiff = M
      class A {
        constructor(d, b) {
          ;(this.lineRangeMapping = d), (this.changes = b)
        }
      }
      n.MovedText = A
    }),
    Y(X[16], J([0, 1, 10]), function (q, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.RangeMapping = n.DetailedLineRangeMapping = n.LineRangeMapping = void 0)
      class A {
        static inverse(p, h, o) {
          const L = []
          let e = 1,
            a = 1
          for (const c of p) {
            ...
            m.modified.isEmpty || L.push(m),
              (e = c.original.endLineNumberExclusive),
              (a = c.modified.endLineNumberExclusive)
          }
          const u = new A(new M.LineRange(e, h + 1), new M.LineRange(a, o + 1))
          return u.modified.isEmpty || L.push(u), L
        }
        static clip(p, h, o) {
          const L = []
          for (const e of p) {
            const a = e.original.intersect(h),
              u = e.modified.intersect(o)
            a && !a.isEmpty && u && !u.isEmpty && L.push(new A(a, u))
          }
          return L
        }
        constructor(p, h) {
          ;(this.original = p), (this.modified = h)
        }
        toString() {
        ...
        join(p) {
          return new A(this.original.join(p.original), this.modified.join(p.modified))
        }
      }
      n.LineRangeMapping = A
      class i extends A {
        constructor(p, h, o) {
          super(p, h), (this.innerChanges = o)
        }
        flip() {
          var p
          return new i(
            this.modified,
            this.original,
            (p = this.innerChanges) === null || p === void 0 ? void 0 : p.map(h => h.flip()),
          )
        }
      }
      ...
      class d {
        constructor(p, h) {
          ;(this.originalRange = p), (this.modifiedRange = h)
        }
        toString() {
    ...
    Y(X[46], J([0, 1, 8, 16, 7, 11, 37, 10, 3, 30, 15, 29]), function (q, n, M, A, i, d, b, p, h, o, L, e) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }), (n.computeMovedLines = void 0)
      function a(E, S, C, r, s, l) {
        let { moves: _, excludedChanges: g } = c(E, S, C, l)
        if (!l.isValid()) return []
        const v = E.filter(N => !g.has(N)),
          R = m(v, r, s, S, C, l)
        return (
          (0, i.pushMany)(_, R),
          (_ = y(_)),
...
`).length >= 15 && u(D, T => T.length >= 2) >= 2
      ...
      function c(E, S, C, r) {
        const s = [],
          l = E.filter(v => v.modified.isEmpty && v.original.length >= 3).map(
            v => new L.LineRangeFragment(v.original, S, v),
          ),
          _ = new Set(
            E.filter(v => v.original.isEmpty && v.modified.length >= 3).map(
              v => new L.LineRangeFragment(v.modified, C, v),
            ),
          ),
          g = new Set()
        for (const v of l) {
          ...
          if (
            (R > 0.9 &&
              N &&
              (_.delete(N), s.push(new A.LineRangeMapping(v.range, N.range)), g.add(v.source), g.add(N.source)),
            !r.isValid())
          )
            return { moves: s, excludedChanges: g }
        }
        return { moves: s, excludedChanges: g }
      }
      function m(E, S, C, r, s, l) {
        const _ = [],
          g = new b.SetMap()
        for (const x of E)
          for (let T = x.original.startLineNumber; T < x.original.endLineNumberExclusive - 2; T++) {
            const F = `${S[T - 1]}:${S[T + 1 - 1]}:${S[T + 2 - 1]}`
            g.add(F, { range: new p.LineRange(T, T + 3) })
          }
        const v = []
        E.sort((0, i.compareBy)(x => x.modified.startLineNumber, i.numberComparator))
        for (const x of E) {
          let T = []
          for (let F = x.modified.startLineNumber; F < x.modified.endLineNumberExclusive - 2; F++) {
            const B = `${C[F - 1]}:${C[F + 1 - 1]}:${C[F + 2 - 1]}`,
              V = new p.LineRange(F, F + 3),
              k = []
            g.forEach(B, ({ range: O }) => {
              for (const W of T)
                if (
                  W.originalLineRange.endLineNumberExclusive + 1 === O.endLineNumberExclusive &&
                  W.modifiedLineRange.endLineNumberExclusive + 1 === V.endLineNumberExclusive
                ) {
                  ;(W.originalLineRange = new p.LineRange(
                    W.originalLineRange.startLineNumber,
                    O.endLineNumberExclusive,
                  )),
                    (W.modifiedLineRange = new p.LineRange(
              ...
              const I = { modifiedLineRange: V, originalLineRange: O }
              v.push(I), k.push(I)
            }),
              (T = k)
          }
        ...
        v.sort((0, i.reverseOrder)((0, i.compareBy)(x => x.modifiedLineRange.length, i.numberComparator)))
        const R = new p.LineRangeSet(),
          N = new p.LineRangeSet()
        for (const x of v) {
          const T = x.modifiedLineRange.startLineNumber - x.originalLineRange.startLineNumber,
            F = R.subtractFrom(x.modifiedLineRange),
            B = N.subtractFrom(x.originalLineRange).getWithDelta(T),
            V = F.getIntersection(B)
          for (const k of V.ranges) {
            if (k.length < 3) continue
            const O = k,
              I = k.delta(-T)
            _.push(new A.LineRangeMapping(I, O)), R.addRange(O), N.addRange(I)
          }
        }
        _.sort((0, i.compareBy)(x => x.original.startLineNumber, i.numberComparator))
        const D = new d.MonotonousArray(E)
        for (let x = 0; x < _.length; x++) {
          const T = _[x],
            F = D.findLastMonotonous(G => G.original.startLineNumber <= T.original.startLineNumber),
            ...
            V = Math.max(
              ...
              T.modified.startLineNumber - B.modified.startLineNumber,
            ),
            k = D.findLastMonotonous(G => G.original.startLineNumber < T.original.endLineNumberExclusive),
            O = (0, d.findLastMonotonous)(E, G => G.modified.startLineNumber < T.modified.endLineNumberExclusive),
            I = Math.max(
              k.original.endLineNumberExclusive - T.original.endLineNumberExclusive,
              O.modified.endLineNumberExclusive - T.modified.endLineNumberExclusive,
            )
          let W
          for (W = 0; W < V; W++) {
            const G = T.original.startLineNumber - W - 1,
              t = T.modified.startLineNumber - W - 1
            if (G > r.length || t > s.length || R.contains(t) || N.contains(G) || !f(r[G - 1], s[t - 1], l)) break
          }
          W > 0 &&
            (N.addRange(new p.LineRange(T.original.startLineNumber - W, T.original.startLineNumber)),
            R.addRange(new p.LineRange(T.modified.startLineNumber - W, T.modified.startLineNumber)))
          let z
          for (z = 0; z < I; z++) {
            const G = T.original.endLineNumberExclusive + z,
              t = T.modified.endLineNumberExclusive + z
            if (G > r.length || t > s.length || R.contains(t) || N.contains(G) || !f(r[G - 1], s[t - 1], l)) break
          }
          z > 0 &&
            (N.addRange(new p.LineRange(T.original.endLineNumberExclusive, T.original.endLineNumberExclusive + z)),
            R.addRange(new p.LineRange(T.modified.endLineNumberExclusive, T.modified.endLineNumberExclusive + z))),
            (W > 0 || z > 0) &&
              (_[x] = new A.LineRangeMapping(
                new p.LineRange(T.original.startLineNumber - W, T.original.endLineNumberExclusive + z),
                new p.LineRange(T.modified.startLineNumber - W, T.modified.endLineNumberExclusive + z),
              ))
        }
        return _
      }
      function f(E, S, C) {
        ...
        const s = new e.MyersDiffAlgorithm().compute(
          ...
          new o.LinesSliceCharSequence([S], new h.OffsetRange(0, 1), !1),
          C,
        )
        let l = 0
        const _ = M.SequenceDiff.invert(s.diffs, E.length)
        for (const N of _)
          N.seq1Range.forEach(D => {
            ;(0, L.isSpace)(E.charCodeAt(D)) || l++
          })
        function g(N) {
          let D = 0
          for (let x = 0; x < E.length; x++) (0, L.isSpace)(N.charCodeAt(x)) || D++
          return D
        }
        const v = g(E.length > S.length ? E : S)
        return l / v > 0.6 && v > 10
      }
      function y(E) {
        ...
        for (let C = 1; C < E.length; C++) {
          const r = S[S.length - 1],
            ...
            _ = s.modified.startLineNumber - r.modified.endLineNumberExclusive
          if (l >= 0 && _ >= 0 && l + _ <= 2) {
            S[S.length - 1] = r.join(s)
            continue
          }
          S.push(s)
        }
      ...
      function w(E, S) {
        ...
        return (
          (S = S.filter(r => {
            const s =
                C.findLastMonotonous(g => g.original.startLineNumber < r.original.endLineNumberExclusive) ||
                new A.LineRangeMapping(new p.LineRange(1, 1), new p.LineRange(1, 1)),
              l = (0, d.findLastMonotonous)(E, g => g.modified.startLineNumber < r.modified.endLineNumberExclusive)
            return s !== l
          })),
          S
        )
    ...
    Y(
      X[47],
      J([0, 1, 7, 12, 10, 3, 2, 8, 45, 29, 46, 43, 31, 16, 30, 44]),
      function (q, n, M, A, i, d, b, p, h, o, L, e, a, u, c, m) {
        'use strict'
        Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.getLineRangeMapping = n.lineRangeMappingFromRangeMappings = n.DefaultLinesDiffComputer = void 0)
        class f {
          constructor() {
          ...
          computeDiff(S, C, r) {
            if (S.length <= 1 && (0, M.equals)(S, C, (z, G) => z === G)) return new a.LinesDiff([], [], !1)
            if ((S.length === 1 && S[0].length === 0) || (C.length === 1 && C[0].length === 0))
              return new a.LinesDiff(
                [
                  new u.DetailedLineRangeMapping(new i.LineRange(1, S.length + 1), new i.LineRange(1, C.length + 1), [
                    new u.RangeMapping(
                      new b.Range(1, 1, S.length, S[0].length + 1),
                      new b.Range(1, 1, C.length, C[0].length + 1),
                    ),
                  ]),
                ],
                [],
            ...
            const s =
                r.maxComputationTimeMs === 0 ? p.InfiniteTimeout.instance : new p.DateTimeout(r.maxComputationTimeMs),
              l = !r.ignoreTrimWhitespace,
              _ = new Map()
            function g(z) {
              let G = _.get(z)
              return G === void 0 && ((G = _.size), _.set(z, G)), G
            }
            const v = S.map(z => g(z.trim())),
              R = C.map(z => g(z.trim())),
              N = new m.LineSequence(v, S),
              D = new m.LineSequence(R, C),
              x = (() =>
                N.length + D.length < 1700
                  ? this.dynamicProgrammingDiffing.compute(N, D, s, (z, G) =>
                      S[z] === C[G] ? (C[G].length === 0 ? 0.1 : 1 + Math.log(1 + C[G].length)) : 0.99,
                    )
                  : this.myersDiffingAlgorithm.compute(N, D))()
            let T = x.diffs,
              F = x.hitTimeout
            ;(T = (0, e.optimizeSequenceDiffs)(N, D, T)), (T = (0, e.removeVeryShortMatchingLinesBetweenDiffs)(N, D, T))
            const B = [],
              V = z => {
                if (l)
                  for (let G = 0; G < z; G++) {
                    const t = k + G,
                      se = O + G
                    if (S[t] !== C[se]) {
                      const ce = this.refineDiff(
                        S,
                        C,
                        new p.SequenceDiff(new d.OffsetRange(t, t + 1), new d.OffsetRange(se, se + 1)),
                        s,
                        l,
                      )
                      for (const me of ce.mappings) B.push(me)
                      ce.hitTimeout && (F = !0)
                    }
                  }
              }
            let k = 0,
              O = 0
            for (const z of T) {
              ;(0, A.assertFn)(() => z.seq1Range.start - k === z.seq2Range.start - O)
              const G = z.seq1Range.start - k
              V(G), (k = z.seq1Range.endExclusive), (O = z.seq2Range.endExclusive)
              const t = this.refineDiff(S, C, z, s, l)
              t.hitTimeout && (F = !0)
              for (const se of t.mappings) B.push(se)
            }
            V(S.length - k)
            const I = y(B, S, C)
            let W = []
            return (
              r.computeMoves && (W = this.computeMoves(I, S, C, v, R, s, l)),
              (0, A.assertFn)(() => {
                function z(t, se) {
                  if (t.lineNumber < 1 || t.lineNumber > se.length) return !1
                  const ce = se[t.lineNumber - 1]
                  return !(t.column < 1 || t.column > ce.length + 1)
                }
                function G(t, se) {
                  return !(
                    t.startLineNumber < 1 ||
                    t.startLineNumber > se.length + 1 ||
                    t.endLineNumberExclusive < 1 ||
                    t.endLineNumberExclusive > se.length + 1
                  )
                }
                for (const t of I) {
                  if (!t.innerChanges) return !1
                  for (const se of t.innerChanges)
                    if (
                      !(
                        z(se.modifiedRange.getStartPosition(), C) &&
                        z(se.modifiedRange.getEndPosition(), C) &&
                        z(se.originalRange.getStartPosition(), S) &&
                        z(se.originalRange.getEndPosition(), S)
                      )
                    )
                      return !1
                  if (!G(t.modified, C) || !G(t.original, S)) return !1
                }
                return !0
              }),
              new a.LinesDiff(I, W, F)
            )
          }
          computeMoves(S, C, r, s, l, _, g) {
            return (0, L.computeMovedLines)(S, C, r, s, l, _).map(N => {
              const D = this.refineDiff(
                  C,
                  r,
                  new p.SequenceDiff(N.original.toOffsetRange(), N.modified.toOffsetRange()),
                  _,
                  g,
                ),
                x = y(D.mappings, C, r, !0)
              return new a.MovedText(N, x)
            })
          }
          refineDiff(S, C, r, s, l) {
            const _ = new c.LinesSliceCharSequence(S, r.seq1Range, l),
              g = new c.LinesSliceCharSequence(C, r.seq2Range, l),
              v =
                _.length + g.length < 500
                  ? this.dynamicProgrammingDiffing.compute(_, g, s)
                  : this.myersDiffingAlgorithm.compute(_, g, s)
            let R = v.diffs
            return (
              (R = (0, e.optimizeSequenceDiffs)(_, g, R)),
              (R = (0, e.extendDiffsToEntireWordIfAppropriate)(_, g, R)),
              (R = (0, e.removeShortMatches)(_, g, R)),
              (R = (0, e.removeVeryShortMatchingTextBetweenLongDiffs)(_, g, R)),
              {
                mappings: R.map(D => new u.RangeMapping(_.translateRange(D.seq1Range), g.translateRange(D.seq2Range))),
        ...
        function y(E, S, C, r = !1) {
          ...
          for (const l of (0, M.groupAdjacentBy)(
            E.map(_ => w(_, S, C)),
            (_, g) => _.original.overlapOrTouch(g.original) || _.modified.overlapOrTouch(g.modified),
          )) {
            const _ = l[0],
              g = l[l.length - 1]
            s.push(
              new u.DetailedLineRangeMapping(
                _.original.join(g.original),
                _.modified.join(g.modified),
          ...
          return (
            (0, A.assertFn)(() =>
              !r && s.length > 0 && s[0].original.startLineNumber !== s[0].modified.startLineNumber
                ? !1
                : (0, A.checkAdjacentItems)(
                    s,
                    (l, _) =>
                      _.original.startLineNumber - l.original.endLineNumberExclusive ===
                        _.modified.startLineNumber - l.modified.endLineNumberExclusive &&
                      l.original.endLineNumberExclusive < _.original.startLineNumber &&
                      l.modified.endLineNumberExclusive < _.modified.startLineNumber,
                  ),
            ),
            s
          )
        }
        n.lineRangeMappingFromRangeMappings = y
        function w(E, S, C) {
          let r = 0,
            s = 0
          E.modifiedRange.endColumn === 1 &&
            ...
            (s = -1),
            E.modifiedRange.startColumn - 1 >= C[E.modifiedRange.startLineNumber - 1].length &&
              E.originalRange.startColumn - 1 >= S[E.originalRange.startLineNumber - 1].length &&
              ...
              (r = 1)
          const l = new i.LineRange(E.originalRange.startLineNumber + r, E.originalRange.endLineNumber + 1 + s),
            _ = new i.LineRange(E.modifiedRange.startLineNumber + r, E.modifiedRange.endLineNumber + 1 + s)
          return new u.DetailedLineRangeMapping(l, _, [E])
        }
        n.getLineRangeMapping = w
      },
    ),
    Y(X[48], J([0, 1, 24, 31, 16, 6, 2, 12, 10]), function (q, n, M, A, i, d, b, p, h) {
      'use strict'
        ...
        computeDiff(r, s, l) {
          ...
          for (const D of v.changes) {
            ...
            D.originalEndLineNumber === 0
              ? (x = new h.LineRange(D.originalStartLineNumber + 1, D.originalStartLineNumber + 1))
              : (x = new h.LineRange(D.originalStartLineNumber, D.originalEndLineNumber + 1))
            let T
            D.modifiedEndLineNumber === 0
              ? (T = new h.LineRange(D.modifiedStartLineNumber + 1, D.modifiedStartLineNumber + 1))
              : (T = new h.LineRange(D.modifiedStartLineNumber, D.modifiedEndLineNumber + 1))
            let F = new i.DetailedLineRangeMapping(
              x,
              T,
              (_ = D.charChanges) === null || _ === void 0
                ? void 0
                : _.map(
                    B =>
                      new i.RangeMapping(
            ...
            N &&
              ...
              ((F = new i.DetailedLineRangeMapping(
                ...
                N.innerChanges && F.innerChanges ? N.innerChanges.concat(F.innerChanges) : void 0,
              )),
              R.pop()),
              R.push(F),
              (N = F)
          ...
          return (
            (0, p.assertFn)(() =>
              (0, p.checkAdjacentItems)(
                R,
                (D, x) =>
                  x.original.startLineNumber - D.original.endLineNumberExclusive ===
                    x.modified.startLineNumber - D.modified.endLineNumberExclusive &&
                  D.original.endLineNumberExclusive < x.original.startLineNumber &&
      ...
      n.LegacyLinesDiffComputer = L
      function e(C, r, s, l) {
        return new M.LcsDiff(C, r, s).ComputeDiff(l)
      }
      class a {
        constructor(r) {
          const s = [],
            l = []
          for (let _ = 0, g = r.length; _ < g; _++) (s[_] = w(r[_], 1)), (l[_] = E(r[_], 1))
          ;(this.lines = r), (this._startColumns = s), (this._endColumns = l)
        }
        getElements() {
          const r = []
          for (let s = 0, l = this.lines.length; s < l; s++)
            r[s] = this.lines[s].substring(this._startColumns[s] - 1, this._endColumns[s] - 1)
          return r
        }
        getStrictElement(r) {
          return this.lines[r]
        ...
        createCharSequence(r, s, l) {
          ...
          for (let N = s; N <= l; N++) {
            ...
            for (let F = x; F < T; F++) (_[R] = D.charCodeAt(F - 1)), (g[R] = N + 1), (v[R] = F), R++
            !r && N < l && ((_[R] = 10), (g[R] = N + 1), (v[R] = D.length + 1), R++)
          }
          return new u(_, g, v)
        }
      }
      class u {
        ...
        toString() {
          return (
            ...
            this._charCodes
              .map(
                (r, s) =>
                  (r === 10 ? '\\n' : String.fromCharCode(r)) + `-(${this._lineNumbers[s]},${this._columns[s]})`,
              )
              .join(', ') +
            ']'
          )
        ...
        getEndLineNumber(r) {
          return r === -1
            ...
            : (this._assertIndex(r, this._lineNumbers),
              this._charCodes[r] === 10 ? this._lineNumbers[r] + 1 : this._lineNumbers[r])
        }
        getStartColumn(r) {
        ...
        getEndColumn(r) {
          return r === -1
            ...
            : (this._assertIndex(r, this._columns), this._charCodes[r] === 10 ? 1 : this._columns[r] + 1)
        }
      }
      class c {
        constructor(r, s, l, _, g, v, R, N) {
          ;(this.originalStartLineNumber = r),
            (this.originalStartColumn = s),
            (this.originalEndLineNumber = l),
            (this.originalEndColumn = _),
        ...
        static createFromDiffChange(r, s, l) {
          const _ = s.getStartLineNumber(r.originalStart),
            g = s.getStartColumn(r.originalStart),
      ...
      function m(C) {
        ...
        const r = [C[0]]
        let s = r[0]
        for (let l = 1, _ = C.length; l < _; l++) {
          const g = C[l],
            v = g.originalStart - (s.originalStart + s.originalLength),
            R = g.modifiedStart - (s.modifiedStart + s.modifiedLength)
          Math.min(v, R) < o
            ? ((s.originalLength = g.originalStart + g.originalLength - s.originalStart),
              (s.modifiedLength = g.modifiedStart + g.modifiedLength - s.modifiedStart))
            : (r.push(g), (s = g))
        }
        return r
      }
      class f {
        constructor(r, s, l, _, g) {
          ;(this.originalStartLineNumber = r),
        ...
        static createFromDiffResult(r, s, l, _, g, v, R) {
          let N, D, x, T, F
          if (
            (s.originalLength === 0
            ...
            s.modifiedLength === 0
              ? ((x = _.getStartLineNumber(s.modifiedStart) - 1), (T = 0))
              : ((x = _.getStartLineNumber(s.modifiedStart)),
                (T = _.getEndLineNumber(s.modifiedStart + s.modifiedLength - 1))),
            v && s.originalLength > 0 && s.originalLength < 20 && s.modifiedLength > 0 && s.modifiedLength < 20 && g())
          ) {
            const B = l.createCharSequence(r, s.originalStart, s.originalStart + s.originalLength - 1),
              V = _.createCharSequence(r, s.modifiedStart, s.modifiedStart + s.modifiedLength - 1)
            if (B.getElements().length > 0 && V.getElements().length > 0) {
              let k = e(B, V, g, !0).changes
              R && (k = m(k)), (F = [])
              for (let O = 0, I = k.length; O < I; O++) F.push(c.createFromDiffChange(k[O], B, V))
            }
          }
      ...
      class y {
        constructor(r, s, l) {
          ;(this.shouldComputeCharChanges = l.shouldComputeCharChanges),
            ...
            (this.continueLineDiff = S(l.maxComputationTime)),
            (this.continueCharDiff = S(l.maxComputationTime === 0 ? 0 : Math.min(l.maxComputationTime, 5e3)))
        }
        computeDiff() {
              ...
              if (F !== B) {
                {
                  let V = w(F, 1),
                    k = w(B, 1)
                  for (; V > 1 && k > 1; ) {
                    const O = F.charCodeAt(V - 2),
                      I = B.charCodeAt(k - 2)
                    if (O !== I) break
                    V--, k--
                  }
                  ;(V > 1 || k > 1) && this._pushTrimWhitespaceCharChange(_, g + 1, 1, V, v + 1, 1, k)
                }
                {
                  let V = E(F, 1),
                    k = E(B, 1)
                  const O = F.length + 1,
                    I = B.length + 1
                  for (; V < O && k < I; ) {
                    const W = F.charCodeAt(V - 1),
                      z = F.charCodeAt(k - 1)
                    if (W !== z) break
                    V++, k++
                  }
                  ;(V < O || k < I) && this._pushTrimWhitespaceCharChange(_, g + 1, V, O, v + 1, k, I)
                }
              }
              g++, v++
            }
          ...
          return { quitEarly: l, changes: _ }
        }
        _pushTrimWhitespaceCharChange(r, s, l, _, g, v, R) {
          if (this._mergeTrimWhitespaceCharChange(r, s, l, _, g, v, R)) return
          let N
          this.shouldComputeCharChanges && (N = [new c(s, l, s, _, g, v, g, R)]), r.push(new f(s, s, g, g, N))
        }
        _mergeTrimWhitespaceCharChange(r, s, l, _, g, v, R) {
          const N = r.length
          if (N === 0) return !1
          const D = r[N - 1]
          return D.originalEndLineNumber === 0 || D.modifiedEndLineNumber === 0
            ? !1
            : D.originalEndLineNumber === s && D.modifiedEndLineNumber === g
              ? (this.shouldComputeCharChanges && D.charChanges && D.charChanges.push(new c(s, l, s, _, g, v, g, R)),
                !0)
              : D.originalEndLineNumber + 1 === s && D.modifiedEndLineNumber + 1 === g
                ? ((D.originalEndLineNumber = s),
                  (D.modifiedEndLineNumber = g),
                  this.shouldComputeCharChanges && D.charChanges && D.charChanges.push(new c(s, l, s, _, g, v, g, R)),
                  !0)
                : !1
        }
      ...
      n.DiffComputer = y
      function w(C, r) {
        const s = d.firstNonWhitespaceIndex(C)
        return s === -1 ? r : s + 1
      }
      function E(C, r) {
        const s = d.lastNonWhitespaceIndex(C)
        return s === -1 ? r : s + 2
      }
      function S(C) {
        if (C === 0) return () => !0
    ...
    Y(X[49], J([0, 1, 48, 47]), function (q, n, M, A) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
    ...
    Y(X[50], J([0, 1, 33]), function (q, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }), (n.computeDefaultDocumentColors = void 0)
      function A(a) {
        const u = []
        for (const c of a) {
          const m = Number(c)
      ...
      function p(a, u, c) {
        ...
        const f = u[0].values(),
          y = A(f)
        return { range: a, color: i(y[0], y[1], y[2], c ? y[3] : 1) }
      }
      function h(a, u, c) {
        if (!a || u.length !== 1) return
        const f = u[0].values(),
          y = A(f),
          w = new M.Color(new M.HSLA(y[0], y[1] / 100, y[2] / 100, c ? y[3] : 1))
        ...
        if (m.length > 0)
          for (const f of m) {
            ...
            if (w === 'rgb') {
              ...
              S = h(d(a, f), o(E, C), !0)
            } else w === '#' && (S = b(d(a, f), w + E))
            S && u.push(S)
          }
        return u
      }
      function e(a) {
        return !a || typeof a.getValue != 'function' || typeof a.positionAt != 'function' ? [] : L(a)
      }
      n.computeDefaultDocumentColors = e
    }),
    Y(X[51], J([0, 1, 27]), function (q, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }), (n.computeLinks = n.LinkComputer = n.StateMachine = void 0)
      class A {
        constructor(a, u, c) {
          const m = new Uint8Array(a * u)
          for (let f = 0, y = a * u; f < y; f++) m[f] = c
      ...
      function h() {
        if (p === null) {
          ...
          const e = ` 	<>'"\u3001\u3002\uFF61\uFF64\uFF0C\uFF0E\uFF1A\uFF1B\u2018\u3008\u300C\u300E\u3014\uFF08\uFF3B\uFF5B\uFF62\uFF63\uFF5D\uFF3D\uFF09\u3015\u300F\u300D\u3009\u2019\uFF40\uFF5E\u2026`
          for (let u = 0; u < e.length; u++) p.set(e.charCodeAt(u), 1)
          const a = '.,;:'
          for (let u = 0; u < a.length; u++) p.set(a.charCodeAt(u), 2)
        }
        return p
      }
      class o {
        static _createLink(a, u, c, m, f) {
          ...
          return {
            range: { startLineNumber: c, startColumn: m + 1, endLineNumber: c, endColumn: y + 2 },
            url: u.substring(m, y + 1),
          }
        }
        static computeLinks(a, u = b()) {
          const c = h(),
            m = []
          for (let f = 1, y = a.getLineCount(); f <= y; f++) {
            ...
            for (; S < E; ) {
              ...
              if (s === 13) {
                ...
                switch (N) {
                  ...
                  case 34:
                  case 96:
                    r === N ? (D = 1) : r === 39 || r === 34 || r === 96 ? (D = 0) : (D = 1)
                    break
                  case 42:
                    D = r === 42 ? 1 : 0
                    break
                ...
                D === 1 && (m.push(o._createLink(c, w, f, C, S)), (R = !0))
              } else if (s === 12) {
                let D
                N === 91 ? ((_ = !0), (D = 0)) : (D = c.get(N)), D === 1 ? (R = !0) : (s = 13)
              } else (s = u.nextState(s, N)), s === 0 && (R = !0)
              R && ((s = 1), (l = !1), (_ = !1), (v = !1), (C = S + 1), (r = N)), S++
            }
            s === 13 && m.push(o._createLink(c, w, f, C, E))
          }
          return m
        }
      }
    ...
    Y(X[52], J([0, 1]), function (q, n) {
      ...
      class M {
        ...
        navigateValueSet(i, d, b, p, h) {
          if (i && d) {
            const o = this.doNavigateValueSet(d, h)
            if (o) return { range: i, value: o }
          }
          if (b && p) {
            const o = this.doNavigateValueSet(p, h)
            if (o) return { range: b, value: o }
          }
          return null
        }
        doNavigateValueSet(i, d) {
          const b = this.numberReplace(i, d)
          return b !== null ? b : this.textReplace(i, d)
        }
        numberReplace(i, d) {
          const b = Math.pow(10, i.length - (i.lastIndexOf('.') + 1))
          let p = Number(i)
          const h = parseFloat(i)
          return !isNaN(p) && !isNaN(h) && p === h
            ? p === 0 && !d
              ? null
              : ((p = Math.floor(p * b)), (p += d ? b : -b), String(p / b))
            : null
        }
        textReplace(i, d) {
          return this.valueSetsReplace(this._defaultValueSet, i, d)
        }
        valueSetsReplace(i, d, b) {
          let p = null
          for (let h = 0, o = i.length; p === null && h < o; h++) p = this.valueSetReplace(i[h], d, b)
          return p
        }
        valueSetReplace(i, d, b) {
          let p = i.indexOf(d)
          return p >= 0 ? ((p += b ? 1 : -1), p < 0 ? (p = i.length - 1) : (p %= i.length), i[p]) : null
        }
      }
      ;(n.BasicInplaceReplace = M), (M.INSTANCE = new M())
    }),
    Y(X[53], J([0, 1, 14]), function (q, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      var i
      ;(function (c) {
        ;(c[(c.Left = 1)] = 'Left'), (c[(c.Center = 2)] = 'Center'), (c[(c.Right = 3)] = 'Right')
      ...
      class p {
        ...
        constructor(m) {
          ;(this._textModelResolvedOptionsBrand = void 0),
            ...
            m.indentSize === 'tabSize'
              ...
              : ((this.indentSize = Math.max(1, m.indentSize | 0)), (this._indentSizeIsTabSize = !1)),
        ...
        equals(m) {
          return (
            ...
            this.trimAutoWhitespace === m.trimAutoWhitespace &&
            (0, M.equals)(this.bracketPairColorizationOptions, m.bracketPairColorizationOptions)
          )
        }
        createChangeEvent(m) {
          return {
      ...
      n.ValidAnnotatedEditOperation = L
      class e {
        constructor(m, f, y) {
          ;(this.regex = m), (this.wordSeparators = f), (this.simpleSearch = y)
        }
      }
      n.SearchData = e
      class a {
        constructor(m, f, y) {
          ;(this.reverseEdits = m), (this.changes = f), (this.trimAutoWhitespaceLineNumbers = y)
        }
      }
    ...
    Y(X[54], J([0, 1, 7, 26]), function (q, n, M, A) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      class i {
        ...
        insertValues(h, o) {
          ...
          return a === 0
            ...
            : ((this.values = new Uint32Array(L.length + a)),
              ...
              this.values.set(L.subarray(h), h + a),
              this.values.set(o, h),
              h - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = h - 1),
              (this.prefixSum = new Uint32Array(this.values.length)),
              this.prefixSumValidIndex[0] >= 0 && this.prefixSum.set(e.subarray(0, this.prefixSumValidIndex[0] + 1)),
              !0)
        }
        setValue(h, o) {
          return (
            ...
            this.values[h] === o
              ? !1
              : ((this.values[h] = o), h - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = h - 1), !0)
          )
        }
        removeValues(h, o) {
          ...
          return (
            ...
            o === 0
              ? !1
              : ((this.values = new Uint32Array(L.length - o)),
                this.values.set(L.subarray(0, h), 0),
                this.values.set(L.subarray(h + o), h),
                (this.prefixSum = new Uint32Array(this.values.length)),
                h - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = h - 1),
                this.prefixSumValidIndex[0] >= 0 && this.prefixSum.set(e.subarray(0, this.prefixSumValidIndex[0] + 1)),
                !0)
        ...
        _getPrefixSum(h) {
          ...
          for (let L = o; L <= h; L++) this.prefixSum[L] = this.prefixSum[L - 1] + this.values[L]
        ...
        getIndexOf(h) {
          ...
          let o = 0,
            ...
            u = 0
          for (; o <= L; )
            if (((e = (o + (L - o) / 2) | 0), (a = this.prefixSum[e]), (u = a - this.values[e]), h < u)) L = e - 1
            else if (h >= a) o = e + 1
            else break
          return new b(e, h - u)
        }
        ...
        _ensureValid() {
          if (!this._isValid) {
            for (let h = this._validEndIndex + 1, o = this._values.length; h < o; h++) {
              const L = this._values[h],
                e = h > 0 ? this._prefixSum[h - 1] : 0
              this._prefixSum[h] = e + L
              for (let a = 0; a < L; a++) this._indexBySum[e + a] = h
            }
      ...
      n.PrefixSumIndexOfResult = b
    }),
    Y(X[55], J([0, 1, 6, 4, 54]), function (q, n, M, A, i) {
      'use strict'
      ...
      class d {
        ...
        onEvents(p) {
          ...
          for (const o of h)
            this._acceptDeleteRange(o.range),
              this._acceptInsertText(new A.Position(o.range.startLineNumber, o.range.startColumn), o.text)
        ...
        _ensureLineStarts() {
          if (!this._lineStarts) {
            const p = this._eol.length,
              ...
              o = new Uint32Array(h)
            for (let L = 0; L < h; L++) o[L] = this._lines[L].length + p
            this._lineStarts = new i.PrefixSumComputer(o)
          }
        }
        _setLineText(p, h) {
          ;(this._lines[p] = h),
            this._lineStarts && this._lineStarts.setValue(p, this._lines[p].length + this._eol.length)
        }
        _acceptDeleteRange(p) {
          ...
          this._setLineText(
            ...
            this._lineStarts && this._lineStarts.removeValues(p.startLineNumber, p.endLineNumber - p.startLineNumber)
        }
        _acceptInsertText(p, h) {
          ...
          ;(o[o.length - 1] += this._lines[p.lineNumber - 1].substring(p.column - 1)),
            this._setLineText(p.lineNumber - 1, this._lines[p.lineNumber - 1].substring(0, p.column - 1) + o[0])
          const L = new Uint32Array(o.length - 1)
          for (let e = 1; e < o.length; e++)
            this._lines.splice(p.lineNumber + e - 1, 0, o[e]), (L[e - 1] = o[e].length + this._eol.length)
          this._lineStarts && this._lineStarts.insertValues(p.lineNumber, L)
        }
      }
      n.MirrorTextModel = d
    }),
    Y(X[56], J([0, 1, 6, 42, 4, 2, 53]), function (q, n, M, A, i, d, b) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.Searcher =
          n.isValidMatch =
...
`) >= 0)
          ...
          return (
            S && this.searchString.toLowerCase() !== this.searchString.toUpperCase() && (S = this.matchCase),
            new b.SearchData(
              E,
              this.wordSeparators ? (0, A.getMapForWordSeparators)(this.wordSeparators) : null,
      ...
      function L(y, w, E) {
        if (!E) return new b.FindMatch(y, null)
        const S = []
        for (let C = 0, r = w.length; C < r; C++) S[C] = w[C]
        return new b.FindMatch(y, S)
      }
      n.createFindMatch = L
      class e {
        constructor(w) {
      ...
      class a {
        static findMatches(w, E, S, C, r) {
          ...
          return s
            ? s.regex.multiline
              ? this._doFindMatchesMultiline(w, S, new f(s.wordSeparators, s.regex), C, r)
              : this._doFindMatchesLineByLine(w, S, s, C, r)
            : []
        }
        static _getMultilineMatchRange(w, E, S, C, r, s) {
          let l,
            _ = 0
          C ? ((_ = C.findLineFeedCountBeforeOffset(r)), (l = E + r + _)) : (l = E + r)
          let g
          if (C) {
            const D = C.findLineFeedCountBeforeOffset(r + s.length) - _
            g = l + s.length + D
          } else g = l + s.length
...
`
          ...
          for (S.reset(0); (R = S.next(l)); )
            if (((g[v++] = L(this._getMultilineMatchRange(w, s, l, _, R.index, R[0]), R, C)), v >= r)) return g
          return g
        }
        static _doFindMatchesLineByLine(w, E, S, C, r) {
          ...
          if (E.startLineNumber === E.endLineNumber) {
            const g = w.getLineContent(E.startLineNumber).substring(E.startColumn - 1, E.endColumn - 1)
            return (l = this._findMatchesInLine(S, g, E.startLineNumber, E.startColumn - 1, l, s, C, r)), s
          }
          const _ = w.getLineContent(E.startLineNumber).substring(E.startColumn - 1)
          l = this._findMatchesInLine(S, _, E.startLineNumber, E.startColumn - 1, l, s, C, r)
          for (let g = E.startLineNumber + 1; g < E.endLineNumber && l < r; g++)
            l = this._findMatchesInLine(S, w.getLineContent(g), g, 0, l, s, C, r)
          if (l < r) {
            const g = w.getLineContent(E.endLineNumber).substring(0, E.endColumn - 1)
            l = this._findMatchesInLine(S, g, E.endLineNumber, 0, l, s, C, r)
          }
          return s
        }
        static _findMatchesInLine(w, E, S, C, r, s, l, _) {
          const g = w.wordSeparators
          if (!l && w.simpleSearch) {
            ...
            for (; (T = E.indexOf(N, T + D)) !== -1; )
              if (
                (!g || m(g, E, x, T, D)) &&
                ((s[r++] = new b.FindMatch(new d.Range(S, T + 1 + C, S, T + 1 + D + C), null)), r >= _)
              )
                return r
            return r
          }
          ...
          do
            if (
              ((R = v.next(E)),
              R && ((s[r++] = L(new d.Range(S, R.index + 1 + C, S, R.index + 1 + R[0].length + C), R, l)), r >= _))
            )
              return r
          while (R)
          return r
        ...
        static findNextMatch(w, E, S, C) {
          ...
          return r.regex.multiline
            ? this._doFindNextMatchMultiline(w, S, s, C)
            : this._doFindNextMatchLineByLine(w, S, s, C)
        }
        static _doFindNextMatchMultiline(w, E, S, C) {
          const r = new i.Position(E.lineNumber, 1),
            s = w.getOffsetAt(r),
            l = w.getLineCount(),
            _ = w.getValueInRange(new d.Range(r.lineNumber, r.column, l, w.getLineMaxColumn(l)), 1),
            g =
              w.getEOL() ===
              `\r
`
          ...
          const v = S.next(_)
          return v
            ? L(this._getMultilineMatchRange(w, s, _, g, v.index, v[0]), v, C)
            : E.lineNumber !== 1 || E.column !== 1
              ? this._doFindNextMatchMultiline(w, new i.Position(1, 1), S, C)
              : null
        }
        static _doFindNextMatchLineByLine(w, E, S, C) {
          const r = w.getLineCount(),
            ...
            _ = this._findFirstMatchInLine(S, l, s, E.column, C)
          if (_) return _
          for (let g = 1; g <= r; g++) {
            const v = (s + g - 1) % r,
              R = w.getLineContent(v + 1),
              N = this._findFirstMatchInLine(S, R, v + 1, 1, C)
            if (N) return N
          }
          return null
        }
        static _findFirstMatchInLine(w, E, S, C, r) {
          w.reset(C - 1)
          const s = w.next(E)
          return s ? L(new d.Range(S, s.index + 1, S, s.index + 1 + s[0].length), s, r) : null
        }
        static findPreviousMatch(w, E, S, C) {
          ...
          const s = new f(r.wordSeparators, r.regex)
          return r.regex.multiline
            ? this._doFindPreviousMatchMultiline(w, S, s, C)
            : this._doFindPreviousMatchLineByLine(w, S, s, C)
        }
        static _doFindPreviousMatchMultiline(w, E, S, C) {
          ...
          return E.lineNumber !== s || E.column !== w.getLineMaxColumn(s)
            ? this._doFindPreviousMatchMultiline(w, new i.Position(s, w.getLineMaxColumn(s)), S, C)
            : null
        }
        static _doFindPreviousMatchLineByLine(w, E, S, C) {
          const r = w.getLineCount(),
            ...
            _ = this._findLastMatchInLine(S, l, s, C)
          if (_) return _
          for (let g = 1; g <= r; g++) {
            const v = (r + s - g - 1) % r,
              R = w.getLineContent(v + 1),
              N = this._findLastMatchInLine(S, R, v + 1, C)
            if (N) return N
          }
          return null
        }
        static _findLastMatchInLine(w, E, S, C) {
          let r = null,
            s
          for (w.reset(0); (s = w.next(E)); ) r = L(new d.Range(S, s.index + 1, S, s.index + 1 + s[0].length), s, C)
          return r
        }
      }
      n.TextModelSearch = a
      function u(y, w, E, S, C) {
        ...
        if (C > 0) {
          const s = w.charCodeAt(S)
          if (y.get(s) !== 0) return !0
        }
        return !1
      }
      function c(y, w, E, S, C) {
        if (S + C === E) return !0
        const r = w.charCodeAt(S + C)
        if (y.get(r) !== 0 || r === 13 || r === 10) return !0
        if (C > 0) {
          const s = w.charCodeAt(S + C - 1)
          if (y.get(s) !== 0) return !0
        }
        return !1
      }
      function m(y, w, E, S, C) {
        return u(y, w, E, S, C) && c(y, w, E, S, C)
      }
      n.isValidMatch = m
      class f {
        constructor(w, E) {
        ...
        next(w) {
          ...
          let S
          do {
            if (this._prevMatchStartIndex + this._prevMatchLength === E || ((S = this._searchRegex.exec(w)), !S))
              return null
            const C = S.index,
              r = S[0].length
            ...
            if (
              ...
              !this._wordSeparators || m(this._wordSeparators, w, E, C, r))
            )
              return S
          } while (S)
          return null
    ...
    Y(X[57], J([0, 1, 2, 56, 6, 12, 28]), function (q, n, M, A, i, d, b) {
      'use strict'
          ...
          e: for (let v = m, R = f; v <= R; v++) {
            ...
            do
              if (((s = S.next(N)), s)) {
                ...
                let B = (0, b.getWordAtText)(x + 1, b.DEFAULT_WORD_REGEXP, N, 0)
                B && B.endColumn <= x + 1 && (B = null)
                const V = y.shouldHighlightNonBasicASCII(F, B ? B.word : null)
                if (V !== 0) {
                  V === 3 ? l++ : V === 2 ? _++ : V === 1 ? g++ : (0, d.assertNever)(V)
                  const k = 1e3
                  if (C.length >= k) {
                    r = !0
                    break e
                  }
                  C.push(new M.Range(v, x + 1, v, T + 1))
                }
              }
            while (s)
          }
          ...
          switch (c.shouldHighlightNonBasicASCII(a, null)) {
            ...
            case 3: {
              const f = a.codePointAt(0),
                y = c.ambiguousCharacters.getPrimaryConfusable(f),
                w = i.AmbiguousCharacters.getLocales().filter(
                  E => !i.AmbiguousCharacters.getInstance(new Set([...u.allowedLocales, E])).isAmbiguous(f),
                )
              return { kind: 0, confusableWith: String.fromCodePoint(y), notAmbiguousInLocales: w }
            }
            case 1:
              return { kind: 2 }
          }
      ...
      class o {
        constructor(a) {
          ;(this.options = a),
            ...
            (this.ambiguousCharacters = i.AmbiguousCharacters.getInstance(new Set(a.allowedLocales)))
        }
        getCandidateCodePoints() {
          if (this.options.nonBasicASCII) return 'allNonBasicAscii'
          const a = new Set()
          if (this.options.invisibleCharacters)
            for (const u of i.InvisibleCharacters.codePoints) L(String.fromCodePoint(u)) || a.add(u)
        ...
        shouldHighlightNonBasicASCII(a, u) {
          ...
          return !m && f
            ? 0
            : this.options.invisibleCharacters && !L(a) && i.InvisibleCharacters.isInvisibleCharacter(c)
              ? 2
              : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(c)
                ? 3
                : 0
        }
      }
...
` ||
    ...
    Y(X[58], J([0, 1]), function (q, n) {
      ...
      ;(function (t) {
        ;(t[(t.acceptSuggestionOnCommitCharacter = 0)] = 'acceptSuggestionOnCommitCharacter'),
          ...
          (t[(t.screenReaderAnnounceInlineSuggestion = 8)] = 'screenReaderAnnounceInlineSuggestion'),
          ...
          (t[(t.inlineCompletionsAccessibilityVerbose = 147)] = 'inlineCompletionsAccessibilityVerbose')
      })(u || (n.EditorOption = u = {}))
      var c
      ;(function (t) {
      ...
      })(G || (n.WrappingIndent = G = {}))
    }),
    Y(X[59], J([0, 1, 9, 13]), function (q, n, M, A) {
      'use strict'
      ...
      class i {
        ...
        register(p, h) {
          return (
            ...
            this.handleChange([p]),
            (0, A.toDisposable)(() => {
              this._tokenizationSupports.get(p) === h && (this._tokenizationSupports.delete(p), this.handleChange([p]))
            })
          )
        }
        get(p) {
        ...
        registerFactory(p, h) {
          ...
          const L = new d(this, p, h)
          return (
            this._factories.set(p, L),
            (0, A.toDisposable)(() => {
    ...
    Y(X[60], J([19, 61]), function (q, n) {
      return q.create('vs/base/common/platform', n)
    }),
    Y(X[17], J([0, 1, 60]), function (q, n, M) {
      'use strict'
      var A
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.isAndroid =
      ...
      const C = typeof ((A = S?.versions) === null || A === void 0 ? void 0 : A.electron) == 'string',
        r = C && S?.type === 'renderer'
      if (typeof S == 'object') {
        ;(i = S.platform === 'win32'),
          (d = S.platform === 'darwin'),
          (b = S.platform === 'linux'),
          (p = b && !!S.env.SNAP && !!S.env.SNAP_REVISION),
          (L = C),
          (a = !!S.env.CI || !!S.env.BUILD_ARTIFACTSTAGINGDIRECTORY),
        ...
        typeof navigator == 'object' && !r
          ? ((w = navigator.userAgent),
            (i = w.indexOf('Windows') >= 0),
            (d = w.indexOf('Macintosh') >= 0),
            (e =
              (w.indexOf('Macintosh') >= 0 || w.indexOf('iPad') >= 0 || w.indexOf('iPhone') >= 0) &&
      ...
      d ? (s = 1) : i ? (s = 3) : b && (s = 2),
        ...
        (n.setTimeout0 = (() => {
          if (n.setTimeout0IsFaster) {
            ...
            return N => {
              const D = ++R
              v.push({ id: D, callback: N }), E.postMessage({ vscodeScheduleAsyncWork: D }, '*')
            }
          }
    ...
    Y(X[62], J([0, 1, 17]), function (q, n, M) {
      'use strict'
    ...
    Y(X[63], J([0, 1, 62]), function (q, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.sep = n.extname = n.basename = n.dirname = n.relative = n.resolve = n.normalize = n.posix = n.win32 = void 0)
      const A = 65,
        i = 97,
        d = 90,
        b = 122,
      ...
      class a extends Error {
        constructor(s, l, _) {
          ...
          typeof l == 'string' && l.indexOf('not ') === 0
            ? ((g = 'must not be'), (l = l.replace(/^not /, '')))
            : (g = 'must be')
          const v = s.indexOf('.') !== -1 ? 'property' : 'argument'
          let R = `The "${s}" ${v} ${g} of type ${l}`
          ;(R += `. Received type ${typeof _}`), super(R), (this.code = 'ERR_INVALID_ARG_TYPE')
        }
      }
      function u(r, s) {
      ...
      function E(r, s, l, _) {
        ...
        for (let x = 0; x <= r.length; ++x) {
          ...
          if (_(D)) {
            if (!(R === x - 1 || N === 1))
              if (N === 2) {
                if (g.length < 2 || v !== 2 || g.charCodeAt(g.length - 1) !== p || g.charCodeAt(g.length - 2) !== p) {
                  if (g.length > 2) {
                    const T = g.lastIndexOf(l)
                    T === -1 ? ((g = ''), (v = 0)) : ((g = g.slice(0, T)), (v = g.length - 1 - g.lastIndexOf(l))),
                      (R = x),
                      (N = 0)
                    continue
                  } else if (g.length !== 0) {
                ...
                s && ((g += g.length > 0 ? `${l}..` : '..'), (v = 2))
              } else g.length > 0 ? (g += `${l}${r.slice(R + 1, x)}`) : (g = r.slice(R + 1, x)), (v = x - R - 1)
            ;(R = x), (N = 0)
          } else D === p && N !== -1 ? ++N : (N = -1)
        }
        return g
      ...
      function S(r, s) {
        ...
        const l = s.dir || s.root,
          _ = s.base || `${s.name || ''}${s.ext || ''}`
        return l ? (l === s.root ? `${l}${_}` : `${l}${r}${_}`) : _
      }
      n.win32 = {
        resolve(...r) {
          let s = '',
            l = '',
            _ = !1
          for (let g = r.length - 1; g >= -1; g--) {
            let v
            if (g >= 0) {
              if (((v = r[g]), c(v, 'path'), v.length === 0)) continue
            } else
              s.length === 0
                ? (v = M.cwd())
                : ((v = M.env[`=${s}`] || M.cwd()),
                  (v === void 0 || (v.slice(0, 2).toLowerCase() !== s.toLowerCase() && v.charCodeAt(2) === o)) &&
                    (v = `${s}\\`))
            const R = v.length
            let N = 0,
              D = '',
            ...
            if (R === 1) f(T) && ((N = 1), (x = !0))
              ...
              if (((x = !0), f(v.charCodeAt(1)))) {
                ...
                if (F < R && F !== B) {
                  const V = v.slice(B, F)
                  for (B = F; F < R && f(v.charCodeAt(F)); ) F++
                  if (F < R && F !== B) {
                    for (B = F; F < R && !f(v.charCodeAt(F)); ) F++
                    ;(F === R || F !== B) && ((D = `\\\\${V}\\${v.slice(B, F)}`), (N = F))
                  }
                }
              } else N = 1
            else
              w(T) &&
                v.charCodeAt(1) === L &&
                ((D = v.slice(0, 2)), (N = 2), R > 2 && f(v.charCodeAt(2)) && ((x = !0), (N = 3)))
            if (D.length > 0)
              if (s.length > 0) {
            ...
            if (_) {
              if (s.length > 0) break
            } else if (((l = `${v.slice(N)}\\${l}`), (_ = x), x && s.length > 0)) break
          }
          return (l = E(l, !_, '\\', f)), _ ? `${s}\\${l}` : `${s}${l}` || '.'
        },
        normalize(r) {
          c(r, 'path')
          const s = r.length
          ...
          if (f(v))
            ...
            w(v) &&
              r.charCodeAt(1) === L &&
              ((_ = r.slice(0, 2)), (l = 2), s > 2 && f(r.charCodeAt(2)) && ((g = !0), (l = 3)))
          let R = l < s ? E(r.slice(l), !g, '\\', f) : ''
          return (
            R.length === 0 && !g && (R = '.'),
            R.length > 0 && f(r.charCodeAt(s - 1)) && (R += '\\'),
            _ === void 0 ? (g ? `\\${R}` : R) : g ? `${_}\\${R}` : `${_}${R}`
          )
        },
        isAbsolute(r) {
          c(r, 'path')
          ...
          return f(l) || (s > 2 && w(l) && r.charCodeAt(1) === L && f(r.charCodeAt(2)))
        },
        join(...r) {
          ...
          if (typeof l == 'string' && f(l.charCodeAt(0))) {
            ++g
            const v = l.length
            v > 1 && f(l.charCodeAt(1)) && (++g, v > 2 && (f(l.charCodeAt(2)) ? ++g : (_ = !1)))
          }
          if (_) {
            for (; g < s.length && f(s.charCodeAt(g)); ) g++
            g >= 2 && (s = `\\${s.slice(g)}`)
          }
        ...
        relative(r, s) {
          ...
          const l = n.win32.resolve(r),
            _ = n.win32.resolve(s)
          if (l === _ || ((r = l.toLowerCase()), (s = _.toLowerCase()), r === s)) return ''
          let g = 0
          for (; g < r.length && r.charCodeAt(g) === o; ) g++
          let v = r.length
          for (; v - 1 > g && r.charCodeAt(v - 1) === o; ) v--
          const R = v - g
          let N = 0
          ...
          let F = -1,
            B = 0
          for (; B < T; B++) {
            const k = r.charCodeAt(g + B)
            if (k !== s.charCodeAt(N + B)) break
            k === o && (F = B)
          }
          if (B !== T) {
            if (F === -1) return _
            ...
            if (x > T) {
              if (s.charCodeAt(N + B) === o) return _.slice(N + B + 1)
              if (B === 2) return _.slice(N + B)
            }
            R > T && (r.charCodeAt(g + B) === o ? (F = B) : B === 2 && (F = 3)), F === -1 && (F = 0)
          }
          let V = ''
          for (B = g + F + 1; B <= v; ++B) (B === v || r.charCodeAt(B) === o) && (V += V.length === 0 ? '..' : '\\..')
          return (N += F), V.length > 0 ? `${V}${_.slice(N, D)}` : (_.charCodeAt(N) === o && ++N, _.slice(N, D))
        },
        toNamespacedPath(r) {
          ...
          if (s.charCodeAt(0) === o) {
            if (s.charCodeAt(1) === o) {
              ...
              if (l !== e && l !== p) return `\\\\?\\UNC\\${s.slice(2)}`
            }
          } else if (w(s.charCodeAt(0)) && s.charCodeAt(1) === L && s.charCodeAt(2) === o) return `\\\\?\\${s}`
          return r
        },
        dirname(r) {
          c(r, 'path')
          ...
          } else w(g) && r.charCodeAt(1) === L && ((l = s > 2 && f(r.charCodeAt(2)) ? 3 : 2), (_ = l))
          let v = -1,
            R = !0
          for (let N = s - 1; N >= _; --N)
            if (f(r.charCodeAt(N))) {
        ...
        basename(r, s) {
          ...
          let l = 0,
            ...
            v
          if (
            (r.length >= 2 && w(r.charCodeAt(0)) && r.charCodeAt(1) === L && (l = 2),
            ...
            for (v = r.length - 1; v >= l; --v) {
              ...
              if (f(D)) {
                ...
                N === -1 && ((g = !1), (N = v + 1)),
                  R >= 0 && (D === s.charCodeAt(R) ? --R === -1 && (_ = v) : ((R = -1), (_ = N)))
            }
            return l === _ ? (_ = N) : _ === -1 && (_ = r.length), r.slice(l, _)
          }
          for (v = r.length - 1; v >= l; --v)
            if (f(r.charCodeAt(v))) {
              if (!g) {
        ...
        extname(r) {
          ...
          let s = 0,
            ...
            v = !0,
            R = 0
          r.length >= 2 && r.charCodeAt(1) === L && w(r.charCodeAt(0)) && (s = _ = 2)
          for (let N = r.length - 1; N >= s; --N) {
            ...
            g === -1 && ((v = !1), (g = N + 1)),
              D === p ? (l === -1 ? (l = N) : R !== 1 && (R = 1)) : l !== -1 && (R = -1)
          }
          return l === -1 || g === -1 || R === 0 || (R === 1 && l === g - 1 && l === _ + 1) ? '' : r.slice(l, g)
        },
        format: S.bind(null, '\\'),
        parse(r) {
          c(r, 'path')
          ...
          let _ = 0,
            g = r.charCodeAt(0)
          if (l === 1) return f(g) ? ((s.root = s.dir = r), s) : ((s.base = s.name = r), s)
          if (f(g)) {
            if (((_ = 1), f(r.charCodeAt(1)))) {
              let F = 2,
                B = F
              for (; F < l && !f(r.charCodeAt(F)); ) F++
              if (F < l && F !== B) {
                for (B = F; F < l && f(r.charCodeAt(F)); ) F++
                if (F < l && F !== B) {
                  for (B = F; F < l && !f(r.charCodeAt(F)); ) F++
                  F === l ? (_ = F) : F !== B && (_ = F + 1)
                }
          ...
          } else if (w(g) && r.charCodeAt(1) === L) {
            if (l <= 2) return (s.root = s.dir = r), s
            if (((_ = 2), f(r.charCodeAt(2)))) {
              if (l === 3) return (s.root = s.dir = r), s
              _ = 3
            }
          }
          _ > 0 && (s.root = r.slice(0, _))
          let v = -1,
            R = _,
            N = -1,
            D = !0,
          ...
          for (; x >= _; --x) {
            ...
            N === -1 && ((D = !1), (N = x + 1)),
              g === p ? (v === -1 ? (v = x) : T !== 1 && (T = 1)) : v !== -1 && (T = -1)
          }
          return (
            N !== -1 &&
              (v === -1 || T === 0 || (T === 1 && v === N - 1 && v === R + 1)
                ? (s.base = s.name = r.slice(R, N))
                : ((s.name = r.slice(R, v)), (s.base = r.slice(R, N)), (s.ext = r.slice(v, N)))),
            R > 0 && R !== _ ? (s.dir = r.slice(0, R - 1)) : (s.dir = s.root),
            s
          )
        },
        sep: '\\',
      ...
      ;(n.posix = {
        resolve(...r) {
          let s = '',
            l = !1
          for (let _ = r.length - 1; _ >= -1 && !l; _--) {
            const g = _ >= 0 ? r[_] : C()
            c(g, 'path'), g.length !== 0 && ((s = `${g}/${s}`), (l = g.charCodeAt(0) === h))
          }
          return (s = E(s, !l, '/', y)), l ? `/${s}` : s.length > 0 ? s : '.'
        },
        normalize(r) {
          ...
          return (
            (r = E(r, !s, '/', y)), r.length === 0 ? (s ? '/' : l ? './' : '.') : (l && (r += '/'), s ? `/${r}` : r)
          )
        },
        isAbsolute(r) {
        ...
        join(...r) {
          ...
          for (let l = 0; l < r.length; ++l) {
            const _ = r[l]
            c(_, 'path'), _.length > 0 && (s === void 0 ? (s = _) : (s += `/${_}`))
          }
          return s === void 0 ? '.' : n.posix.normalize(s)
        },
        relative(r, s) {
          if ((c(r, 'from'), c(s, 'to'), r === s || ((r = n.posix.resolve(r)), (s = n.posix.resolve(s)), r === s)))
            return ''
          const l = 1,
            _ = r.length,
            g = _ - l,
          ...
          if (x === N)
            ...
            } else g > N && (r.charCodeAt(l + x) === h ? (D = x) : x === 0 && (D = 0))
          let T = ''
          for (x = l + D + 1; x <= _; ++x) (x === _ || r.charCodeAt(x) === h) && (T += T.length === 0 ? '..' : '/..')
        ...
        extname(r) {
          ...
          for (let R = r.length - 1; R >= 0; --R) {
            ...
            _ === -1 && ((g = !1), (_ = R + 1)),
              N === p ? (s === -1 ? (s = R) : v !== 1 && (v = 1)) : s !== -1 && (v = -1)
          }
          return s === -1 || _ === -1 || v === 0 || (v === 1 && s === _ - 1 && s === l + 1) ? '' : r.slice(s, _)
        },
        format: S.bind(null, '/'),
        parse(r) {
          c(r, 'path')
          ...
          for (; D >= _; --D) {
            ...
            R === -1 && ((N = !1), (R = D + 1)),
              T === p ? (g === -1 ? (g = D) : x !== 1 && (x = 1)) : g !== -1 && (x = -1)
          }
          if (R !== -1) {
            const T = v === 0 && l ? 1 : v
            g === -1 || x === 0 || (x === 1 && g === R - 1 && g === v + 1)
              ? (s.base = s.name = r.slice(T, R))
              : ((s.name = r.slice(T, g)), (s.base = r.slice(T, R)), (s.ext = r.slice(g, R)))
          }
    ...
    Y(X[18], J([0, 1, 63, 17]), function (q, n, M, A) {
      'use strict'
      ...
      function p(l, _) {
        ...
        if (l.scheme && !i.test(l.scheme)) throw new Error('[UriError]: Scheme contains illegal characters.')
        if (l.path) {
          if (l.authority) {
            if (!d.test(l.path))
              throw new Error(
      ...
      class u {
        ...
        constructor(_, g, v, R, N, D = !1) {
          typeof _ == 'object'
            ? ((this.scheme = _.scheme || L),
              (this.authority = _.authority || L),
              (this.path = _.path || L),
              (this.query = _.query || L),
              (this.fragment = _.fragment || L))
            : ((this.scheme = h(_, D)),
              (this.authority = g || L),
              (this.path = o(this.scheme, v || L)),
              (this.query = R || L),
              (this.fragment = N || L),
              p(this, D))
        }
        ...
        with(_) {
          if (!_) return this
          let { scheme: g, authority: v, path: R, query: N, fragment: D } = _
          return (
            g === void 0 ? (g = this.scheme) : g === null && (g = L),
            v === void 0 ? (v = this.authority) : v === null && (v = L),
            R === void 0 ? (R = this.path) : R === null && (R = L),
            N === void 0 ? (N = this.query) : N === null && (N = L),
            D === void 0 ? (D = this.fragment) : D === null && (D = L),
            g === this.scheme && v === this.authority && R === this.path && N === this.query && D === this.fragment
              ? this
              : new m(g, v, R, N, D)
          )
        }
        static parse(_, g = !1) {
          const v = a.exec(_)
          return v ? new m(v[2] || L, s(v[4] || L), s(v[5] || L), s(v[7] || L), s(v[9] || L), g) : new m(L, L, L, L, L)
        }
        static file(_) {
          let g = L
          if ((A.isWindows && (_ = _.replace(/\\/g, e)), _[0] === e && _[1] === e)) {
            const v = _.indexOf(e, 2)
            v === -1 ? ((g = _.substring(2)), (_ = e)) : ((g = _.substring(2, v)), (_ = _.substring(v) || e))
          }
          return new m('file', g, _, L, L)
        }
        static from(_, g) {
          return new m(_.scheme, _.authority, _.path, _.query, _.fragment, g)
        }
        static joinPath(_, ...g) {
          if (!_.path) throw new Error('[UriError]: cannot call joinPath on URI without path')
          let v
          return (
            A.isWindows && _.scheme === 'file'
              ? (v = u.file(M.win32.join(E(_, !0), ...g)).path)
              : (v = M.posix.join(_.path, ...g)),
            _.with({ path: v })
          )
        }
        toString(_ = !1) {
        ...
        static revive(_) {
          var g, v
          if (_) {
            if (_ instanceof u) return _
            {
              const R = new m(_)
              return (
                (R._formatted = (g = _.external) !== null && g !== void 0 ? g : null),
                (R._fsPath = _._sep === c && (v = _.fsPath) !== null && v !== void 0 ? v : null),
                R
              )
            }
          } else return _
      ...
      class m extends u {
        ...
        toString(_ = !1) {
          return _ ? S(this, !0) : (this._formatted || (this._formatted = S(this, !1)), this._formatted)
        }
        toJSON() {
          const _ = { $mid: 1 }
          return (
            this._fsPath && ((_.fsPath = this._fsPath), (_._sep = c)),
      ...
      function y(l, _, g) {
        ...
        for (let N = 0; N < l.length; N++) {
          ...
          if (
            ...
            R !== -1 && ((v += encodeURIComponent(l.substring(R, N))), (R = -1)), v !== void 0 && (v += l.charAt(N))
          else {
            v === void 0 && (v = l.substr(0, N))
            const x = f[D]
            x !== void 0
              ? (R !== -1 && ((v += encodeURIComponent(l.substring(R, N))), (R = -1)), (v += x))
              : R === -1 && (R = N)
          }
        }
      ...
      function w(l) {
        ...
        for (let g = 0; g < l.length; g++) {
          ...
          v === 35 || v === 63 ? (_ === void 0 && (_ = l.substr(0, g)), (_ += f[v])) : _ !== void 0 && (_ += l[g])
        }
        return _ !== void 0 ? _ : l
      }
      function E(l, _) {
        ...
        return (
          l.authority && l.path.length > 1 && l.scheme === 'file'
            ...
            : l.path.charCodeAt(0) === 47 &&
              ...
              ? _
                ? (g = l.path.substr(1))
                : (g = l.path[1].toLowerCase() + l.path.substr(2))
              : (g = l.path),
          A.isWindows && (g = g.replace(/\//g, '\\')),
          g
        )
      }
      n.uriToFsPath = E
      function S(l, _) {
        ...
        if ((R && ((v += R), (v += ':')), (N || R === 'file') && ((v += e), (v += e)), N)) {
          let F = N.indexOf('@')
          if (F !== -1) {
            const B = N.substr(0, F)
            ;(N = N.substr(F + 1)),
              (F = B.lastIndexOf(':')),
              F === -1
                ? (v += g(B, !1, !1))
                : ((v += g(B.substr(0, F), !1, !1)), (v += ':'), (v += g(B.substr(F + 1), !1, !0))),
              (v += '@')
          }
          ;(N = N.toLowerCase()),
            (F = N.lastIndexOf(':')),
            F === -1 ? (v += g(N, !1, !0)) : ((v += g(N.substr(0, F), !1, !0)), (v += N.substr(F)))
        }
        if (D) {
        ...
        return x && ((v += '?'), (v += g(x, !1, !1))), T && ((v += '#'), (v += _ ? T : y(T, !1, !1))), v
      }
      function C(l) {
        try {
          return decodeURIComponent(l)
        } catch {
          return l.length > 3 ? l.substr(0, 3) + C(l.substr(3)) : l
        }
      }
      const r = /(%[0-9A-Za-z][0-9A-Za-z])+/g
      function s(l) {
        return l.match(r) ? l.replace(r, _ => C(_)) : l
      }
    }),
    Y(X[67], J([0, 1, 5, 9, 13, 14, 17, 6]), function (q, n, M, A, i, d, b, p) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.create = n.SimpleWorkerServer = n.SimpleWorkerClient = n.logOnceWebWorkerWarning = void 0)
      const h = '$initialize'
      let o = !1
      function L(s) {
        b.isWeb &&
      ...
      n.logOnceWebWorkerWarning = L
      class e {
        constructor(l, _, g, v) {
          ;(this.vsWorker = l), (this.req = _), (this.method = g), (this.args = v), (this.type = 0)
        }
      }
      class a {
        constructor(l, _, g, v) {
          ;(this.vsWorker = l), (this.seq = _), (this.res = g), (this.err = v), (this.type = 1)
        }
      }
      class u {
        constructor(l, _, g, v) {
          ;(this.vsWorker = l), (this.req = _), (this.eventName = g), (this.arg = v), (this.type = 2)
        }
      }
      class c {
        constructor(l, _, g) {
          ;(this.vsWorker = l), (this.req = _), (this.event = g), (this.type = 3)
        }
      }
      class m {
        constructor(l, _) {
          ;(this.vsWorker = l), (this.req = _), (this.type = 4)
        }
      }
      class f {
        constructor(l) {
        ...
        sendMessage(l, _) {
          const g = String(++this._lastSentReq)
          return new Promise((v, R) => {
            ;(this._pendingReplies[g] = { resolve: v, reject: R }), this._send(new e(this._workerId, g, l, _))
          })
        }
        listen(l, _) {
          let g = null
          const v = new A.Emitter({
            onWillAddFirstListener: () => {
              ;(g = String(++this._lastSentReq)),
                this._pendingEmitters.set(g, v),
                this._send(new u(this._workerId, g, l, _))
            },
            onDidRemoveLastListener: () => {
              this._pendingEmitters.delete(g), this._send(new m(this._workerId, g)), (g = null)
            },
          })
          return v.event
        }
        handleMessage(l) {
          !l || !l.vsWorker || (this._workerId !== -1 && l.vsWorker !== this._workerId) || this._handleMessage(l)
        }
        _handleMessage(l) {
          switch (l.type) {
            case 1:
        ...
        _handleReplyMessage(l) {
          ...
          const _ = this._pendingReplies[l.seq]
          if ((delete this._pendingReplies[l.seq], l.err)) {
            let g = l.err
            l.err.$isError &&
              ((g = new Error()), (g.name = l.err.name), (g.message = l.err.message), (g.stack = l.err.stack)),
              _.reject(g)
            return
          }
          _.resolve(l.res)
        ...
        _handleRequestMessage(l) {
          ...
          this._handler.handleMessage(l.method, l.args).then(
            v => {
              this._send(new a(this._workerId, _, v, void 0))
            },
            v => {
              v.detail instanceof Error && (v.detail = (0, M.transformErrorForSerialization)(v.detail)),
                this._send(new a(this._workerId, _, void 0, (0, M.transformErrorForSerialization)(v)))
            },
          )
        }
        _handleSubscribeEventMessage(l) {
          const _ = l.req,
            g = this._handler.handleEvent(
              l.eventName,
              l.arg,
            )(v => {
              this._send(new c(this._workerId, _, v))
            })
          this._pendingEvents.set(_, g)
        }
        ...
        _send(l) {
          const _ = []
          if (l.type === 0)
            for (let g = 0; g < l.args.length; g++) l.args[g] instanceof ArrayBuffer && _.push(l.args[g])
          else l.type === 1 && l.res instanceof ArrayBuffer && _.push(l.res)
          this._handler.sendMessage(l, _)
        }
      }
      class y extends i.Disposable {
        constructor(l, _, g) {
            ...
            (this._protocol = new f({
              ...
              handleMessage: (F, B) => {
                if (typeof g[F] != 'function')
                  return Promise.reject(new Error('Missing method ' + F + ' on main thread host.'))
                try {
                  return Promise.resolve(g[F].apply(g, B))
                } catch (V) {
              ...
              handleEvent: (F, B) => {
                if (E(F)) {
                  const V = g[F].call(g, B)
                  if (typeof V != 'function') throw new Error(`Missing dynamic event ${F} on main thread host.`)
                  return V
                }
                if (w(F)) {
                  const V = g[F]
                  if (typeof V != 'function') throw new Error(`Missing event ${F} on main thread host.`)
                  return V
                }
          ...
          typeof N < 'u' && typeof N.getConfig == 'function'
            ? (R = N.getConfig())
            : typeof globalThis.requirejs < 'u' && (R = globalThis.requirejs.s.contexts._.config)
          const D = (0, d.getAllMethodNames)(g)
          ...
          const x = (F, B) => this._request(F, B),
            T = (F, B) => this._protocol.listen(F, B)
          this._lazyProxy = new Promise((F, B) => {
            ;(v = B),
              this._onModuleLoaded.then(
                ...
                V => {
                  B(V), this._onError('Worker failed to load ' + _, V)
                },
              )
          })
        }
        ...
        _request(l, _) {
          return new Promise((g, v) => {
            this._onModuleLoaded.then(() => {
              this._protocol.sendMessage(l, _).then(g, v)
            }, v)
          })
        }
        _onError(l, _) {
          console.error(l), console.info(_)
        }
      }
      n.SimpleWorkerClient = y
      function w(s) {
        return s[0] === 'o' && s[1] === 'n' && p.isUpperAsciiLetter(s.charCodeAt(2))
      }
      function E(s) {
        return /^onDynamic/.test(s) && p.isUpperAsciiLetter(s.charCodeAt(9))
      }
      function S(s, l, _) {
        const g = N =>
            function () {
      ...
      class C {
        constructor(l, _) {
          ;(this._requestHandlerFactory = _),
            ...
            (this._protocol = new f({
              ...
              handleMessage: (g, v) => this._handleMessage(g, v),
              handleEvent: (g, v) => this._handleEvent(g, v),
            }))
        }
        onmessage(l) {
        ...
        _handleMessage(l, _) {
          if (l === h) return this.initialize(_[0], _[1], _[2], _[3])
          ...
          try {
            return Promise.resolve(this._requestHandler[l].apply(this._requestHandler, _))
          } catch (g) {
        ...
        _handleEvent(l, _) {
          ...
          if (E(l)) {
            const g = this._requestHandler[l].call(this._requestHandler, _)
            if (typeof g != 'function') throw new Error(`Missing dynamic event ${l} on request handler.`)
            return g
          }
          if (w(l)) {
            const g = this._requestHandler[l]
            if (typeof g != 'function') throw new Error(`Missing event ${l} on request handler.`)
            return g
          }
        ...
        initialize(l, _, g, v) {
          ...
          return this._requestHandlerFactory
            ...
            : (_ &&
                (typeof _.baseUrl < 'u' && delete _.baseUrl,
                typeof _.paths < 'u' && typeof _.paths.vs < 'u' && delete _.paths.vs,
                typeof _.trustedTypesPolicy < 'u' && delete _.trustedTypesPolicy,
                (_.catchError = !0),
                globalThis.require.config(_)),
              new Promise((x, T) => {
    ...
    Y(X[64], J([19, 61]), function (q, n) {
      return q.create('vs/editor/common/languages', n)
    }),
    Y(X[65], J([0, 1, 40, 18, 2, 59, 64]), function (q, n, M, A, i, d, b) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      class p {
        constructor(l, _, g) {
          ;(this.offset = l), (this.type = _), (this.language = g), (this._tokenBrand = void 0)
        }
        toString() {
      ...
      class h {
        constructor(l, _) {
          ;(this.tokens = l), (this.endState = _), (this._tokenizationResultBrand = void 0)
        }
      }
      n.TokenizationResult = h
      class o {
        constructor(l, _) {
          ;(this.tokens = l), (this.endState = _), (this._encodedTokenizationResultBrand = void 0)
        }
      }
      ...
      ;(function (s) {
        ...
        function _(R) {
          let N = l.get(R)
          return N || (console.info('No codicon found for CompletionItemKind ' + R), (N = M.Codicon.symbolProperty)), N
        }
        s.toIcon = _
        const g = new Map()
        g.set('method', 0),
      ...
      class a {
        constructor(l, _, g, v) {
          ;(this.range = l), (this.text = _), (this.completionKind = g), (this.isSnippetText = v)
        }
        equals(l) {
          return (
      ...
      function m(s) {
        return (
          ...
          (i.Range.isIRange(s.originSelectionRange) || i.Range.isIRange(s.targetSelectionRange))
        )
      }
      ;(n.isLocationLink = m),
        (n.symbolKindNames = {
          [17]: (0, b.localize)(0, null),
          [16]: (0, b.localize)(1, null),
          [4]: (0, b.localize)(2, null),
          [13]: (0, b.localize)(3, null),
          [8]: (0, b.localize)(4, null),
          [9]: (0, b.localize)(5, null),
          [21]: (0, b.localize)(6, null),
          [23]: (0, b.localize)(7, null),
          [7]: (0, b.localize)(8, null),
          [0]: (0, b.localize)(9, null),
          [11]: (0, b.localize)(10, null),
          [10]: (0, b.localize)(11, null),
          [19]: (0, b.localize)(12, null),
          [5]: (0, b.localize)(13, null),
          [1]: (0, b.localize)(14, null),
          [2]: (0, b.localize)(15, null),
          [20]: (0, b.localize)(16, null),
          [15]: (0, b.localize)(17, null),
          [18]: (0, b.localize)(18, null),
          [24]: (0, b.localize)(19, null),
          [3]: (0, b.localize)(20, null),
          [6]: (0, b.localize)(21, null),
          [14]: (0, b.localize)(22, null),
          [22]: (0, b.localize)(23, null),
          [25]: (0, b.localize)(24, null),
          [12]: (0, b.localize)(25, null),
        })
      function f(s, l) {
        return (0, b.localize)(26, null, s, n.symbolKindNames[l])
      }
      ...
      ;(function (s) {
        ...
        function _(g) {
          let v = l.get(g)
          return v || (console.info('No codicon found for SymbolKind ' + g), (v = M.Codicon.symbolProperty)), v
        }
        s.toIcon = _
      })(y || (n.SymbolKinds = y = {}))
      class w {}
      ...
      ;(function (s) {
        function l(_) {
          return !_ || typeof _ != 'object' ? !1 : typeof _.id == 'string' && typeof _.title == 'string'
        }
        s.is = l
      })(S || (n.Command = S = {}))
      var C
      ...
      class r {
        ...
        get tokenizationSupport() {
          return (
            this._tokenizationSupport || (this._tokenizationSupport = this.createSupport()), this._tokenizationSupport
          )
        }
      }
      ;(n.LazyTokenizationSupport = r), (n.TokenizationRegistry = new d.TokenizationRegistry())
    }),
    Y(X[66], J([0, 1, 38, 9, 35, 18, 4, 2, 41, 65, 58]), function (q, n, M, A, i, d, b, p, h, o, L) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }), (n.createMonacoBaseAPI = n.KeyMod = void 0)
      class e {
        static chord(c, m) {
    ...
    Y(
      X[68],
      J([0, 1, 24, 18, 4, 2, 55, 28, 51, 52, 66, 23, 57, 49, 14, 50]),
      function (q, n, M, A, i, d, b, p, h, o, L, e, a, u, c, m) {
        'use strict'
        Object.defineProperty(n, '__esModule', { value: !0 }), (n.create = n.EditorSimpleWorker = void 0)
        class f extends b.MirrorTextModel {
          get uri() {
            return this._uri
          }
          get eol() {
          ...
          findMatches(S) {
            ...
            for (let r = 0; r < this._lines.length; r++) {
              const s = this._lines[r],
                ...
                _ = s.matchAll(S)
              for (const g of _) (g.index || g.index === 0) && (g.index = g.index + l), C.push(g)
            }
            return C
          }
          getLinesContent() {
          ...
          getWordAtPosition(S, C) {
            const r = (0, p.getWordAtText)(
              S.column,
              (0, p.ensureValidWordDefinition)(C),
          ...
          words(S) {
            ...
            return {
              *[Symbol.iterator]() {
                for (;;)
                  if (_ < g.length) {
                    const v = l.substring(g[_].start, g[_].end)
                    ;(_ += 1), yield v
                  } else if (s < C.length) (l = C[s]), (g = r(l, S)), (_ = 0), (s += 1)
                  else break
              },
            }
          }
          getLineWords(S, C) {
            const r = this._lines[S - 1],
              s = this._wordenize(r, C),
              l = []
            for (const _ of s)
              l.push({ word: r.substring(_.start, _.end), startColumn: _.start + 1, endColumn: _.end + 1 })
            return l
          }
          _wordenize(S, C) {
            const r = []
            let s
            for (C.lastIndex = 0; (s = C.exec(S)) && s[0].length !== 0; )
              r.push({ start: s.index, end: s.index + s[0].length })
            return r
          }
          getValueInRange(S) {
            if (((S = this._validateRange(S)), S.startLineNumber === S.endLineNumber))
              return this._lines[S.startLineNumber - 1].substring(S.startColumn - 1, S.endColumn - 1)
            const C = this._eol,
              r = S.startLineNumber - 1,
              s = S.endLineNumber - 1,
              l = []
            l.push(this._lines[r].substring(S.startColumn - 1))
            for (let _ = r + 1; _ < s; _++) l.push(this._lines[_])
            return l.push(this._lines[s].substring(0, S.endColumn - 1)), l.join(C)
          }
          offsetAt(S) {
            return (
          ...
          _validateRange(S) {
            const C = this._validatePosition({ lineNumber: S.startLineNumber, column: S.startColumn }),
              r = this._validatePosition({ lineNumber: S.endLineNumber, column: S.endColumn })
            return C.lineNumber !== S.startLineNumber ||
              C.column !== S.startColumn ||
          ...
          _validatePosition(S) {
            ...
            let { lineNumber: C, column: r } = S,
              s = !1
            if (C < 1) (C = 1), (r = 1), (s = !0)
            else if (C > this._lines.length) (C = this._lines.length), (r = this._lines[C - 1].length + 1), (s = !0)
            else {
              const l = this._lines[C - 1].length + 1
              r < 1 ? ((r = 1), (s = !0)) : r > l && ((r = l), (s = !0))
            }
            return s ? { lineNumber: C, column: r } : S
          }
        }
        class y {
          constructor(S, C) {
          ...
          _getModels() {
            const S = []
            return Object.keys(this._models).forEach(C => S.push(this._models[C])), S
          }
          acceptNewModel(S) {
            this._models[S.url] = new f(A.URI.parse(S.url), S.lines, S.EOL, S.versionId)
          }
          ...
          async computeUnicodeHighlights(S, C, r) {
            const s = this._getModel(S)
            return s
              ? a.UnicodeTextModelHighlighter.computeUnicodeHighlights(s, C, r)
              : {
                  ranges: [],
                  hasMore: !1,
          ...
          async computeDiff(S, C, r, s) {
            const l = this._getModel(S),
              _ = this._getModel(C)
            return !l || !_ ? null : y.computeDiff(l, _, r, s)
          }
          static computeDiff(S, C, r, s) {
            const l = s === 'advanced' ? u.linesDiffComputers.getDefault() : u.linesDiffComputers.getLegacy(),
              _ = S.getLinesContent(),
              g = C.getLinesContent(),
              v = l.computeDiff(_, g, r),
              R = v.changes.length > 0 ? !1 : this._modelsAreIdentical(S, C)
            function N(D) {
              return D.map(x => {
                var T
                return [
          ...
          static _modelsAreIdentical(S, C) {
            ...
            if (r !== s) return !1
            for (let l = 1; l <= r; l++) {
              const _ = S.getLineContent(l),
                g = C.getLineContent(l)
              if (_ !== g) return !1
            }
            return !0
          }
          async computeMoreMinimalEdits(S, C, r) {
            ...
            const l = []
            let _
            C = C.slice(0).sort((v, R) => {
              if (v.range && R.range) return d.Range.compareRangesUsingStarts(v.range, R.range)
              const N = v.range ? 0 : 1,
                D = R.range ? 0 : 1
              return N - D
            })
            ...
            for (let v = 1; v < C.length; v++)
              d.Range.getEndPosition(C[g].range).equals(d.Range.getStartPosition(C[v].range))
                ? ((C[g].range = d.Range.fromPositions(
                    d.Range.getStartPosition(C[g].range),
                    d.Range.getEndPosition(C[v].range),
                  )),
                  (C[g].text += C[v].text))
                : (g++, (C[g] = C[v]))
            C.length = g + 1
            for (let { range: v, text: R, eol: N } of C) {
              if ((typeof N == 'number' && (_ = N), d.Range.isEmpty(v) && !R)) continue
              const D = s.getValueInRange(v)
              if (((R = R.replace(/\r\n|\n|\r/g, s.eol)), D === R)) continue
              if (Math.max(R.length, D.length) > y._diffLimit) {
              ...
              for (const F of x) {
                const B = s.positionAt(T + F.originalStart),
                  V = s.positionAt(T + F.originalStart + F.originalLength),
                  k = {
          ...
          async textualSuggest(S, C, r, s) {
            ...
            e: for (const v of S) {
              ...
              if (R) {
                for (const N of R.words(_))
                  if (!(N === C || !isNaN(Number(N))) && (g.add(N), g.size > y._suggestionsLimit)) break e
              }
            }
            return { words: Array.from(g), duration: l.elapsed() }
          }
          async computeWordRanges(S, C, r, s) {
            const l = this._getModel(S)
            if (!l) return Object.create(null)
            const _ = new RegExp(r, s),
              g = Object.create(null)
            for (let v = C.startLineNumber; v < C.endLineNumber; v++) {
              const R = l.getLineWords(v, _)
              for (const N of R) {
                if (!isNaN(Number(N.word))) continue
                let D = g[N.word]
                D || ((D = []), (g[N.word] = D)),
                  D.push({ startLineNumber: v, startColumn: N.startColumn, endLineNumber: v, endColumn: N.endColumn })
              }
            }
            return g
          }
          async navigateValueSet(S, C, r, s, l) {
            const _ = this._getModel(S)
            if (!_) return null
            const g = new RegExp(s, l)
            ...
            const v = _.getValueInRange(C),
              R = _.getWordAtPosition({ lineNumber: C.startLineNumber, column: C.startColumn }, g)
            if (!R) return null
            const N = _.getValueInRange(R)
            return o.BasicInplaceReplace.INSTANCE.navigateValueSet(C, v, R, N, r)
          }
          loadForeignModule(S, C, r) {
            const s = (g, v) => this._host.fhr(g, v),
              _ = { host: (0, c.createProxyObject)(r, s), getMirrorModels: () => this._getModels() }
            return this._foreignModuleFactory
              ? ((this._foreignModule = this._foreignModuleFactory(_, C)),
                Promise.resolve((0, c.getAllMethodNames)(this._foreignModule)))
              : new Promise((g, v) => {
                  q(
                    [S],
                    R => {
                      ;(this._foreignModule = R.create(_, C)), g((0, c.getAllMethodNames)(this._foreignModule))
                    },
                    v,
                  )
                })
          ...
          fmr(S, C) {
            if (!this._foreignModule || typeof this._foreignModule[S] != 'function')
              return Promise.reject(new Error('Missing requestHandler or method: ' + S))
            try {
        ...
        ;(n.EditorSimpleWorker = y), (y._diffLimit = 1e5), (y._suggestionsLimit = 1e4)
        function w(E) {
          return new y(E, null)
        }
        ;(n.create = w), typeof importScripts == 'function' && (globalThis.monaco = (0, L.createMonacoBaseAPI)())
      },
    )
}).call(this)
