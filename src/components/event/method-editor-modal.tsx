  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      ...
      <DialogContent className='!max-w-[1000px]'>
        <DialogHeader>
          <DialogTitle>方法编辑</DialogTitle>
          <DialogDescription className='flex flex-col gap-4 h-[600px] mt-2'>
            <div className='flex items-center space-x-2'>
              <Label htmlFor='name' className='text-xs basis-10'>
                名称:
              </Label>
              <Input
                id='name'
            ...
            <div className='flex items-center space-x-2'>
              <Label htmlFor='description' className='text-xs basis-10'>
                描述:
              </Label>
              <Input
                id='description'
            ...
            <div className='flex space-x-2 flex-1'>
              <Label htmlFor='code' className='text-xs basis-10'>
                代码:
              </Label>
