...
const AvatarImage = React.forwardRef<HTMLImageElement, AvatarImageProps>(({ alt = '', className, ...props }, ref) => (
  <img {...props} ref={ref} alt={alt} className={cn('aspect-square h-full w-full object-cover', className)} />
))
